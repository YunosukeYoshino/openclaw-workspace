...
class IncidentCommunicatorAgent:
    """incident-communicator-agent"""

    def __init__(self, db_path: str = "incident-communicator-agent.db"):
...
def main():
    """メイン関数"""
    agent = IncidentCommunicatorAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="インシデントコミュニケータエージェント。インシデント通信・通知。",
