...
# 進捗管理ファイル
PROGRESS_FILE = PROJECT_ROOT / "v80_progress.json"

# エージェント定義
AGENTS = [
    # 野球統計・データ可視化エージェント (5個)
    {
        "name": "baseball-stats-viz-agent",
        "title": "野球統計可視化エージェント",
        "description": "野球統計データの可視化・グラフ化",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["matplotlib", "seaborn", "plotly", "pandas", "numpy"]
    },
    {
        "name": "baseball-dashboard-agent",
        "title": "野球ダッシュボードエージェント",
        "description": "野球データのダッシュボード表示",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["streamlit", "plotly", "pandas", "numpy", "requests"]
    },
    {
        "name": "baseball-report-agent",
        "title": "野球レポート生成エージェント",
        "description": "野球統計レポートの自動生成",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["pandas", "matplotlib", "reportlab", "jinja2", "requests"]
    },
    {
        "name": "baseball-insights-agent",
        "title": "野球インサイト分析エージェント",
        "description": "野球データからのインサイト発見",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scipy", "matplotlib", "scikit-learn"]
    },
    {
        "name": "baseball-metrics-agent",
        "title": "野球メトリクス管理エージェント",
        "description": "野球メトリクスの収集・管理",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "requests", "prometheus-client", "influxdb-client"]
    },

    # ゲーム分析・統計エージェント (5個)
    {
        "name": "game-statistics-agent",
        "title": "ゲーム統計エージェント",
        "description": "ゲーム統計データの収集・分析",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "matplotlib", "seaborn", "requests"]
    },
    {
        "name": "game-metrics-viz-agent",
        "title": "ゲームメトリクス可視化エージェント",
        "description": "ゲームメトリクスの可視化",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["plotly", "streamlit", "pandas", "numpy", "matplotlib"]
    },
    {
        "name": "game-insights-agent",
        "title": "ゲームインサイト分析エージェント",
        "description": "ゲームデータからのインサイト発見",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scikit-learn", "matplotlib", "plotly"]
    },
    {
        "name": "game-dashboard-agent",
        "title": "ゲームダッシュボードエージェント",
        "description": "ゲームデータのダッシュボード表示",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["streamlit", "plotly", "pandas", "numpy", "redis"]
    },
    {
        "name": "game-reporting-agent",
        "title": "ゲームレポート生成エージェント",
        "description": "ゲーム統計レポートの自動生成",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["pandas", "matplotlib", "reportlab", "jinja2", "pdfkit"]
    },

    # えっちコンテンツ分析・トレンドエージェント (5個)
    {
        "name": "erotic-analytics-agent",
        "title": "えっちアナリティクスエージェント",
        "description": "えっちコンテンツのアナリティクス分析",
        "category": "content",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "matplotlib", "seaborn", "scikit-learn"]
    },
    {
        "name": "erotic-trends-agent",
        "title": "えっちトレンド分析エージェント",
        "description": "えっちコンテンツのトレンド分析",
        "category": "content",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scipy", "matplotlib", "plotly"]
    },
    {
        "name": "erotic-insights-agent",
        "title": "えっちインサイトエージェント",
        "description": "えっちデータからのインサイト発見",
        "category": "content",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scikit-learn", "matplotlib", "seaborn"]
    },
    {
        "name": "erotic-dashboard-agent",
        "title": "えっちダッシュボードエージェント",
        "description": "えっちデータのダッシュボード表示",
        "category": "content",
        "language": "Japanese",
        "tools": ["streamlit", "plotly", "pandas", "numpy", "fastapi"]
    },
    {
        "name": "erotic-reporting-agent",
        "title": "えっちレポート生成エージェント",
        "description": "えっち統計レポートの自動生成",
        "category": "content",
        "language": "Japanese",
        "tools": ["pandas", "matplotlib", "reportlab", "jinja2", "pdfkit"]
    },
    ...
    # サービスメッシュ・マイクロサービスエージェント (5個)
    {
        ...
        "description": "サービスメッシュの管理・運用",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["kubernetes", "pyyaml", "requests", "grpcio", "protobuf"]
    },
    {
        "name": "istio-agent",
        "title": "Istioエージェント",
        "description": "Istioサービスメッシュの管理",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["kubernetes", "pyyaml", "requests", "urllib3", "typer"]
    },
    {
        "name": "linkerd-agent",
        "title": "Linkerdエージェント",
        "description": "Linkerdサービスメッシュの管理",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["kubernetes", "pyyaml", "requests", "urllib3", "rich"]
    },
    {
        "name": "consul-agent",
        "title": "Consulエージェント",
        "description": "Consulサービスディスカバリの管理",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["consul", "requests", "pyyaml", "typer", "rich"]
    },
    {
        "name": "envoy-agent",
        "title": "Envoyエージェント",
        "description": "Envoyプロキシの設定・管理",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["pyyaml", "requests", "jinja2", "protobuf", "grpcio"]
    },
    ...
    # セキュリティ・脅威検知エージェント (5個)
    {
        ...
        "title": "脅威検知エージェント",
        "description": "脅威の検知・アラート",
        "category": "security",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scikit-learn", "requests", "prometheus-client"]
    },
    {
        "name": "security-siem-agent",
        "title": "セキュリティSIEMエージェント",
        "description": "SIEMシステムの管理・運用",
        "category": "security",
        "language": "Japanese",
        "tools": ["elasticsearch", "splunk-sdk", "requests", "pyyaml", "rich"]
    },
    {
        "name": "edr-agent",
        "title": "EDRエージェント",
        "description": "エンドポイント検知・応答",
        "category": "security",
        "language": "Japanese",
    ...
    },
    {
        ...
        "category": "security",
        "language": "Japanese",
        "tools": ["requests", "pyyaml", "pandas", "numpy", "rich"]
    },
    {
        "name": "soar-agent-v2",
        "title": "SOAR V2エージェント",
        "description": "セキュリティオーケストレーションV2",
        "category": "security",
        "language": "Japanese",
        "tools": ["requests", "pyyaml", "jinja2", "schedule", "typer"]
    },
]
