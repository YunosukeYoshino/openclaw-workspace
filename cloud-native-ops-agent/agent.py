...
class CloudNativeOpsAgent:
    """cloud-native-ops-agent"""

    def __init__(self, db_path: str = "cloud-native-ops-agent.db"):
...
def main():
    """メイン関数"""
    agent = CloudNativeOpsAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="クラウドネイティブ運用エージェント。クラウドネイティブ運用。",
