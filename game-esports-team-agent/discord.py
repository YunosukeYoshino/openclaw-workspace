#!/usr/bin/env python3
"""
game-esports-team-agent - Discord Bot モジュール
"""
...
class GameEsportsTeamAgentDiscordBot:
    """ゲームeスポーツチームエージェント。eスポーツチームの管理。 Discord Bot"""
...
if __name__ == "__main__":
    # テスト実行
    async def test():
        bot = GameEsportsTeamAgentDiscordBot()
        await bot.start()
