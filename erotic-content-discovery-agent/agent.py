...
えっちコンテンツディスカバリーエージェント。新しいコンテンツの発見。
"""
...
class EroticContentDiscoveryAgentAgent:
    def __init__(self, db_path: str = None):
        self.db_path = db_path or str(Path(__file__).parent / "erotic-content-discovery-agent.db")
        self.init_database()
