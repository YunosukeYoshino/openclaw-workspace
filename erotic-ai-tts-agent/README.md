...
えっちAI TTSエージェント。AI音声合成。

Erotic AI TTS agent. AI text-to-speech synthesis.
...
```python
from agent import EroticAiTtsAgentAgent

agent = EroticAiTtsAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from erotic-ai-tts-agent")
```
