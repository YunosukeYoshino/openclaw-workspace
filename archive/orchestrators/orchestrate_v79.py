...
# 進捗管理ファイル
PROGRESS_FILE = PROJECT_ROOT / "v79_progress.json"

# エージェント定義
AGENTS = [
    # 野球データサイエンス・予測エージェント (5個)
    {
        "name": "baseball-data-science-agent",
        "title": "野球データサイエンスエージェント",
        "description": "野球データのデータサイエンス分析・解析",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scikit-learn", "matplotlib", "requests"]
    },
    {
        "name": "baseball-machine-learning-agent",
        "title": "野球機械学習エージェント",
        "description": "野球データの機械学習モデル構築",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["scikit-learn", "tensorflow", "pandas", "numpy", "joblib"]
    },
    {
        "name": "baseball-prediction-model-agent",
        "title": "野球予測モデルエージェント",
        "description": "野球試合結果予測モデルの管理",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["scikit-learn", "xgboost", "pandas", "numpy", "joblib"]
    },
    {
        "name": "baseball-advanced-stats-agent",
        "title": "野球高度統計エージェント",
        "description": "野球高度統計（セイバーメトリクス）の計算・分析",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "matplotlib", "requests", "numpy"]
    },
    {
        "name": "baseball-predictive-analytics-agent",
        "title": "野球予測分析エージェント",
        "description": "野球の予測分析・統計的予測",
        "category": "baseball",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scipy", "scikit-learn", "matplotlib"]
    },
    ...
    # ゲームAI・強化学習エージェント (5個)
    {
        "name": "game-rl-agent",
        "title": "ゲーム強化学習エージェント",
        "description": "ゲーム用強化学習エージェントの管理・学習",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["gym", "stable-baselines3", "numpy", "torch", "tensorboard"]
    },
    {
        "name": "game-ai-training-agent",
        "title": "ゲームAIトレーニングエージェント",
        "description": "ゲームAIのトレーニング・学習管理",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["torch", "tensorboard", "numpy", "wandb", "accelerate"]
    },
    {
        "name": "game-reinforcement-agent",
        "title": "ゲーム強化エージェント",
        "description": "ゲーム強化学習エージェントの強化・改善",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["stable-baselines3", "gym", "numpy", "torch", "ray"]
    },
    {
        "name": "game-ai-model-agent",
        "title": "ゲームAIモデルエージェント",
        "description": "ゲームAIモデルの管理・バージョン管理",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["torch", "onnx", "joblib", "huggingface_hub", "transformers"]
    },
    {
        "name": "game-ai-evaluation-agent",
        "title": "ゲームAI評価エージェント",
        "description": "ゲームAIモデルの評価・性能測定",
        "category": "gaming",
        "language": "Japanese",
        "tools": ["gym", "numpy", "matplotlib", "seaborn", "scikit-learn"]
    },

    # えっちコンテンツパーソナライズエージェント (5個)
    {
        "name": "erotic-personalization-agent",
        "title": "えっちパーソナライズエージェント",
        "description": "えっちコンテンツのパーソナライズ提供",
        "category": "content",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scikit-learn", "fastapi", "uvicorn"]
    },
    {
        "name": "erotic-preference-agent",
        "title": "えっち嗜好分析エージェント",
        "description": "ユーザーのえっち嗜好の分析・学習",
        "category": "content",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scikit-learn", "matplotlib", "seaborn"]
    },
    {
        "name": "erotic-behavior-agent",
        "title": "えっち行動分析エージェント",
        "description": "ユーザーのえっちコンテンツ行動分析",
        "category": "content",
        "language": "Japanese",
        "tools": ["pandas", "numpy", "scikit-learn", "matplotlib", "plotly"]
    },
    {
        "name": "erotic-recommendation-v2-agent",
        "title": "えっち推薦V2エージェント",
        "description": "高度なえっちコンテンツ推薦エンジン",
        "category": "content",
        "language": "Japanese",
        "tools": ["implicit", "lightfm", "pandas", "numpy", "fastapi"]
    },
    {
        "name": "erotic-customization-agent",
        "title": "えっちカスタマイズエージェント",
        "description": "えっちコンテンツのカスタマイズ・設定管理",
        "category": "content",
        "language": "Japanese",
        "tools": ["fastapi", "pydantic", "python-multipart", "pillow", "uvicorn"]
    },
    ...
    # クラウドネイティブ・Kubernetesエージェント (5個)
    {
        ...
        "description": "Kubernetesクラスタの管理・運用",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["kubernetes", "pyyaml", "requests", "python-dotenv", "rich"]
    },
    {
        "name": "k8s-deployment-agent",
        "title": "K8sデプロイメントエージェント",
        "description": "Kubernetesデプロイメントの管理",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["kubernetes", "pyyaml", "jinja2", "requests", "rich"]
    },
    {
        "name": "k8s-service-agent",
        "title": "K8sサービスエージェント",
        "description": "Kubernetesサービスの管理・設定",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["kubernetes", "pyyaml", "requests", "rich", "typer"]
    },
    {
        "name": "k8s-ingress-agent",
        "title": "K8sイングレスエージェント",
        "description": "Kubernetesイングレスの管理・設定",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["kubernetes", "pyyaml", "requests", "certbot", "rich"]
    },
    {
        "name": "k8s-helm-agent",
        "title": "K8s Helmエージェント",
        "description": "Helmチャートの管理・デプロイ",
        "category": "cloud",
        "language": "Japanese",
        "tools": ["helm", "pyyaml", "jinja2", "requests", "typer"]
    },

    # セキュリティDevSecOpsエージェント (5個)
    {
        "name": "devsecops-agent",
        "title": "DevSecOpsエージェント",
        "description": "DevSecOpsプロセスの管理・自動化",
        "category": "security",
        "language": "Japanese",
        "tools": ["subprocess", "docker", "requests", "pyyaml", "rich"]
    },
    {
        "name": "security-scan-agent",
        "title": "セキュリティスキャンエージェント",
        "description": "コード・インフラのセキュリティスキャン",
        "category": "security",
        "language": "Japanese",
        "tools": ["bandit", "safety", "trivy", "requests", "rich"]
    },
    {
        "name": "security-testing-agent",
        "title": "セキュリティテストエージェント",
        "description": "アプリケーションのセキュリティテスト",
        "category": "security",
        "language": "Japanese",
        "tools": ["owasp-zap", "selenium", "requests", "pytest", "beautifulsoup4"]
    },
    {
        "name": "security-automation-agent",
        "title": "セキュリティ自動化エージェント",
        "description": "セキュリティタスクの自動化",
        "category": "security",
        "language": "Japanese",
        "tools": ["subprocess", "requests", "pyyaml", "schedule", "rich"]
    },
    {
        "name": "shift-left-security-agent",
        "title": "シフトレフトセキュリティエージェント",
        "description": "開発フェーズからのセキュリティ統合",
        "category": "security",
        "language": "Japanese",
        "tools": ["pre-commit", "bandit", "safety", "pytest", "rich"]
    },
]
