#!/usr/bin/env python3
"""
ゲームAI戦略エージェントオーケストレーター

ゲームプレイのAI分析・戦略提案エージェントプロジェクト
...
# エージェント情報
PROJECT_NAME = "ゲームAI戦略エージェント"
AGENTS = [
    {
        "name": "game-ai-strategy-agent",
        "title": "ゲームAI戦略エージェント",
        "description": "AIによるゲーム戦略分析・提案エージェント",
        "tables": ["strategies", "tactics", "situations"]
    },
    {
        "name": "game-play-optimizer-agent",
        "title": "ゲームプレイ最適化エージェント",
        "description": "AIによるゲームプレイの最適化エージェント",
        "tables": ["optimizations", "settings", "presets"]
    },
    {
        "name": "game-coaching-ai-agent",
        "title": "ゲームコーチングAIエージェント",
        "description": "AIによるゲームコーチング・指導エージェント",
        "tables": ["coaching_sessions", "tips", "feedback"]
    },
    {
        "name": "game-skill-analyzer-agent",
        "title": "ゲームスキル分析エージェント",
        "description": "AIによるプレイヤースキル分析エージェント",
        "tables": ["skills", "metrics", "assessments"]
    },
    {
        "name": "game-pro-tips-ai-agent",
        "title": "ゲームプロtips AIエージェント",
        "description": "AIによるプロプレイヤーtipsエージェント",
        "tables": ["tips", "techniques", "resources"]
    }
]
...
PROGRESS_FILE = WORKSPACE / "game_ai_strategy_progress.json"
...
def create_agent_files(agent_info, progress):
    ...
    short_name = agent_name.replace("game-", "").replace("-agent", "")
