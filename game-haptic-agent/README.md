...
ゲーム触覚フィードバックエージェント。触覚フィードバックの管理。

Game haptic agent. Manage haptic feedback.
...
```python
from agent import GameHapticAgentAgent

agent = GameHapticAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from game-haptic-agent")
```
