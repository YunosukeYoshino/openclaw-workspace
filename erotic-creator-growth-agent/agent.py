...
class EroticCreatorGrowthAgent:
    """erotic-creator-growth-agent"""

    def __init__(self, db_path: str = "erotic-creator-growth-agent.db"):
...
def main():
    """メイン関数"""
    agent = EroticCreatorGrowthAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="えっちクリエイターグロースエージェント。クリエイターの成長支援。",
