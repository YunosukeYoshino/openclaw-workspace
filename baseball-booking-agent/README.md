...
Baseball booking agent. Manage facility bookings.
...
```python
from agent import BaseballBookingAgentAgent

agent = BaseballBookingAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from baseball-booking-agent")
```
