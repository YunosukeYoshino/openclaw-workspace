...
# -*- coding: utf-8 -*-
"""
Discordボットモジュール - ゲームコミュニティマネージャーエージェント
"""
...
class DiscordBot(commands.Bot):
    ...
    async def cmd_info(self, ctx: commands.Context):
        embed = discord.Embed(title="ゲームコミュニティマネージャーエージェント", description="ゲームコミュニティの運営・管理を行うエージェント", color=discord.Color.green())
        embed.add_field(name="カテゴリ", value="ゲームソーシャル・コミュニティ", inline=False)
        await ctx.send(embed=embed)
