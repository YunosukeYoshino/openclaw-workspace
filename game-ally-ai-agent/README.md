...
ゲーム味方AIエージェント。味方AIの管理。

Game ally AI agent. Manage ally AI.
...
```python
from agent import GameAllyAiAgentAgent

agent = GameAllyAiAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from game-ally-ai-agent")
```
