#!/usr/bin/env python3
"""
container-registry-agent - Discord Bot モジュール
"""
...
class ContainerRegistryAgentDiscordBot:
    """コンテナレジストリエージェント。コンテナイメージレジストリの管理。 Discord Bot"""
...
if __name__ == "__main__":
    # テスト実行
    async def test():
        bot = ContainerRegistryAgentDiscordBot()
        await bot.start()
