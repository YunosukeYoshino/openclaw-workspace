# baseball-statistical-research-agent

野球統計研究エージェント。新しい統計手法の研究・開発。

Baseball statistical research agent. Research and develop new statistical methods.
...
```python
from agent import BaseballStatisticalResearchAgentAgent

agent = BaseballStatisticalResearchAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from baseball-statistical-research-agent")
```
