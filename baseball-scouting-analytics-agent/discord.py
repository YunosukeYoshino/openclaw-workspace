...
class BaseballScoutingAnalyticsAgentDiscordBot:
    ...
    def _setup_commands(self):
        ...
        async def help_command(ctx):
            help_text = """
**baseball-scouting-analytics-agent Commands:**
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Discord bot for baseball-scouting-analytics-agent")
    parser.add_argument("--token", help="Discord bot token")
    parser.add_argument("--prefix", default="!", help="Command prefix")
    args = parser.parse_args()

    bot = BaseballScoutingAnalyticsAgentDiscordBot(token=args.token, prefix=args.prefix)
    if bot.run():
