...
えっちAIコンパニオンエージェント。AIコンパニオンの管理。

Erotic AI companion agent. Manage AI companions.
...
```python
from agent import EroticAiCompanionAgentAgent

agent = EroticAiCompanionAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from erotic-ai-companion-agent")
```
