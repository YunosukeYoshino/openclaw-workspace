...
PROGRESS_FILE = WORKSPACE / "v60_progress.json"

V60_AGENTS = [
    {"name": "baseball-game-planner-agent", "desc": "野球ゲームプランナーエージェント。試合のゲームプラン・戦略の立案・管理。", "category": "baseball-strategy"},
    {"name": "baseball-matchup-analyzer-agent", "desc": "野球対戦分析エージェント。対戦相手の分析・戦略策定。", "category": "baseball-strategy"},
    {"name": "baseball-rotation-planner-agent", "desc": "野球ローテーションプランナーエージェント。先発ローテーションの計画。", "category": "baseball-strategy"},
    {"name": "baseball-bullpen-optimizer-agent", "desc": "野球ブルペンオプティマイザーエージェント。リリーフ陣の最適化。", "category": "baseball-strategy"},
    {"name": "baseball-scouting-intel-agent", "desc": "野球スカウティングインテリジェンスエージェント。スカウティング情報の収集・分析。", "category": "baseball-strategy"},
    {"name": "game-ar-content-agent", "desc": "ゲームARコンテンツエージェント。ARコンテンツの作成・管理。", "category": "game-ar-mr"},
    {"name": "game-mr-experience-agent", "desc": "ゲームMR体験エージェント。MR体験の設計・管理。", "category": "game-ar-mr"},
    {"name": "game-spatial-mapping-agent", "desc": "ゲーム空間マッピングエージェント。空間マッピングの管理。", "category": "game-ar-mr"},
    {"name": "game-ar-ux-agent", "desc": "ゲームAR UXエージェント。AR体験のUX設計・管理。", "category": "game-ar-mr"},
    {"name": "game-location-based-agent", "desc": "ゲームロケーションベースエージェント。位置情報に基づくゲーム機能の管理。", "category": "game-ar-mr"},
    {"name": "erotic-community-engagement-agent", "desc": "えっちコミュニティエンゲージメントエージェント。コミュニティエンゲージメントの管理。", "category": "erotic-social"},
    {"name": "erotic-social-features-agent", "desc": "えっちソーシャル機能エージェント。ソーシャル機能の設計・管理。", "category": "erotic-social"},
    {"name": "erotic-discussion-forum-agent", "desc": "えっちディスカッションフォーラムエージェント。フォーラム・議論の管理。", "category": "erotic-social"},
    {"name": "erotic-social-analytics-agent", "desc": "えっちソーシャルアナリティクスエージェント。ソーシャル指標の分析。", "category": "erotic-social"},
    {"name": "erotic-influencer-connect-agent", "desc": "えっちインフルエンサーコネクトエージェント。インフルエンサーとの連携管理。", "category": "erotic-social"},
    {"name": "stream-processor-agent", "desc": "ストリームプロセッサーエージェント。ストリームデータの処理。", "category": "data-pipeline"},
    {"name": "data-ingestion-v2-agent", "desc": "データインジェスションV2エージェント。高度なデータ取り込み。", "category": "data-pipeline"},
    {"name": "stream-aggregation-agent", "desc": "ストリーム集約エージェント。ストリームデータの集約。", "category": "data-pipeline"},
    {"name": "real-time-pipeline-agent", "desc": "リアルタイムパイプラインエージェント。リアルタイムデータパイプライン。", "category": "data-pipeline"},
    {"name": "data-scheduler-agent", "desc": "データスケジューラーエージェント。データ処理のスケジューリング。", "category": "data-pipeline"},
    {"name": "threat-detection-agent", "desc": "脅威検知エージェント。セキュリティ脅威の検知。", "category": "security-threat"},
    {"name": "incident-handler-agent", "desc": "インシデントハンドラーエージェント。セキュリティインシデントの対応。", "category": "security-threat"},
    {"name": "threat-intelligence-v2-agent", "desc": "脅威インテリジェンスV2エージェント。高度な脅威インテリジェンス。", "category": "security-threat"},
    {"name": "malware-analyzer-agent", "desc": "マルウェアアナライザーエージェント。マルウェアの分析。", "category": "security-threat"},
    {"name": "security-soc-agent", "desc": "セキュリティSOCエージェント。SOC (Security Operations Center) 機能。", "category": "security-threat"},
]
...
def load_progress():
    if PROGRESS_FILE.exists():
        with open(PROGRESS_FILE, 'r', encoding='utf-8') as f:
            return json.load(f)
    return {"completed": [], "total": len(V60_AGENTS)}
...
def main():
    ...
    for i, agent_info in enumerate(V60_AGENTS, 1):
