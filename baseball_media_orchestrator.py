#!/usr/bin/env python3
"""
野球メディア統合エージェントオーケストレーター

野球関連メディアの統合管理エージェントプロジェクト
...
# エージェント情報
PROJECT_NAME = "野球メディア統合エージェント"
AGENTS = [
    {
        "name": "baseball-media-aggregator-agent",
        "title": "野球メディア統合エージェント",
        "description": "野球関連メディアの統合管理エージェント",
        "tables": ["media_sources", "articles", "videos"]
    },
    {
        "name": "baseball-news-analysis-agent",
        "title": "野球ニュース分析エージェント",
        "description": "野球ニュースのAI分析・要約エージェント",
        "tables": ["news", "summaries", "keywords"]
    },
    {
        "name": "baseball-video-summary-agent",
        "title": "野球動画要約エージェント",
        "description": "野球動画の自動要約・抽出エージェント",
        "tables": ["videos", "highlights", "clips"]
    },
    {
        "name": "baseball-social-monitor-agent",
        "title": "野球ソーシャルメディア監視エージェント",
        "description": "野球関連SNSの監視・分析エージェント",
        "tables": ["social_posts", "mentions", "trends"]
    },
    {
        "name": "baseball-trend-tracker-agent",
        "title": "野球トレンド追跡エージェント",
        "description": "野球界のトレンド追跡エージェント",
        "tables": ["trends", "topics", "analytics"]
    }
]
...
PROGRESS_FILE = WORKSPACE / "baseball_media_orchestrator_progress.json"
...
def create_agent_files(agent_info, progress):
    ...
    short_name = agent_name.replace("baseball-", "").replace("-agent", "")
    ...
    # README.md の作成
    overview_jp = f"野球関連メディアの{agent_info['description']}。"
    overview_en = f"{agent_info['description']} for baseball media."
    ...
    readme_code = README_TEMPLATE.format(
        ...
        class_name=class_name,
        feature1_jp="メディア統合機能",
        feature2_jp="ニュース分析機能",
        feature3_jp="トレンド追跡機能",
        table_name=table_name,
        table_name_lower=table_name_lower,
