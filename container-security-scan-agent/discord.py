#!/usr/bin/env python3
"""
container-security-scan-agent - Discord Bot モジュール
"""
...
class ContainerSecurityScanAgentDiscordBot:
    """コンテナセキュリティスキャンエージェント。コンテナのセキュリティスキャン。 Discord Bot"""
...
if __name__ == "__main__":
    # テスト実行
    async def test():
        bot = ContainerSecurityScanAgentDiscordBot()
        await bot.start()
