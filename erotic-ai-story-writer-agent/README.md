# erotic-ai-story-writer-agent

えっちAIストーリーライターエージェント。AIによる物語執筆。

Erotic AI story writer agent. Write stories with AI.
...
```python
from agent import EroticAiStoryWriterAgentAgent

agent = EroticAiStoryWriterAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from erotic-ai-story-writer-agent")
```
