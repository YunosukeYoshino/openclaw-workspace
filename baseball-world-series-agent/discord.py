#!/usr/bin/env python3
"""
baseball-world-series-agent - Discord Bot モジュール
"""
...
class BaseballWorldSeriesAgentDiscordBot:
    """野球ワールドシリーズエージェント。ワールドシリーズの管理。 Discord Bot"""
...
if __name__ == "__main__":
    # テスト実行
    async def test():
        bot = BaseballWorldSeriesAgentDiscordBot()
        await bot.start()
