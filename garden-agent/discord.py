#!/usr/bin/env python3
"""Discord Integration for garden-agent"""
...
**Entry types:** plant, task, harvest, watering, maintenance
...
async def main():
    ...
    bot = GardenAgentDiscordBot(token=token, prefix=prefix)
    await bot.start()
