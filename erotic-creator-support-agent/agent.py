...
class EroticCreatorSupportAgent:
    """erotic-creator-support-agent"""

    def __init__(self, db_path: str = "erotic-creator-support-agent.db"):
...
def main():
    """メイン関数"""
    agent = EroticCreatorSupportAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="えっちクリエイターサポートエージェント。クリエイターへのサポート・相談。",
