...
Privileged access manager agent. Manage privileged access.
...
```python
from agent import PrivilegeAccessManagerAgentAgent
...
await bot.connect()
await bot.send_message("Hello from privilege-access-manager-agent")
```
