#!/usr/bin/env python3
"""
Game Social Metagaming Orchestrator
ゲームソーシャルメタゲーミングオーケストレーター

自律的にゲームソーシャルメタゲーミングエージェントを開発するオーケストレーター
"""
...
AGENTS = [
    {
        "id": "game-meta-reporter-agent",
        "name_ja": "ゲームメタレポーターエージェント",
        "name_en": "Game Meta Reporter Agent",
        "description_ja": "最新の環境推移、人気キャラ・デッキの追跡、プロプレイヤー、トーナメント結果の分析、定期的なメタレポートの生成・配信",
        "description_en": "Track latest meta shifts, popular characters/decks, analyze pro players and tournament results, generate and distribute regular meta reports",
        "features": [
            "Meta Shift Tracking",
            "Popularity Analysis",
            "Pro Results Analysis",
            "Tournament Coverage",
            "Report Generation",
            "Auto Distribution"
        ],
    ...
    {
        "id": "game-tier-list-manager-agent",
        "name_ja": "ゲームTierリスト管理エージェント",
        "name_en": "Game Tier List Manager Agent",
        "description_ja": "コミュニティ投票によるTierリストの作成・更新、バージョン別、ロール別、使用率別のTierリスト、履歴管理、トレンド表示、差分比較",
        "description_en": "Create and update tier lists via community voting, version-specific, role-specific, usage-rate specific tier lists, history management, trend display, diff comparison",
        "features": [
            "Tier List Creation",
            "Community Voting",
            "Version Management",
        ...
        "tech_stack": ["pandas", "numpy", "matplotlib", "seaborn", "discord.py"]
    },
    {
        "id": "game-counter-pick-agent",
        "name_ja": "ゲームカウンターピックエージェント",
        "name_en": "Game Counter Pick Agent",
        "description_ja": "特定キャラ・デッキへの最適カウンターピック提案、シナジー、アンチシナジーの分析、ビルドガイド、戦略解説の自動生成",
        "description_en": "Suggest optimal counter picks for specific characters/decks, analyze synergies and anti-synergies, auto-generate build guides and strategy explanations",
        "features": [
        ...
        "tech_stack": ["pandas", "numpy", "scikit-learn", "networkx", "requests"]
    },
    {
        "id": "game-meta-discussion-agent",
        "name_ja": "ゲームメタ議論エージェント",
        "name_en": "Game Meta Discussion Agent",
        "description_ja": "メタ環境に関する議論スレッドの自動生成、注目トピック、投票、アンケートの作成、コミュニティ意見の集約、サマリー表示",
        "description_en": "Auto-generate discussion threads about meta environment, create trending topics, polls, surveys, aggregate community opinions, display summaries",
        "features": [
            "Thread Generation",
            "Topic Detection",
            "Poll Creation",
        ...
        "tech_stack": ["discord.py", "pandas", "numpy", "scikit-learn", "requests"]
    },
    {
        "id": "game-build-optimizer-agent",
        "name_ja": "ゲームビルド最適化エージェント",
        "name_en": "Game Build Optimizer Agent",
        "description_ja": "アイテム、スキル、ルーンの最適ビルド提案、対戦相手、状況別のビルド変化案、パッチ対応、成功率統計、ビルド共有",
        "description_en": "Suggest optimal builds for items, skills, runes, build variations based on opponent and situation, patch support, success rate statistics, build sharing",
        "features": [
            "Build Optimization",
            "Item Suggestions",
            "Skill Priorities",
        ...
        "tech_stack": ["pandas", "numpy", "scikit-learn", "requests", "beautifulsoup4"]
    }
]

# プロジェクト設定
PROJECT_NAME = "Game Social Metagaming"
PROJECT_NAME_JA = "ゲームソーシャルメタゲーミング"
PROJECT_DIR = "/workspace"
PROGRESS_FILE = "/workspace/game_social_metagaming_progress.json"
