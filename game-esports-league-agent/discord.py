#!/usr/bin/env python3
"""
game-esports-league-agent - Discord Bot モジュール
"""
...
class GameEsportsLeagueAgentDiscordBot:
    """ゲームeスポーツリーグエージェント。eスポーツリーグ運営。 Discord Bot"""
...
if __name__ == "__main__":
    # テスト実行
    async def test():
        bot = GameEsportsLeagueAgentDiscordBot()
        await bot.start()
