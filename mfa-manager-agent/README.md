...
MFA manager agent. Manage multi-factor authentication.
...
```python
from agent import MfaManagerAgentAgent

agent = MfaManagerAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from mfa-manager-agent")
```
