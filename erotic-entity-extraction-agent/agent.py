...
class EroticEntityExtractionAgent:
    """erotic-entity-extraction-agent"""

    def __init__(self, db_path: str = "erotic-entity-extraction-agent.db"):
...
def main():
    """メイン関数"""
    agent = EroticEntityExtractionAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="えっちエンティティ抽出エージェント。エンティティの抽出・認識。",
