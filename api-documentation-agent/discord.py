#!/usr/bin/env python3
"""Discord Integration for api-documentation-agent"""
...
logger = logging.getLogger('api-documentation-agent')


class ApiDocumentationAgentDiscordBot:
    ...
    def _setup_commands(self):
        ...
        async def help_command(ctx):
            help_text = """
**api-documentation-agent Commands:**
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Discord bot for api-documentation-agent")
    parser.add_argument("--token", help="Discord bot token")
    parser.add_argument("--prefix", default="!", help="Command prefix")
    args = parser.parse_args()

    bot = ApiDocumentationAgentDiscordBot(token=args.token, prefix=args.prefix)
    if bot.run():
