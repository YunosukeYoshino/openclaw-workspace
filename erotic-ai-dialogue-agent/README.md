# erotic-ai-dialogue-agent

えっちAIダイアログエージェント。AI対話の生成・管理。

Erotic AI dialogue agent. Generate and manage AI dialogues.
...
```python
from agent import EroticAiDialogueAgentAgent

agent = EroticAiDialogueAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from erotic-ai-dialogue-agent")
```
