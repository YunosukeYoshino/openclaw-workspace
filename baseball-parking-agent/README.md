...
Baseball parking agent. Manage parking.
...
```python
from agent import BaseballParkingAgentAgent

agent = BaseballParkingAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from baseball-parking-agent")
```
