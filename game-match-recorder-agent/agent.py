...
class GameMatchRecorderAgent:
    """game-match-recorder-agent"""

    def __init__(self, db_path: str = "game-match-recorder-agent.db"):
...
def main():
    """メイン関数"""
    agent = GameMatchRecorderAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="ゲームマッチレコーダーエージェント。試合記録の管理。",
