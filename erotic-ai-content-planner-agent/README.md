# erotic-ai-content-planner-agent

えっちAIコンテンツプランナーエージェント。AIによるコンテンツ計画。

Erotic AI content planner agent. Plan content with AI.
...
```python
from agent import EroticAiContentPlannerAgentAgent

agent = EroticAiContentPlannerAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from erotic-ai-content-planner-agent")
```
