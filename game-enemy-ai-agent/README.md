...
Game enemy AI agent. Manage enemy AI.
...
```python
from agent import GameEnemyAiAgentAgent

agent = GameEnemyAiAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from game-enemy-ai-agent")
```
