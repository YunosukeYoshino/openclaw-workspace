...
# -*- coding: utf-8 -*-
"""
Discordボットモジュール - えっちクリエイターダッシュボードエージェント
"""
...
class DiscordBot(commands.Bot):
    ...
    async def cmd_info(self, ctx: commands.Context):
        embed = discord.Embed(title="えっちクリエイターダッシュボードエージェント", description="えっちクリエイターのためのダッシュボードを管理するエージェント", color=discord.Color.green())
