...
class SecurityScanAgentAgent:
    def __init__(self, db_path: str = None):
        self.db_path = db_path or str(Path(__file__).parent / "security-scan-agent.db")
        self.init_database()
