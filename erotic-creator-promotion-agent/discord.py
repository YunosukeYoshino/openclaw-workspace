...
# -*- coding: utf-8 -*-
"""
Discordボットモジュール - えっちクリエイタープロモーションエージェント
"""
...
class DiscordBot(commands.Bot):
    ...
    async def cmd_info(self, ctx: commands.Context):
        embed = discord.Embed(title="えっちクリエイタープロモーションエージェント", description="えっちクリエイターのプロモーション・宣伝を支援するエージェント", color=discord.Color.green())
