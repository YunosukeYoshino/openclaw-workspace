...
# -*- coding: utf-8 -*-
"""
game-mr-experience-agent - Database Module
SQLite database management for game-mr-experience-agent
"""
...
class GameMrExperienceAgentDB:
    """Database manager for game-mr-experience-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-mr-experience-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-mr-experience-agent initialized at " + str(db.db_path))
