#!/usr/bin/env python3
"""
game-metrics-aggregator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameMetricsAggregatorAgentDB

class GameMetricsAggregatorAgentDiscordBot(commands.Bot):
    """game-metrics-aggregator-agent Discord Bot"""

    def __init__(self, db_path: str = "game-metrics-aggregator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameMetricsAggregatorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameMetricsAggregatorAgentDiscordBot()
