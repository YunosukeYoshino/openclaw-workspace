#!/usr/bin/env python3
"""
Discord integration for soc-alert-agent
"""
...
class SocAlertBot(commands.Bot):
    """Discord bot for soc-alert-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/soc-alert-agent/data.db"):
