...
```python
from agent import GameTournamentOrganizerAgent
from db import GameTournamentOrganizerAgentDB
...
- `!game-tournament-organizer-agent_help` - Show help information
- `!game-tournament-organizer-agent_status` - Show agent status
...
### GameTournamentOrganizerAgentDB
