...
```python
from agent import GameTournamentCommunicationAgent
from db import GameTournamentCommunicationAgentDB
...
- `!game-tournament-communication-agent_help` - Show help information
- `!game-tournament-communication-agent_status` - Show agent status
...
### GameTournamentCommunicationAgent
...
### GameTournamentCommunicationAgentDB
