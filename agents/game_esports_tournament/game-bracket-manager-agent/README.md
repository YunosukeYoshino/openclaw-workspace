...
```python
from agent import GameBracketManagerAgent
from db import GameBracketManagerAgentDB
...
- `!game-bracket-manager-agent_help` - Show help information
- `!game-bracket-manager-agent_status` - Show agent status
