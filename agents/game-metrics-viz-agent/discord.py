...
class GameMetricsVizAgentDiscord:
    """ゲームメトリクス可視化エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameMetricsVizAgentDiscord()
    await bot.start()
