#!/usr/bin/env python3
"""
Discord integration for compliance-monitor-agent
"""
...
class ComplianceMonitorBot(commands.Bot):
    """Discord bot for compliance-monitor-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/compliance-monitor-agent/data.db"):
