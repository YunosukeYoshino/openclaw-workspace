#!/usr/bin/env python3
"""
Discord integration for game-team-manager-agent
"""
...
class GameTeamManagerBot(commands.Bot):
    """Discord bot for game-team-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-team-manager-agent/data.db"):
