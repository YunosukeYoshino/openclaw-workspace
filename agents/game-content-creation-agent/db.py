#!/usr/bin/env python3
"""
Database module for game-content-creation-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "game-content-creation-agent.db"
...
class Database:
    """Database operations for game-content-creation-agent"""
