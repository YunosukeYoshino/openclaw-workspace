#!/usr/bin/env python3
"""
Discord integration for api-throttling-agent
"""
...
class ApiThrottlingBot(commands.Bot):
    """Discord bot for api-throttling-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/api-throttling-agent/data.db"):
