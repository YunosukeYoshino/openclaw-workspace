...
"""
野球スカウティングレポートエージェント
Baseball Scouting Report Agent
...
class BaseballScoutReportAgentAgent:
    "Baseball Scouting Report Agent"

    def __init__(self, db_path: str = "data/baseball-scout-report-agent.db"):
        self.db = BaseballScoutReportAgentDB(db_path)
        self.name = "野球スカウティングレポートエージェント"
