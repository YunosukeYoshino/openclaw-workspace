...
# -*- coding: utf-8 -*-
"""
Database for Baseball Free Agency Agent
野球フリーエージェンシーエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-free-agency-agent.db"


class BaseballFreeAgencyAgentDB:
    """Database handler for Baseball Free Agency Agent"""
...
if __name__ == "__main__":
    db = BaseballFreeAgencyAgentDB()
    print(f"Database initialized: "野球フリーエージェンシーエージェント"")
