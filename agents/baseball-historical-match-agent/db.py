#!/usr/bin/env python3
"""
Database for 野球歴史的名試合エージェント / Baseball Historical Match Agent
"""
...
class Database:
    """Database for baseball-historical-match-agent"""

    def __init__(self, db_path: str = "data/baseball-historical-match-agent.db"):
