#!/usr/bin/env python3
"""
erotic-performance-tracker-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticPerformanceTrackerAgentDB

class EroticPerformanceTrackerAgentDiscordBot(commands.Bot):
    """erotic-performance-tracker-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-performance-tracker-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticPerformanceTrackerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticPerformanceTrackerAgentDiscordBot()
