#!/usr/bin/env python3
"""
Database module for erotic-semantic-search-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "erotic-semantic-search-agent.db"
...
class Database:
    """Database operations for erotic-semantic-search-agent"""
