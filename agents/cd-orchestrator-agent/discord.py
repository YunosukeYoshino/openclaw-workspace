#!/usr/bin/env python3
"""
cd-orchestrator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import CdOrchestratorAgentDB

class CdOrchestratorAgentDiscordBot(commands.Bot):
    """cd-orchestrator-agent Discord Bot"""

    def __init__(self, db_path: str = "cd-orchestrator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = CdOrchestratorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = CdOrchestratorAgentDiscordBot()
