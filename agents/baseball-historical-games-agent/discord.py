...
class BaseballHistoricalGamesAgentDiscord:
    """野球歴史的名試合エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = BaseballHistoricalGamesAgentDiscord()
    await bot.start()
