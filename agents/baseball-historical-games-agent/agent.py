...
class BaseballHistoricalGamesAgent:
    """野球歴史的名試合エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-historical-games-agent"
        self.title = "野球歴史的名試合エージェント"
        self.description = "野球歴史的名試合の管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球歴史的名試合エージェント"
        }
    }
