...
class BaseballHistoricalGamesAgentDB:
    """野球歴史的名試合エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-historical-games-agent.db"):
...
async def main():
    ...
    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球歴史的名試合エージェント"
    )
