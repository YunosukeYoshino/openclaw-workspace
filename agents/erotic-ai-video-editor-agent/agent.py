...
class EroticAiVideoEditor:
    """えっちAI動画編集エージェント。AIによる動画の編集・加工。"""

    def __init__(self, db_path: str = "agents/erotic-ai-video-editor-agent/data.db"):
