#!/usr/bin/env python3
"""
Discord integration for erotic-ai-video-editor-agent
"""
...
class EroticAiVideoEditorBot(commands.Bot):
    """Discord bot for erotic-ai-video-editor-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-video-editor-agent/data.db"):
