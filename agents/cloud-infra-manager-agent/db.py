...
# -*- coding: utf-8 -*-
"""
cloud-infra-manager-agent - Database Module
SQLite database management for cloud-infra-manager-agent
"""
...
class CloudInfraManagerAgentDB:
    """Database manager for cloud-infra-manager-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "cloud-infra-manager-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for cloud-infra-manager-agent initialized at " + str(db.db_path))
