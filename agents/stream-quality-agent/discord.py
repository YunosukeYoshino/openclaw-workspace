#!/usr/bin/env python3
"""
Discord integration for stream-quality-agent
"""
...
class StreamQualityBot(commands.Bot):
    """Discord bot for stream-quality-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/stream-quality-agent/data.db"):
