#!/usr/bin/env python3
"""
Discord integration for erotic-ai-text-editor-agent
"""
...
class EroticAiTextEditorBot(commands.Bot):
    """Discord bot for erotic-ai-text-editor-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-text-editor-agent/data.db"):
