#!/usr/bin/env python3
"""
Database module for erotic-saved-search-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "erotic-saved-search-agent.db"
...
class Database:
    """Database operations for erotic-saved-search-agent"""
