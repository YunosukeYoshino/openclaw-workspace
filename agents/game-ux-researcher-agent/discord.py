#!/usr/bin/env python3
"""
game-ux-researcher-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameUxResearcherAgentDB

class GameUxResearcherAgentDiscordBot(commands.Bot):
    """game-ux-researcher-agent Discord Bot"""

    def __init__(self, db_path: str = "game-ux-researcher-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameUxResearcherAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameUxResearcherAgentDiscordBot()
