...
# -*- coding: utf-8 -*-
"""
Database for Game AR Overlay Agent
ゲームARオーバーレイエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-ar-overlay-agent.db"


class GameArOverlayAgentDB:
    """Database handler for Game AR Overlay Agent"""
...
if __name__ == "__main__":
    db = GameArOverlayAgentDB()
    print(f"Database initialized: "ゲームARオーバーレイエージェント"")
