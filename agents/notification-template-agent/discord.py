#!/usr/bin/env python3
"""
notification-template-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import NotificationTemplateAgentDB

class NotificationTemplateAgentDiscordBot(commands.Bot):
    """notification-template-agent Discord Bot"""

    def __init__(self, db_path: str = "notification-template-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = NotificationTemplateAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = NotificationTemplateAgentDiscordBot()
