#!/usr/bin/env python3
"""
Database module for serverless-database-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "serverless-database-agent.db"
...
class Database:
    """Database operations for serverless-database-agent"""
