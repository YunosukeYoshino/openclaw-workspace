...
class ServerlessDatabaseAgentDiscord:
    """サーバーレスデータベースエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = ServerlessDatabaseAgentDiscord()
    await bot.start()
