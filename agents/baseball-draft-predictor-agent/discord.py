#!/usr/bin/env python3
"""
Discord integration for baseball-draft-predictor-agent
"""
...
class BaseballDraftPredictorBot(commands.Bot):
    """Discord bot for baseball-draft-predictor-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-draft-predictor-agent/data.db"):
