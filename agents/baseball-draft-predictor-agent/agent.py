...
class BaseballDraftPredictor:
    """野球ドラフト予測エージェント。ドラフト順位の予測。"""

    def __init__(self, db_path: str = "agents/baseball-draft-predictor-agent/data.db"):
