...
class BaseballTradeAnalyst:
    """野球トレードアナリストエージェント。トレードの分析。"""

    def __init__(self, db_path: str = "agents/baseball-trade-analyst-agent/data.db"):
