...
class GameStreamAffiliateAgentDiscord:
    """ゲーム配信アフィリエイトエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameStreamAffiliateAgentDiscord()
    await bot.start()
