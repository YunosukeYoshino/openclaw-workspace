#!/usr/bin/env python3
"""
Discord integration for certificate-manager-agent
"""
...
class CertificateManagerBot(commands.Bot):
    """Discord bot for certificate-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/certificate-manager-agent/data.db"):
