#!/usr/bin/env python3
"""
Database for ゲームカウンターピックエージェント / Game Counter Pick Agent
"""
...
class Database:
    """Database for game-counter-pick-agent"""

    def __init__(self, db_path: str = "data/game-counter-pick-agent.db"):
