...
class GameStreamRevenueAgentDiscord:
    """ゲーム配信収益エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameStreamRevenueAgentDiscord()
    await bot.start()
