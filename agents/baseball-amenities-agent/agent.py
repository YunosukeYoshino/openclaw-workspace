...
class BaseballAmenitiesAgent:
    """野球場アメニティエージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-amenities-agent"
        self.title = "野球場アメニティエージェント"
        self.description = "野球場アメニティの管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球場アメニティエージェント"
        }
    }
