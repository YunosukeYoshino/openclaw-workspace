#!/usr/bin/env python3
"""
character-favorites-agent Database Module
SQLite database for character-favorites-agent
"""
...
class CharacterFavoritesAgentDatabase:
    """Database for character-favorites-agent"""

    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            db_path = os.path.join(os.path.dirname(__file__), "character-favorites-agent.db")
...
if __name__ == "__main__":
    db = CharacterFavoritesAgentDatabase()
