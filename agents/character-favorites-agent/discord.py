#!/usr/bin/env python3
"""
character-favorites-agent Discord Bot
Discord bot interface for character-favorites-agent
"""
...
class CharacterFavoritesAgentBot(commands.Bot):
    """Discord Bot for character-favorites-agent"""
...
def main():
    ...
    bot = CharacterFavoritesAgentBot()
    bot.run(token)
