...
# -*- coding: utf-8 -*-
"""
Database for Baseball NPB Agent
野球NPBエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-npb-agent.db"


class BaseballNpbAgentDB:
    """Database handler for Baseball NPB Agent"""
...
if __name__ == "__main__":
    db = BaseballNpbAgentDB()
    print(f"Database initialized: "野球NPBエージェント"")
