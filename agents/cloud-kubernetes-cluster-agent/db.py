#!/usr/bin/env python3
"""
Database module for クラウドKubernetesクラスタエージェント
"""
...
class Database:
    """Database handler for クラウドKubernetesクラスタエージェント"""

    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            db_path = Path(__file__).parent / "cloud-kubernetes-cluster-agent.db"
