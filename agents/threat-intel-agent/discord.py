#!/usr/bin/env python3
"""
Discord integration for threat-intel-agent
"""
...
class ThreatIntelBot(commands.Bot):
    """Discord bot for threat-intel-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/threat-intel-agent/data.db"):
