#!/usr/bin/env python3
"""
Discord integration for erotic-ai-chat-agent
"""
...
class EroticAiChatBot(commands.Bot):
    """Discord bot for erotic-ai-chat-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-chat-agent/data.db"):
