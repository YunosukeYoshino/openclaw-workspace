#!/usr/bin/env python3
"""
Discord integration for redis-agent
"""
...
class RedisBot(commands.Bot):
    """Discord bot for redis-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/redis-agent/data.db"):
