#!/usr/bin/env python3
"""
baseball-team-finance-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballTeamFinanceAgentDB

class BaseballTeamFinanceAgentDiscordBot(commands.Bot):
    """baseball-team-finance-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-team-finance-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballTeamFinanceAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballTeamFinanceAgentDiscordBot()
