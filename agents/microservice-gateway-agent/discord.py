#!/usr/bin/env python3
"""
microservice-gateway-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import MicroserviceGatewayAgentDB

class MicroserviceGatewayAgentDiscordBot(commands.Bot):
    """microservice-gateway-agent Discord Bot"""

    def __init__(self, db_path: str = "microservice-gateway-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = MicroserviceGatewayAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = MicroserviceGatewayAgentDiscordBot()
