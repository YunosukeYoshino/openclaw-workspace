#!/usr/bin/env python3
"""
Discord integration for baseball-perf-tracker-agent
"""
...
class BaseballPerfTrackerBot(commands.Bot):
    """Discord bot for baseball-perf-tracker-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-perf-tracker-agent/data.db"):
