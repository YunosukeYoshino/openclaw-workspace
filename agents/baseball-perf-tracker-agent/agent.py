...
class BaseballPerfTracker:
    """野球パフォーマンストラッカーエージェント。選手パフォーマンスの追跡。"""

    def __init__(self, db_path: str = "agents/baseball-perf-tracker-agent/data.db"):
