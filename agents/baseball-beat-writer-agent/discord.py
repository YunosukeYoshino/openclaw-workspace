#!/usr/bin/env python3
"""
baseball-beat-writer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballBeatWriterAgentDB

class BaseballBeatWriterAgentDiscordBot(commands.Bot):
    """baseball-beat-writer-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-beat-writer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballBeatWriterAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballBeatWriterAgentDiscordBot()
