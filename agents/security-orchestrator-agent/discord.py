#!/usr/bin/env python3
"""
Discord integration for security-orchestrator-agent
"""
...
class SecurityOrchestratorBot(commands.Bot):
    """Discord bot for security-orchestrator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/security-orchestrator-agent/data.db"):
