#!/usr/bin/env python3
"""
Discord integration for mongodb-agent
"""
...
class MongodbBot(commands.Bot):
    """Discord bot for mongodb-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/mongodb-agent/data.db"):
