#!/usr/bin/env python3
"""
Discord integration for baseball-drill-creator-agent
"""
...
class BaseballDrillCreatorBot(commands.Bot):
    """Discord bot for baseball-drill-creator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-drill-creator-agent/data.db"):
