...
class BaseballDrillCreator:
    """野球ドリルクリエイターエージェント。トレーニングドリルの作成。"""

    def __init__(self, db_path: str = "agents/baseball-drill-creator-agent/data.db"):
