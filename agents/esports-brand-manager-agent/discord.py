#!/usr/bin/env python3
"""
Discord integration for esports-brand-manager-agent
"""
...
class EsportsBrandManagerBot(commands.Bot):
    """Discord bot for esports-brand-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/esports-brand-manager-agent/data.db"):
