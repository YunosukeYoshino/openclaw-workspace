...
class EsportsBrandManager:
    """eスポーツブランドマネージャーエージェント。チームブランド管理。"""

    def __init__(self, db_path: str = "agents/esports-brand-manager-agent/data.db"):
