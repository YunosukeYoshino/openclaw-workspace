#!/usr/bin/env python3
"""
Discord integration for shift-left-agent
"""
...
class ShiftLeftBot(commands.Bot):
    """Discord bot for shift-left-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/shift-left-agent/data.db"):
