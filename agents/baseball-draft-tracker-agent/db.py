...
# -*- coding: utf-8 -*-
"""
baseball-draft-tracker-agent - Database Module
SQLite database management for baseball-draft-tracker-agent
"""
...
class BaseballDraftTrackerAgentDB:
    """Database manager for baseball-draft-tracker-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "baseball-draft-tracker-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for baseball-draft-tracker-agent initialized at " + str(db.db_path))
