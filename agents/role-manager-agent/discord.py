#!/usr/bin/env python3
"""
Discord integration for role-manager-agent
"""
...
class RoleManagerBot(commands.Bot):
    """Discord bot for role-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/role-manager-agent/data.db"):
