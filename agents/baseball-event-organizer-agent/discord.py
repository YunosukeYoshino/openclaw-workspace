#!/usr/bin/env python3
"""
Discord integration for baseball-event-organizer-agent
"""
...
class BaseballEventOrganizerBot(commands.Bot):
    """Discord bot for baseball-event-organizer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-event-organizer-agent/data.db"):
