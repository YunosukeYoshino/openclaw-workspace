...
class BaseballAdvanceStats:
    """野球高度統計エージェント。WAR・OPS等の高度メトリクス計算。"""

    def __init__(self, db_path: str = "agents/baseball-advance-stats-agent/data.db"):
