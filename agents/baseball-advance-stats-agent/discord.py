#!/usr/bin/env python3
"""
Discord integration for baseball-advance-stats-agent
"""
...
class BaseballAdvanceStatsBot(commands.Bot):
    """Discord bot for baseball-advance-stats-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-advance-stats-agent/data.db"):
