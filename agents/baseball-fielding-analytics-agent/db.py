#!/usr/bin/env python3
"""
Database module for baseball-fielding-analytics-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "baseball-fielding-analytics-agent.db"
...
class Database:
    """Database operations for baseball-fielding-analytics-agent"""
