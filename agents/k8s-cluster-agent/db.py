...
# -*- coding: utf-8 -*-
"""
k8s-cluster-agent - Database Module
SQLite database management for k8s-cluster-agent
"""
...
class K8sClusterAgentDB:
    """Database manager for k8s-cluster-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "k8s-cluster-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for k8s-cluster-agent initialized at " + str(db.db_path))
