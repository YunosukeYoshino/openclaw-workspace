#!/usr/bin/env python3
"""
Discord integration for game-exp-optimizer-agent
"""
...
class GameExpOptimizerBot(commands.Bot):
    """Discord bot for game-exp-optimizer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-exp-optimizer-agent/data.db"):
