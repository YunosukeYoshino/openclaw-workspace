...
```python
from agent import BaseballFanEventOrganizerAgent
from db import BaseballFanEventOrganizerAgentDB
...
- `!baseball-fan-event-organizer-agent_help` - Show help information
- `!baseball-fan-event-organizer-agent_status` - Show agent status
...
### BaseballFanEventOrganizerAgent
...
### BaseballFanEventOrganizerAgentDB
