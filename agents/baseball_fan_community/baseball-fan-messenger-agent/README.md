...
```python
from agent import BaseballFanMessengerAgent
from db import BaseballFanMessengerAgentDB
...
- `!baseball-fan-messenger-agent_help` - Show help information
- `!baseball-fan-messenger-agent_status` - Show agent status
