#!/usr/bin/env python3
"""
baseball-revenue-tracker-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballRevenueTrackerAgentDB

class BaseballRevenueTrackerAgentDiscordBot(commands.Bot):
    """baseball-revenue-tracker-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-revenue-tracker-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballRevenueTrackerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballRevenueTrackerAgentDiscordBot()
