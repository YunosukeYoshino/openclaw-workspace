#!/usr/bin/env python3
"""
Discord integration for baseball-physical-coach-agent
"""
...
class BaseballPhysicalCoachBot(commands.Bot):
    """Discord bot for baseball-physical-coach-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-physical-coach-agent/data.db"):
