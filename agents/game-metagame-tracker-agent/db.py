...
# -*- coding: utf-8 -*-
"""
game-metagame-tracker-agent - Database Module
SQLite database management for game-metagame-tracker-agent
"""
...
class GameMetagameTrackerAgentDB:
    """Database manager for game-metagame-tracker-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-metagame-tracker-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-metagame-tracker-agent initialized at " + str(db.db_path))
