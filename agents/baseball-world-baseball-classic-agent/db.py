...
# -*- coding: utf-8 -*-
"""
Database for Baseball WBC Agent
野球WBCエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-world-baseball-classic-agent.db"


class BaseballWorldBaseballClassicAgentDB:
    """Database handler for Baseball WBC Agent"""
...
if __name__ == "__main__":
    db = BaseballWorldBaseballClassicAgentDB()
    print(f"Database initialized: "野球WBCエージェント"")
