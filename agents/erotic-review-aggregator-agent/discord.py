#!/usr/bin/env python3
"""
erotic-review-aggregator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticReviewAggregatorAgentDB

class EroticReviewAggregatorAgentDiscordBot(commands.Bot):
    """erotic-review-aggregator-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-review-aggregator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticReviewAggregatorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticReviewAggregatorAgentDiscordBot()
