...
class GameRetroGamingAgentDiscord:
    """ゲームレトロゲーミングエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameRetroGamingAgentDiscord()
    await bot.start()
