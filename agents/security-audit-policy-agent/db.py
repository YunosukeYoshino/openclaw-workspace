#!/usr/bin/env python3
"""
Database module for security-audit-policy-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "security-audit-policy-agent.db"
...
class Database:
    """Database operations for security-audit-policy-agent"""
