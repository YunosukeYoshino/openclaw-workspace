#!/usr/bin/env python3
"""
Database for 野球場歴史エージェント / Baseball Stadium History Agent
"""
...
class Database:
    """Database for baseball-stadium-history-agent"""

    def __init__(self, db_path: str = "data/baseball-stadium-history-agent.db"):
