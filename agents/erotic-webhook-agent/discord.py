#!/usr/bin/env python3
"""
erotic-webhook-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticWebhookAgentDB

class EroticWebhookAgentDiscordBot(commands.Bot):
    """erotic-webhook-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-webhook-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticWebhookAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticWebhookAgentDiscordBot()
