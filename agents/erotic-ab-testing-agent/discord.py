#!/usr/bin/env python3
"""
erotic-ab-testing-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticAbTestingAgentDB

class EroticAbTestingAgentDiscordBot(commands.Bot):
    """erotic-ab-testing-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-ab-testing-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticAbTestingAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticAbTestingAgentDiscordBot()
