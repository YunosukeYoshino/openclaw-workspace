...
# -*- coding: utf-8 -*-
"""
game-vfx-artist-agent - Database Module
SQLite database management for game-vfx-artist-agent
"""
...
class GameVfxArtistAgentDB:
    """Database manager for game-vfx-artist-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-vfx-artist-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-vfx-artist-agent initialized at " + str(db.db_path))
