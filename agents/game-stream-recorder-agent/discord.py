#!/usr/bin/env python3
"""
Discord integration for game-stream-recorder-agent
"""
...
class GameStreamRecorderBot(commands.Bot):
    """Discord bot for game-stream-recorder-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-stream-recorder-agent/data.db"):
