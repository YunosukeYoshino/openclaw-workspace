#!/usr/bin/env python3
"""
push-notification-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import PushNotificationAgentDB

class PushNotificationAgentDiscordBot(commands.Bot):
    """push-notification-agent Discord Bot"""

    def __init__(self, db_path: str = "push-notification-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = PushNotificationAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = PushNotificationAgentDiscordBot()
