...
class SoftwareAgent:
    """SoftwareAgent - Discord-based software management agent with SQLite database and NLP-based message processing."""

    def __init__(self, db_path: str = None):
        """初期化"""
        if db_path is None:
            db_path = Path(__file__).parent / "software-agent.db"
        self.db = Database(str(db_path))
        self.table_name = "software_agent"
...
if __name__ == "__main__":
    agent = SoftwareAgent()
    print(f"{SoftwareAgent} initialized")
