#!/usr/bin/env python3
"""
Discord integration for game-meta-analyzer-agent
"""
...
class GameMetaAnalyzerBot(commands.Bot):
    """Discord bot for game-meta-analyzer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-meta-analyzer-agent/data.db"):
