#!/usr/bin/env python3
"""
Discord integration for micro-frontend-builder-agent
"""
...
class MicroFrontendBuilderBot(commands.Bot):
    """Discord bot for micro-frontend-builder-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/micro-frontend-builder-agent/data.db"):
