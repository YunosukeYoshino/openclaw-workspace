#!/usr/bin/env python3
"""
Discord integration for baseball-lineup-agent
"""
...
class BaseballLineupBot(commands.Bot):
    """Discord bot for baseball-lineup-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-lineup-agent/data.db"):
