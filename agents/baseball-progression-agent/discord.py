#!/usr/bin/env python3
"""
Discord integration for baseball-progression-agent
"""
...
class BaseballProgressionBot(commands.Bot):
    """Discord bot for baseball-progression-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-progression-agent/data.db"):
