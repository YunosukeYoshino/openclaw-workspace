#!/usr/bin/env python3
"""
data-dedup-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import DataDedupAgentDB

class DataDedupAgentDiscordBot(commands.Bot):
    """data-dedup-agent Discord Bot"""

    def __init__(self, db_path: str = "data-dedup-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = DataDedupAgentDB(db_path)
