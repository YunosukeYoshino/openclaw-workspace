#!/usr/bin/env python3
"""
threat-hunting-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import ThreatHuntingAgentDB

class ThreatHuntingAgentDiscordBot(commands.Bot):
    """threat-hunting-agent Discord Bot"""

    def __init__(self, db_path: str = "threat-hunting-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = ThreatHuntingAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = ThreatHuntingAgentDiscordBot()
