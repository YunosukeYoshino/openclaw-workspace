#!/usr/bin/env python3
"""
Discord integration for threat-hunting-agent
"""
...
class ThreatHuntingBot(commands.Bot):
    """Discord bot for threat-hunting-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/threat-hunting-agent/data.db"):
