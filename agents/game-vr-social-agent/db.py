...
# -*- coding: utf-8 -*-
"""
Database for Game VR Social Agent
ゲームVRソーシャルエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-vr-social-agent.db"


class GameVrSocialAgentDB:
    """Database handler for Game VR Social Agent"""
...
if __name__ == "__main__":
    db = GameVrSocialAgentDB()
    print(f"Database initialized: "ゲームVRソーシャルエージェント"")
