...
class AiModelPipelineAgent:
    """AIモデルパイプラインエージェント。MLパイプラインの自動化・管理。"""

    def __init__(self, db_path=None):
        """Initialize agent"""
        from .db import ai_model_pipeline_agentDatabase

        self.db_path = db_path or Path(f"/workspace/agents/ai-model-pipeline-agent/data.db")
        self.db = ai_model_pipeline_agentDatabase(self.db_path)
