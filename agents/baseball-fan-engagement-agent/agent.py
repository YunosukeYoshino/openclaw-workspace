...
class BaseballFanEngagementAgent:
    """野球ファンエンゲージメントエージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-fan-engagement-agent"
        self.title = "野球ファンエンゲージメントエージェント"
        self.description = "野球ファンのエンゲージメント管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球ファンエンゲージメントエージェント"
        }
    }
