#!/usr/bin/env python3
"""
erotic-audience-insights-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticAudienceInsightsAgentDB

class EroticAudienceInsightsAgentDiscordBot(commands.Bot):
    """erotic-audience-insights-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-audience-insights-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticAudienceInsightsAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticAudienceInsightsAgentDiscordBot()
