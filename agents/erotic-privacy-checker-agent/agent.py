...
class EroticPrivacyChecker:
    """えっちプライバシーチェッカーエージェント。プライバシーの検査・確認。"""

    def __init__(self, db_path: str = "agents/erotic-privacy-checker-agent/data.db"):
