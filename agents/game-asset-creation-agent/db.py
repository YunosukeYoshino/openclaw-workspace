#!/usr/bin/env python3
"""
Database module for game-asset-creation-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "game-asset-creation-agent.db"
...
class Database:
    """Database operations for game-asset-creation-agent"""
