#!/usr/bin/env python3
"""
Discord integration for baseball-player-profiler-agent
"""
...
class BaseballPlayerProfilerBot(commands.Bot):
    """Discord bot for baseball-player-profiler-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-player-profiler-agent/data.db"):
