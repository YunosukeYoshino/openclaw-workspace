#!/usr/bin/env python3
"""
baseball-simulator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballSimulatorAgentDB

class BaseballSimulatorAgentDiscordBot(commands.Bot):
    """baseball-simulator-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-simulator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballSimulatorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballSimulatorAgentDiscordBot()
