...
class GameCommunityV2AgentDB:
    """ゲームコミュニティV2エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/game-community-v2-agent.db"):
...
async def main():
    """動作確認"""
    db = GameCommunityV2AgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for ゲームコミュニティV2エージェント"
    )
