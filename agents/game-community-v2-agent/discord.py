...
class GameCommunityV2AgentDiscord:
    """ゲームコミュニティV2エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameCommunityV2AgentDiscord()
    await bot.start()
