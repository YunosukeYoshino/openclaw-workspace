#!/usr/bin/env python3
"""
Discord integration for stream-distribution-agent
"""
...
class StreamDistributionBot(commands.Bot):
    """Discord bot for stream-distribution-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/stream-distribution-agent/data.db"):
