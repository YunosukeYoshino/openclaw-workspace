...
class EroticInsightsAgentDiscord:
    """えっちインサイトエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticInsightsAgentDiscord()
    await bot.start()
