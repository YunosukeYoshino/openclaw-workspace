...
# -*- coding: utf-8 -*-
"""
game-multiplayer-matchmaker-agent - Database Module
SQLite database management for game-multiplayer-matchmaker-agent
"""
...
class GameMultiplayerMatchmakerAgentDB:
    """Database manager for game-multiplayer-matchmaker-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-multiplayer-matchmaker-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-multiplayer-matchmaker-agent initialized at " + str(db.db_path))
