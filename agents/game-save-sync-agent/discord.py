#!/usr/bin/env python3
"""
game-save-sync-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameSaveSyncAgentDB

class GameSaveSyncAgentDiscordBot(commands.Bot):
    """game-save-sync-agent Discord Bot"""

    def __init__(self, db_path: str = "game-save-sync-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameSaveSyncAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameSaveSyncAgentDiscordBot()
