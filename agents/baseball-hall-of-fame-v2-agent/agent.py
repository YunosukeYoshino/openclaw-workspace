...
class BaseballHallOfFameV2Agent:
    """野球殿堂V2エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-hall-of-fame-v2-agent"
        self.title = "野球殿堂V2エージェント"
        self.description = "野球殿堂の管理V2"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球殿堂V2エージェント"
        }
    }
