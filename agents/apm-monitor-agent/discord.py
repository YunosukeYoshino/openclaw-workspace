#!/usr/bin/env python3
"""
apm-monitor-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import ApmMonitorAgentDB

class ApmMonitorAgentDiscordBot(commands.Bot):
    """apm-monitor-agent Discord Bot"""

    def __init__(self, db_path: str = "apm-monitor-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = ApmMonitorAgentDB(db_path)
