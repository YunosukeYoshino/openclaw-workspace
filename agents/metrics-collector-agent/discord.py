#!/usr/bin/env python3
"""
Discord integration for metrics-collector-agent
"""
...
class MetricsCollectorBot(commands.Bot):
    """Discord bot for metrics-collector-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/metrics-collector-agent/data.db"):
