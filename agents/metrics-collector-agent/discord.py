#!/usr/bin/env python3
"""
metrics-collector-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import MetricsCollectorAgentDB

class MetricsCollectorAgentDiscordBot(commands.Bot):
    """metrics-collector-agent Discord Bot"""

    def __init__(self, db_path: str = "metrics-collector-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = MetricsCollectorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = MetricsCollectorAgentDiscordBot()
