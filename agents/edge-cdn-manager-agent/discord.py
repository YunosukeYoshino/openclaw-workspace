#!/usr/bin/env python3
"""
Discord integration for edge-cdn-manager-agent
"""
...
class EdgeCdnManagerBot(commands.Bot):
    """Discord bot for edge-cdn-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/edge-cdn-manager-agent/data.db"):
