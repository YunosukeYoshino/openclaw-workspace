...
# -*- coding: utf-8 -*-
"""
erotic-filter-agent - Database Module
SQLite database management for erotic-filter-agent
"""
...
class EroticFilterAgentDB:
    """Database manager for erotic-filter-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "erotic-filter-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for erotic-filter-agent initialized at " + str(db.db_path))
