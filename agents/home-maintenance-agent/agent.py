#!/usr/bin/env python3
"""
home-maintenance-agent エージェント
home-maintenance-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class HomeMaintenanceAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "home-maintenance-agent.db"
