#!/usr/bin/env python3
"""
Discord integration for baseball-scouting-director-agent
"""
...
class BaseballScoutingDirectorBot(commands.Bot):
    """Discord bot for baseball-scouting-director-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-scouting-director-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballScoutingDirectorBot()
