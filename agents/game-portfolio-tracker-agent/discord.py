#!/usr/bin/env python3
"""
game-portfolio-tracker-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GamePortfolioTrackerAgentDB

class GamePortfolioTrackerAgentDiscordBot(commands.Bot):
    """game-portfolio-tracker-agent Discord Bot"""

    def __init__(self, db_path: str = "game-portfolio-tracker-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GamePortfolioTrackerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GamePortfolioTrackerAgentDiscordBot()
