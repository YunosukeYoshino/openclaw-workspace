#!/usr/bin/env python3
"""
Discord integration for baseball-allstar-agent
"""
...
class BaseballAllstarBot(commands.Bot):
    """Discord bot for baseball-allstar-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-allstar-agent/data.db"):
