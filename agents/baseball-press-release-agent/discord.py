#!/usr/bin/env python3
"""
baseball-press-release-agent - Discord Botモジュール
"""
...
class BaseballPressReleaseAgentDiscordBot(commands.Bot):
    """baseball-press-release-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-press-release-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballPressReleaseAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballPressReleaseAgentDiscordBot()
