#!/usr/bin/env python3
"""
erotic-legal-audit-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticLegalAuditAgentDB

class EroticLegalAuditAgentDiscordBot(commands.Bot):
    """erotic-legal-audit-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-legal-audit-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticLegalAuditAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticLegalAuditAgentDiscordBot()
