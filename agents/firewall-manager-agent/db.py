...
# -*- coding: utf-8 -*-
"""
firewall-manager-agent - Database Module
SQLite database management for firewall-manager-agent
"""
...
class FirewallManagerAgentDB:
    """Database manager for firewall-manager-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "firewall-manager-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for firewall-manager-agent initialized at " + str(db.db_path))
