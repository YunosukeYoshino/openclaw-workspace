#!/usr/bin/env python3
"""
Discord integration for erotic-legal-checker-agent
"""
...
class EroticLegalCheckerBot(commands.Bot):
    """Discord bot for erotic-legal-checker-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-legal-checker-agent/data.db"):
