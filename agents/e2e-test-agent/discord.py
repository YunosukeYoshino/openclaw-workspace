#!/usr/bin/env python3
"""
e2e-test-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import E2ETestAgentDB

class E2ETestAgentDiscordBot(commands.Bot):
    """e2e-test-agent Discord Bot"""

    def __init__(self, db_path: str = "e2e-test-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = E2ETestAgentDB(db_path)
