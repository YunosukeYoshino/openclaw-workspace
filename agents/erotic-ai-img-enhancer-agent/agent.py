...
class EroticAiImgEnhancer:
    """えっちAI画像エンハンサーエージェント。画質の全体的な改善。"""

    def __init__(self, db_path: str = "agents/erotic-ai-img-enhancer-agent/data.db"):
