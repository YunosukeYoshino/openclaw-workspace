#!/usr/bin/env python3
"""
erotic-oauth-integrator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticOauthIntegratorAgentDB

class EroticOauthIntegratorAgentDiscordBot(commands.Bot):
    """erotic-oauth-integrator-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-oauth-integrator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticOauthIntegratorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticOauthIntegratorAgentDiscordBot()
