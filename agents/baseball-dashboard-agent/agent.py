...
class BaseballDashboardAgent:
    """野球ダッシュボードエージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-dashboard-agent"
        self.title = "野球ダッシュボードエージェント"
        self.description = "野球データのダッシュボード表示"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球ダッシュボードエージェント"
        }
    }
