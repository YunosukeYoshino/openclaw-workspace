#!/usr/bin/env python3
"""
character-news-agent Database Module
SQLite database for character-news-agent
"""
...
class CharacterNewsAgentDatabase:
    """Database for character-news-agent"""

    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            db_path = os.path.join(os.path.dirname(__file__), "character-news-agent.db")
