...
class GameCasterScheduler:
    """ゲームキャスタースケジューラーエージェント。実況スケジュールの管理。"""

    def __init__(self, db_path: str = "agents/game-caster-scheduler-agent/data.db"):
