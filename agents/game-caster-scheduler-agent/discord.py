#!/usr/bin/env python3
"""
Discord integration for game-caster-scheduler-agent
"""
...
class GameCasterSchedulerBot(commands.Bot):
    """Discord bot for game-caster-scheduler-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-caster-scheduler-agent/data.db"):
