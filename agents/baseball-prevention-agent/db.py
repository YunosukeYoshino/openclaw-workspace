...
# -*- coding: utf-8 -*-
"""
Database for Baseball Injury Prevention Agent
野球怪我予防エージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-prevention-agent.db"


class BaseballPreventionAgentDB:
    """Database handler for Baseball Injury Prevention Agent"""
...
if __name__ == "__main__":
    db = BaseballPreventionAgentDB()
    print(f"Database initialized: "野球怪我予防エージェント"")
