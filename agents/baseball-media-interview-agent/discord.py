#!/usr/bin/env python3
"""
Discord integration for baseball-media-interview-agent
"""
...
class BaseballMediaInterviewBot(commands.Bot):
    """Discord bot for baseball-media-interview-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-media-interview-agent/data.db"):
