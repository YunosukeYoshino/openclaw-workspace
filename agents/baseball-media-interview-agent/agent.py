...
class BaseballMediaInterview:
    """野球メディアインタビューエージェント。メディア対応の準備・練習。"""

    def __init__(self, db_path: str = "agents/baseball-media-interview-agent/data.db"):
