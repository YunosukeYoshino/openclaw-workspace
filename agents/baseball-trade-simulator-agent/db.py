#!/usr/bin/env python3
"""
Database for 野球トレードシミュレータエージェント / Baseball Trade Simulator Agent
"""
...
class Database:
    """Database for baseball-trade-simulator-agent"""

    def __init__(self, db_path: str = "data/baseball-trade-simulator-agent.db"):
