#!/usr/bin/env python3
"""
ゲームコーチングAIエージェント - Discord Botモジュール
...
class GameCoachingAiAgentDiscord:
    """ゲームコーチングAIエージェント Discord Botクラス"""
    ...
    def _setup_commands(self):
        ...
        @self.bot.command(name='add_coaching-ai')
        ...
        @self.bot.command(name='list_coaching-ai')
        ...
        @self.bot.command(name='get_coaching-ai')
        ...
        @self.bot.command(name='search_coaching-ai')
        ...
        @self.bot.command(name='stats_coaching-ai')
...
def main():
    ...
    discord_bot = GameCoachingAiAgentDiscord(agent)
    discord_bot.run()
