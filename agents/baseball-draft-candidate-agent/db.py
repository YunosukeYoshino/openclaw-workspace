#!/usr/bin/env python3
"""
Database for 野球ドラフト候補エージェント / Baseball Draft Candidate Agent
"""
...
class Database:
    """Database for baseball-draft-candidate-agent"""

    def __init__(self, db_path: str = "data/baseball-draft-candidate-agent.db"):
