#!/usr/bin/env python3
"""
game-license-manager-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameLicenseManagerAgentDB

class GameLicenseManagerAgentDiscordBot(commands.Bot):
    """game-license-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "game-license-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameLicenseManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameLicenseManagerAgentDiscordBot()
