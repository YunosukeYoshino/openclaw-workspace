#!/usr/bin/env python3
"""
Database module for game-ai-behavior-tree-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "game-ai-behavior-tree-agent.db"
...
class Database:
    """Database operations for game-ai-behavior-tree-agent"""
