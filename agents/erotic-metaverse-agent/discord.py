...
class EroticMetaverseAgentDiscord:
    """えっちメタバースエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticMetaverseAgentDiscord()
    await bot.start()
