...
class GameAchievementHunter:
    """ゲーム実績ハンターエージェント。実績の達成支援。"""

    def __init__(self, db_path: str = "agents/game-achievement-hunter-agent/data.db"):
