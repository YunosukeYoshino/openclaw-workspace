#!/usr/bin/env python3
"""
Discord integration for audit-reporter-agent
"""
...
class AuditReporterBot(commands.Bot):
    """Discord bot for audit-reporter-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/audit-reporter-agent/data.db"):
