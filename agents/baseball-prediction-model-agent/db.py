...
class BaseballPredictionModelAgentDB:
    """野球予測モデルエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-prediction-model-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballPredictionModelAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球予測モデルエージェント"
    )
