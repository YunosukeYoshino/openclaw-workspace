#!/usr/bin/env python3
"""
Discord integration for baseball-drill-finder-agent
"""
...
class BaseballDrillFinderBot(commands.Bot):
    """Discord bot for baseball-drill-finder-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-drill-finder-agent/data.db"):
