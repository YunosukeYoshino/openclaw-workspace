...
from db import EroticAiVideoGenAgentDB
...
- `!erotic-ai-video-gen-agent_help` - Show help information
- `!erotic-ai-video-gen-agent_status` - Show agent status
