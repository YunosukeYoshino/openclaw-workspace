...
```python
from agent import EroticAiModelTuningAgent
from db import EroticAiModelTuningAgentDB
...
- `!erotic-ai-model-tuning-agent_help` - Show help information
- `!erotic-ai-model-tuning-agent_status` - Show agent status
