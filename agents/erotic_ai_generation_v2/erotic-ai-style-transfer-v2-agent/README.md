...
```python
from agent import EroticAiStyleTransferV2Agent
from db import EroticAiStyleTransferV2AgentDB
...
- `!erotic-ai-style-transfer-v2-agent_help` - Show help information
- `!erotic-ai-style-transfer-v2-agent_status` - Show agent status
...
### EroticAiStyleTransferV2AgentDB
