...
```python
from agent import EroticAiUpscaleAgent
from db import EroticAiUpscaleAgentDB
...
- `!erotic-ai-upscale-agent_help` - Show help information
- `!erotic-ai-upscale-agent_status` - Show agent status
