...
```python
from agent import EroticAiInpaintAgent
from db import EroticAiInpaintAgentDB
...
- `!erotic-ai-inpaint-agent_help` - Show help information
- `!erotic-ai-inpaint-agent_status` - Show agent status
