#!/usr/bin/env python3
"""
erotic-sentiment-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticSentimentAgentDB

class EroticSentimentAgentDiscordBot(commands.Bot):
    """erotic-sentiment-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-sentiment-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticSentimentAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticSentimentAgentDiscordBot()
