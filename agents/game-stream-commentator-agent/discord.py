#!/usr/bin/env python3
"""
Discord integration for game-stream-commentator-agent
"""
...
class GameStreamCommentatorBot(commands.Bot):
    """Discord bot for game-stream-commentator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-stream-commentator-agent/data.db"):
