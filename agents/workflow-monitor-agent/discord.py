#!/usr/bin/env python3
"""
workflow-monitor-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import WorkflowMonitorAgentDB

class WorkflowMonitorAgentDiscordBot(commands.Bot):
    """workflow-monitor-agent Discord Bot"""

    def __init__(self, db_path: str = "workflow-monitor-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = WorkflowMonitorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = WorkflowMonitorAgentDiscordBot()
