...
class EroticCustomizationAgentDB:
    """えっちカスタマイズエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/erotic-customization-agent.db"):
...
async def main():
    """動作確認"""
    db = EroticCustomizationAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for えっちカスタマイズエージェント"
    )
