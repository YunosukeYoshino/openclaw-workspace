...
class EroticCustomizationAgentDiscord:
    """えっちカスタマイズエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticCustomizationAgentDiscord()
    await bot.start()
