...
class EroticCensorshipAgentDB:
    """えっち検閲エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/erotic-censorship-agent.db"):
...
async def main():
    """動作確認"""
    db = EroticCensorshipAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for えっち検閲エージェント"
    )
