...
class BaseballConcessionBot(commands.Bot):
    """Discord bot for baseball-concession-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-concession-agent/data.db"):
