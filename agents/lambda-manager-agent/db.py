...
# -*- coding: utf-8 -*-
"""
lambda-manager-agent - Database Module
SQLite database management for lambda-manager-agent
"""
...
class LambdaManagerAgentDB:
    """Database manager for lambda-manager-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "lambda-manager-agent.db")
...
if __name__ == "__main__":
    db = LambdaManagerAgentDB()
    print("Database for lambda-manager-agent initialized at " + str(db.db_path))
