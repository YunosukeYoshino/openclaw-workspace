...
# -*- coding: utf-8 -*-
"""
incident-handler-agent - Database Module
SQLite database management for incident-handler-agent
"""
...
class IncidentHandlerAgentDB:
    """Database manager for incident-handler-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "incident-handler-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for incident-handler-agent initialized at " + str(db.db_path))
