# 野球トレンド追跡エージェント / 野球トレンド追跡エージェント (EN)

野球界のトレンド追跡エージェント / 野球界のトレンド追跡エージェント

## Overview / 概要

野球関連メディアの野球界のトレンド追跡エージェント。
...
- `!add_trend-tracker <title> <content>` - Add entry / エントリー追加
- `!list_trend-tracker [limit]` - List entries / エントリー一覧
- `!get_trend-tracker <id>` - Get entry / エントリー取得
- `!search_trend-tracker <query>` - Search entries / エントリー検索
- `!stats_trend-tracker` - Get statistics / 統計情報
