#!/usr/bin/env python3
"""
Discord integration for forensic-analyzer-agent
"""
...
class ForensicAnalyzerBot(commands.Bot):
    """Discord bot for forensic-analyzer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/forensic-analyzer-agent/data.db"):
