#!/usr/bin/env python3
"""
Discord integration for sso-integration-agent
"""
...
class SsoIntegrationBot(commands.Bot):
    """Discord bot for sso-integration-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/sso-integration-agent/data.db"):
