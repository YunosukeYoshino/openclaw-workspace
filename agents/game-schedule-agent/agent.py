#!/usr/bin/env python3
"""
game-schedule-agent エージェント
game-schedule-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class GameScheduleAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "game-schedule-agent.db"
