#!/usr/bin/env python3
"""
Discord integration for baseball-vip-club-agent
"""
...
class BaseballVipClubBot(commands.Bot):
    """Discord bot for baseball-vip-club-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-vip-club-agent/data.db"):
