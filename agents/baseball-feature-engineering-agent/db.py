...
# -*- coding: utf-8 -*-
"""
Database for Baseball Feature Engineering Agent
野球特徴量エンジニアリングエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-feature-engineering-agent.db"


class BaseballFeatureEngineeringAgentDB:
    """Database handler for Baseball Feature Engineering Agent"""
...
if __name__ == "__main__":
    db = BaseballFeatureEngineeringAgentDB()
    print(f"Database initialized: "野球特徴量エンジニアリングエージェント"")
