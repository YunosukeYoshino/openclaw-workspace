#!/usr/bin/env python3
"""
Discord integration for erotic-ai-video-merger-agent
"""
...
class EroticAiVideoMergerBot(commands.Bot):
    """Discord bot for erotic-ai-video-merger-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-video-merger-agent/data.db"):
