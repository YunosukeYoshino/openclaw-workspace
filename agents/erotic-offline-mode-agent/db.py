...
# -*- coding: utf-8 -*-
"""
Database for Erotic Offline Mode Agent
えっちオフラインモードエージェント
"""
...
DB_PATH = Path(__file__).parent / "erotic-offline-mode-agent.db"


class EroticOfflineModeAgentDB:
    """Database handler for Erotic Offline Mode Agent"""
...
if __name__ == "__main__":
    db = EroticOfflineModeAgentDB()
    print(f"Database initialized: "えっちオフラインモードエージェント"")
