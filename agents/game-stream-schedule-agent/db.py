...
# -*- coding: utf-8 -*-
"""
Database for Game Stream Schedule Agent
ゲーム配信スケジュールエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-stream-schedule-agent.db"


class GameStreamScheduleAgentDB:
    """Database handler for Game Stream Schedule Agent"""
...
if __name__ == "__main__":
    db = GameStreamScheduleAgentDB()
    print(f"Database initialized: "ゲーム配信スケジュールエージェント"")
