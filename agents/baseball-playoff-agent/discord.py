#!/usr/bin/env python3
"""
Discord integration for baseball-playoff-agent
"""
...
class BaseballPlayoffBot(commands.Bot):
    """Discord bot for baseball-playoff-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-playoff-agent/data.db"):
