...
# -*- coding: utf-8 -*-
"""
Database for Baseball Rehab Plan Agent
野球リハビリプランエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-rehab-plan-agent.db"


class BaseballRehabPlanAgentDB:
    """Database handler for Baseball Rehab Plan Agent"""
...
if __name__ == "__main__":
    db = BaseballRehabPlanAgentDB()
    print(f"Database initialized: "野球リハビリプランエージェント"")
