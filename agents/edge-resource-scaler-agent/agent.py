...
class EdgeResourceScaler:
    """エッジリソーススケーラーエージェント。エッジリソースの自動スケーリング。"""

    def __init__(self, db_path: str = "agents/edge-resource-scaler-agent/data.db"):
