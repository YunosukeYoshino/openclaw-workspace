#!/usr/bin/env python3
"""
Discord integration for siem-analyzer-agent
"""
...
class SiemAnalyzerBot(commands.Bot):
    """Discord bot for siem-analyzer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/siem-analyzer-agent/data.db"):
