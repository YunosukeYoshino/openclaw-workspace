...
class BaseballPressConference:
    """野球記者会見エージェント。記者会見の準備・管理。"""

    def __init__(self, db_path: str = "agents/baseball-press-conference-agent/data.db"):
