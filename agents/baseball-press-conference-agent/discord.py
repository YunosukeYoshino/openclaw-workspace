#!/usr/bin/env python3
"""
Discord integration for baseball-press-conference-agent
"""
...
class BaseballPressConferenceBot(commands.Bot):
    """Discord bot for baseball-press-conference-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-press-conference-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballPressConferenceBot()
