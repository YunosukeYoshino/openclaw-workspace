...
# -*- coding: utf-8 -*-
"""
data-ingestion-v2-agent - Database Module
SQLite database management for data-ingestion-v2-agent
"""
...
class DataIngestionV2AgentDB:
    """Database manager for data-ingestion-v2-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "data-ingestion-v2-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for data-ingestion-v2-agent initialized at " + str(db.db_path))
