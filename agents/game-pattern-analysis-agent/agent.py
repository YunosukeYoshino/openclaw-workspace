...
class GamePatternAnalysisAgentAgent:
    "Game Pattern Analysis Agent"

    def __init__(self, db_path: str = "data/game-pattern-analysis-agent.db"):
        self.db = GamePatternAnalysisAgentDB(db_path)
        self.name = "ゲームパターン分析エージェント"
