#!/usr/bin/env python3
"""
game-social-wall-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameSocialWallAgentDB

class GameSocialWallAgentDiscordBot(commands.Bot):
    """game-social-wall-agent Discord Bot"""

    def __init__(self, db_path: str = "game-social-wall-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameSocialWallAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameSocialWallAgentDiscordBot()
