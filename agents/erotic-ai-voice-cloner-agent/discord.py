#!/usr/bin/env python3
"""
Discord integration for erotic-ai-voice-cloner-agent
"""
...
class EroticAiVoiceClonerBot(commands.Bot):
    """Discord bot for erotic-ai-voice-cloner-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-voice-cloner-agent/data.db"):
