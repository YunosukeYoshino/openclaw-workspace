...
class EroticAiVoiceCloner:
    """えっちAIボイスクロナーエージェント。音声のクローン生成。"""

    def __init__(self, db_path: str = "agents/erotic-ai-voice-cloner-agent/data.db"):
