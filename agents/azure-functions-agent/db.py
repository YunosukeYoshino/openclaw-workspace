...
# -*- coding: utf-8 -*-
"""
azure-functions-agent - Database Module
SQLite database management for azure-functions-agent
"""
...
class AzureFunctionsAgentDB:
    """Database manager for azure-functions-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "azure-functions-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for azure-functions-agent initialized at " + str(db.db_path))
