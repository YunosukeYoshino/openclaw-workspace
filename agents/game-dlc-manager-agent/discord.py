#!/usr/bin/env python3
"""
Discord integration for game-dlc-manager-agent
"""
...
class GameDlcManagerBot(commands.Bot):
    """Discord bot for game-dlc-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-dlc-manager-agent/data.db"):
