...
budget agentは、budgetの管理と追跡を行うAIエージェントです。
...
- "Add budget record"
- "Show my budget history"
- "List recent budget entries"
