#!/usr/bin/env python3
"""
budget-agent - Discord Bot Module

Discord bot for budget-agent - 家計の収入・支出管理・予算追跡
"""
...
class DiscordBot(commands.Bot):
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Household income, expense, and budget tracking"
        )
