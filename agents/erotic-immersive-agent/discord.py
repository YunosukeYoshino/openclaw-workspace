...
class EroticImmersiveAgentDiscord:
    """えっちイマーシブエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticImmersiveAgentDiscord()
    await bot.start()
