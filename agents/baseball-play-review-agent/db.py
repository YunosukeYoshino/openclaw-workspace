...
class BaseballPlayReviewAgentDB:
    """野球プレイレビューエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-play-review-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballPlayReviewAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球プレイレビューエージェント"
    )
