...
class BaseballPlayReviewAgentDiscord:
    """野球プレイレビューエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = BaseballPlayReviewAgentDiscord()
    await bot.start()
