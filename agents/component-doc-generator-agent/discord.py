#!/usr/bin/env python3
"""
Discord integration for component-doc-generator-agent
"""
...
class ComponentDocGeneratorBot(commands.Bot):
    """Discord bot for component-doc-generator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/component-doc-generator-agent/data.db"):
