...
# -*- coding: utf-8 -*-
"""
faas-monitor-agent - Database Module
SQLite database management for faas-monitor-agent
"""
...
class FaasMonitorAgentDB:
    """Database manager for faas-monitor-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "faas-monitor-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for faas-monitor-agent initialized at " + str(db.db_path))
