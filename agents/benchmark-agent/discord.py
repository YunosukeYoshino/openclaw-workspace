#!/usr/bin/env python3
"""
benchmark-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BenchmarkAgentDB

class BenchmarkAgentDiscordBot(commands.Bot):
    """benchmark-agent Discord Bot"""

    def __init__(self, db_path: str = "benchmark-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BenchmarkAgentDB(db_path)
