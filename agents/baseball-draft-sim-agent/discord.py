#!/usr/bin/env python3
"""
Discord integration for baseball-draft-sim-agent
"""
...
class BaseballDraftSimBot(commands.Bot):
    """Discord bot for baseball-draft-sim-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-draft-sim-agent/data.db"):
