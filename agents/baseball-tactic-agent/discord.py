#!/usr/bin/env python3
"""
Discord integration for baseball-tactic-agent
"""
...
class BaseballTacticBot(commands.Bot):
    """Discord bot for baseball-tactic-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-tactic-agent/data.db"):
