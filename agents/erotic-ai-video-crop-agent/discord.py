#!/usr/bin/env python3
"""
Discord integration for erotic-ai-video-crop-agent
"""
...
class EroticAiVideoCropBot(commands.Bot):
    """Discord bot for erotic-ai-video-crop-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-video-crop-agent/data.db"):
