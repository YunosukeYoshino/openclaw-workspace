...
class ShiftLeftSecurityAgentDB:
    """シフトレフトセキュリティエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/shift-left-security-agent.db"):
...
async def main():
    """動作確認"""
    db = ShiftLeftSecurityAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for シフトレフトセキュリティエージェント"
    )
