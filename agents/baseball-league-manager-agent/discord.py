#!/usr/bin/env python3
"""
Discord integration for baseball-league-manager-agent
"""
...
class BaseballLeagueManagerBot(commands.Bot):
    """Discord bot for baseball-league-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-league-manager-agent/data.db"):
