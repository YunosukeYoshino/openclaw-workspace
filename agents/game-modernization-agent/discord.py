...
class GameModernizationAgentDiscord:
    """ゲームモダライゼーションエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameModernizationAgentDiscord()
    await bot.start()
