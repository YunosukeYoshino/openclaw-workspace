...
class K8sHelmAgentDB:
    """K8s Helmエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/k8s-helm-agent.db"):
...
async def main():
    ...
    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for K8s Helmエージェント"
    )
