#!/usr/bin/env python3
"""
Discord integration for baseball-fan-survey-agent
"""
...
class BaseballFanSurveyBot(commands.Bot):
    """Discord bot for baseball-fan-survey-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-fan-survey-agent/data.db"):
