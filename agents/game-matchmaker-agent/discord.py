#!/usr/bin/env python3
"""
Discord integration for game-matchmaker-agent
"""
...
class GameMatchmakerBot(commands.Bot):
    """Discord bot for game-matchmaker-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-matchmaker-agent/data.db"):
