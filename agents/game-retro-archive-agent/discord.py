...
class GameRetroArchiveAgentDiscord:
    """ゲームレトロアーカイブエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameRetroArchiveAgentDiscord()
    await bot.start()
