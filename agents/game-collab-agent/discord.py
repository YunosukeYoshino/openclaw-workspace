#!/usr/bin/env python3
"""
Discord integration for game-collab-agent
"""
...
class GameCollabBot(commands.Bot):
    """Discord bot for game-collab-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-collab-agent/data.db"):
