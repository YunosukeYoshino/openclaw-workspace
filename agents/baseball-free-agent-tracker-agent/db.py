#!/usr/bin/env python3
"""
Database module for 野球フリーエージェントトラッカーエージェント
"""
...
class Database:
    """Database handler for 野球フリーエージェントトラッカーエージェント"""

    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            db_path = Path(__file__).parent / "baseball-free-agent-tracker-agent.db"
