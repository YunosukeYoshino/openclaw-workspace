#!/usr/bin/env python3
"""
load-balancer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import LoadBalancerAgentDB

class LoadBalancerAgentDiscordBot(commands.Bot):
    """load-balancer-agent Discord Bot"""

    def __init__(self, db_path: str = "load-balancer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = LoadBalancerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = LoadBalancerAgentDiscordBot()
