#!/usr/bin/env python3
"""
game-friend-list-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameFriendListAgentDB

class GameFriendListAgentDiscordBot(commands.Bot):
    """game-friend-list-agent Discord Bot"""

    def __init__(self, db_path: str = "game-friend-list-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameFriendListAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameFriendListAgentDiscordBot()
