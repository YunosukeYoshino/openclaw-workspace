...
class BaseballPlayEvaluationAgentDB:
    """野球プレイ評価エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-play-evaluation-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballPlayEvaluationAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球プレイ評価エージェント"
    )
