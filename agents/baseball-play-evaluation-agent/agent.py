...
class BaseballPlayEvaluationAgent:
    """野球プレイ評価エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-play-evaluation-agent"
        self.title = "野球プレイ評価エージェント"
        self.description = "野球プレイの評価・採点"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球プレイ評価エージェント"
        }
    }
