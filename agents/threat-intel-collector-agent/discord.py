#!/usr/bin/env python3
"""
Discord integration for threat-intel-collector-agent
"""
...
class ThreatIntelCollectorBot(commands.Bot):
    """Discord bot for threat-intel-collector-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/threat-intel-collector-agent/data.db"):
