...
class BaseballFanRetention:
    """野球ファンリテンションエージェント。ファン維持・リテンション戦略。"""

    def __init__(self, db_path: str = "agents/baseball-fan-retention-agent/data.db"):
