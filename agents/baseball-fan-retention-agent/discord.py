#!/usr/bin/env python3
"""
Discord integration for baseball-fan-retention-agent
"""
...
class BaseballFanRetentionBot(commands.Bot):
    """Discord bot for baseball-fan-retention-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-fan-retention-agent/data.db"):
