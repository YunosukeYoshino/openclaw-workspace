#!/usr/bin/env python3
"""
Discord integration for cassandra-agent
"""
...
class CassandraBot(commands.Bot):
    """Discord bot for cassandra-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/cassandra-agent/data.db"):
