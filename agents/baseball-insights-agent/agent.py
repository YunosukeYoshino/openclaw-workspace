...
class BaseballInsightsAgent:
    """野球インサイト分析エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-insights-agent"
        self.title = "野球インサイト分析エージェント"
        self.description = "野球データからのインサイト発見"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球インサイト分析エージェント"
        }
    }
