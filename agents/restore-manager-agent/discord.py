#!/usr/bin/env python3
"""
Discord integration for restore-manager-agent
"""
...
class RestoreManagerBot(commands.Bot):
    """Discord bot for restore-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/restore-manager-agent/data.db"):
