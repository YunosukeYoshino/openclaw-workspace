...
# -*- coding: utf-8 -*-
"""
erotic-a-b-tester-agent - Database Module
SQLite database management for erotic-a-b-tester-agent
"""
...
class EroticABTesterAgentDB:
    """Database manager for erotic-a-b-tester-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "erotic-a-b-tester-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for erotic-a-b-tester-agent initialized at " + str(db.db_path))
