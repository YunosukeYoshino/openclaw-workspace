#!/usr/bin/env python3
"""
quality-gate-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import QualityGateAgentDB

class QualityGateAgentDiscordBot(commands.Bot):
    """quality-gate-agent Discord Bot"""

    def __init__(self, db_path: str = "quality-gate-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = QualityGateAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = QualityGateAgentDiscordBot()
