...
# -*- coding: utf-8 -*-
"""
Database for Baseball Model Deployment Agent
野球モデルデプロイメントエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-model-deployment-agent.db"


class BaseballModelDeploymentAgentDB:
    """Database handler for Baseball Model Deployment Agent"""
...
if __name__ == "__main__":
    db = BaseballModelDeploymentAgentDB()
    print(f"Database initialized: "野球モデルデプロイメントエージェント"")
