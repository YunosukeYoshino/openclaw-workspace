#!/usr/bin/env python3
"""
profiler-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import ProfilerAgentDB

class ProfilerAgentDiscordBot(commands.Bot):
    """profiler-agent Discord Bot"""

    def __init__(self, db_path: str = "profiler-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = ProfilerAgentDB(db_path)
