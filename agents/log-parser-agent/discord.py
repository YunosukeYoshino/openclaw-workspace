#!/usr/bin/env python3
"""
log-parser-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import LogParserAgentDB

class LogParserAgentDiscordBot(commands.Bot):
    """log-parser-agent Discord Bot"""

    def __init__(self, db_path: str = "log-parser-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = LogParserAgentDB(db_path)
