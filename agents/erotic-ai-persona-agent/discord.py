#!/usr/bin/env python3
"""
Discord integration for erotic-ai-persona-agent
"""
...
class EroticAiPersonaBot(commands.Bot):
    """Discord bot for erotic-ai-persona-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-persona-agent/data.db"):
