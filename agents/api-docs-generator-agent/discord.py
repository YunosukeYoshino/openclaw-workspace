#!/usr/bin/env python3
"""
api-docs-generator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import ApiDocsGeneratorAgentDB

class ApiDocsGeneratorAgentDiscordBot(commands.Bot):
    """api-docs-generator-agent Discord Bot"""

    def __init__(self, db_path: str = "api-docs-generator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = ApiDocsGeneratorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = ApiDocsGeneratorAgentDiscordBot()
