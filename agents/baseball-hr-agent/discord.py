#!/usr/bin/env python3
"""
Discord integration for baseball-hr-agent
"""
...
class BaseballHrBot(commands.Bot):
    """Discord bot for baseball-hr-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-hr-agent/data.db"):
