#!/usr/bin/env python3
"""
Discord integration for esports-revenue-agent
"""
...
class EsportsRevenueBot(commands.Bot):
    """Discord bot for esports-revenue-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/esports-revenue-agent/data.db"):
