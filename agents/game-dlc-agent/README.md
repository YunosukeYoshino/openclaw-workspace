# ゲームDLCエージェント / Game DLC Agent

ゲームDLC・追加コンテンツを管理するエージェント
Agent for managing game DLC and additional content
...
```python
from agents.game-dlc-agent.agent import GameDlcAgentAgent

agent = GameDlcAgentAgent()
