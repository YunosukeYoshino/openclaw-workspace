...
class CloudMigrationAgentV2:
    """クラウド移行V2エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "cloud-migration-agent-v2"
        self.title = "クラウド移行V2エージェント"
        self.description = "クラウドへの移行V2"
        self.category = "cloud"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for クラウド移行V2エージェント"
        }
    }
