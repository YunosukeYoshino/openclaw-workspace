...
class CloudMigrationAgentV2DB:
    """クラウド移行V2エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/cloud-migration-agent-v2.db"):
...
async def main():
    """動作確認"""
    db = CloudMigrationAgentV2DB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for クラウド移行V2エージェント"
    )
