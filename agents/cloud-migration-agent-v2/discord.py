...
class CloudMigrationAgentV2Discord:
    """クラウド移行V2エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = CloudMigrationAgentV2Discord()
    await bot.start()
