#!/usr/bin/env python3
"""
music-library-agent エージェント
music-library-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class MusicLibraryAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "music-library-agent.db"
