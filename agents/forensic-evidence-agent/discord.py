#!/usr/bin/env python3
"""
Discord integration for forensic-evidence-agent
"""
...
class ForensicEvidenceBot(commands.Bot):
    """Discord bot for forensic-evidence-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/forensic-evidence-agent/data.db"):
