#!/usr/bin/env python3
"""
Database for 野球状況分析エージェント / Baseball Situation Analyzer Agent
"""
...
class Database:
    """Database for baseball-situation-analyzer-agent"""

    def __init__(self, db_path: str = "data/baseball-situation-analyzer-agent.db"):
