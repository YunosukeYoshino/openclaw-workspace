#!/usr/bin/env python3
"""
Discord integration for baseball-strength-conditioning-agent
"""
...
class BaseballStrengthConditioningBot(commands.Bot):
    """Discord bot for baseball-strength-conditioning-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-strength-conditioning-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballStrengthConditioningBot()
