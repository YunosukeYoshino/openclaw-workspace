...
class EroticAiRecommendationAgentDB:
    """えっちAI推薦エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/erotic-ai-recommendation-agent.db"):
...
async def main():
    ...
    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for えっちAI推薦エージェント"
    )
