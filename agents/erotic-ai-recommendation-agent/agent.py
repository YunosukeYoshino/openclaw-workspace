...
class EroticAiRecommendation:
    """えっちAIレコメンデーションエージェント。レコメンデーションの提供。"""

    def __init__(self, db_path: str = "agents/erotic-ai-recommendation-agent/data.db"):
