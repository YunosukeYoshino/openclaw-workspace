#!/usr/bin/env python3
"""
えっちなファンアートコレクションエージェント - Discord Botモジュール
...
from db import EroticFanartAgentDB


class EroticFanartAgentBot(commands.Bot):
    """えっちなファンアートコレクションエージェント Discord Bot"""
    ...
    def __init__(self, db_path: str = None, command_prefix: str = "!"):
        ...
        self.db = EroticFanartAgentDB(db_path)
        self.db.initialize()
...
def get_bot(db_path: str = None, command_prefix: str = "!"):
    ...
    global bot
    if bot is None:
        bot = EroticFanartAgentBot(db_path, command_prefix)
        ...
        async def show_help(ctx: commands.Context):
            ...
            embed = discord.Embed(
                ...
                description="えっちなファンアートコレクションエージェントの使い方",
                color=0x00aaff
            )
