#!/usr/bin/env python3
"""
えっちなファンアートコレクションエージェント - データベースモジュール
...
class EroticFanartAgentDB:
    """えっちなファンアートコレクションエージェント データベースクラス"""

    def __init__(self, db_path: Optional[str] = None):
        """初期化"""
        self.db_path = Path(db_path) if db_path else Path(__file__).parent / "erotic-fanart-agent.db"
