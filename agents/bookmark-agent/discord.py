#!/usr/bin/env python3
"""
bookmark-agent Discord Bot
bookmark-agent - AIエージェント
"""
...
from agent import BookmarkAgent
...
class BookmarkAgentBot(commands.Bot):
    def __init__(self):
        super().__init__(command_prefix='!', intents=intents)
        self.agent = BookmarkAgent()
