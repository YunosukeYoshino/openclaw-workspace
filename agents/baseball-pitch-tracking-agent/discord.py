#!/usr/bin/env python3
"""
Discord integration for baseball-pitch-tracking-agent
"""
...
class BaseballPitchTrackingBot(commands.Bot):
    """Discord bot for baseball-pitch-tracking-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-pitch-tracking-agent/data.db"):
