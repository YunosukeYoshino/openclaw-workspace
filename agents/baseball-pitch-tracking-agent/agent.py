...
class BaseballPitchTracking:
    """野球ピッチトラッキングエージェント。投球データ分析。"""

    def __init__(self, db_path: str = "agents/baseball-pitch-tracking-agent/data.db"):
