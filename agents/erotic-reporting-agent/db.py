...
class EroticReportingAgentDB:
    """えっちレポート生成エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/erotic-reporting-agent.db"):
...
async def main():
    """動作確認"""
    db = EroticReportingAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for えっちレポート生成エージェント"
    )
