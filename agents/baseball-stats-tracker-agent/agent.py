...
class BaseballStatsTracker:
    """野球スタットトラッカーエージェント。統計データの追跡・記録。"""

    def __init__(self, db_path: str = "agents/baseball-stats-tracker-agent/data.db"):
