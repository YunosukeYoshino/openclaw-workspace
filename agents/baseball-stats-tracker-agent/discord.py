#!/usr/bin/env python3
"""
Discord integration for baseball-stats-tracker-agent
"""
...
class BaseballStatsTrackerBot(commands.Bot):
    """Discord bot for baseball-stats-tracker-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-stats-tracker-agent/data.db"):
