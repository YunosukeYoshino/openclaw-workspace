#!/usr/bin/env python3
"""
野球メディア統合エージェント - Discord Botモジュール
...
class BaseballMediaAggregatorAgentDiscord:
    """野球メディア統合エージェント Discord Botクラス"""
    ...
    def _setup_commands(self):
        ...
        @self.bot.command(name='add_media-aggregator')
        ...
        @self.bot.command(name='list_media-aggregator')
        ...
        @self.bot.command(name='get_media-aggregator')
        ...
        @self.bot.command(name='search_media-aggregator')
        ...
        @self.bot.command(name='stats_media-aggregator')
...
def main():
    ...
    discord_bot = BaseballMediaAggregatorAgentDiscord(agent)
    discord_bot.run()
