#!/usr/bin/env python3
"""
erotic-roi-calculator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticRoiCalculatorAgentDB

class EroticRoiCalculatorAgentDiscordBot(commands.Bot):
    """erotic-roi-calculator-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-roi-calculator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticRoiCalculatorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticRoiCalculatorAgentDiscordBot()
