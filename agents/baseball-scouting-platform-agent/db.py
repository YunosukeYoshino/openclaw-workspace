#!/usr/bin/env python3
"""
Database module for 野球スカウティングプラットフォームエージェント
"""
...
class Database:
    """Database handler for 野球スカウティングプラットフォームエージェント"""

    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            db_path = Path(__file__).parent / "baseball-scouting-platform-agent.db"
