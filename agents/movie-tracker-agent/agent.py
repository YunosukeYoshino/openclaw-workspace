#!/usr/bin/env python3
"""
movie-tracker-agent エージェント
movie-tracker-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class MovieTrackerAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "movie-tracker-agent.db"
