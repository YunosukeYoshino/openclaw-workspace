#!/usr/bin/env python3
"""
movie-tracker-agent - Discord Bot Module

Discord bot for movie-tracker-agent - 映画の視聴記録と評価管理
"""
...
class DiscordBot(commands.Bot):
    """Discord bot for movie-tracker-agent"""
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Movie viewing tracking and rating management"
        )
