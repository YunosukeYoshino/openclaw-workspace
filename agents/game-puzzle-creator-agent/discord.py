#!/usr/bin/env python3
"""
Discord integration for game-puzzle-creator-agent
"""
...
class GamePuzzleCreatorBot(commands.Bot):
    """Discord bot for game-puzzle-creator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-puzzle-creator-agent/data.db"):
