#!/usr/bin/env python3
"""
Discord integration for siem-collector-agent
"""
...
class SiemCollectorBot(commands.Bot):
    """Discord bot for siem-collector-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/siem-collector-agent/data.db"):
