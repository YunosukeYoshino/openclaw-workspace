...
# -*- coding: utf-8 -*-
"""
cloud-cost-agent - Database Module
SQLite database management for cloud-cost-agent
"""
...
class CloudCostAgentDB:
    """Database manager for cloud-cost-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "cloud-cost-agent.db")
...
if __name__ == "__main__":
    db = CloudCostAgentDB()
    print("Database for cloud-cost-agent initialized at " + str(db.db_path))
