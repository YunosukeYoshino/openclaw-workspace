...
```python
from agent import BaseballSwingAnalyzerAgent
from db import BaseballSwingAnalyzerAgentDB
...
- `!baseball-swing-analyzer-agent_help` - Show help information
- `!baseball-swing-analyzer-agent_status` - Show agent status
