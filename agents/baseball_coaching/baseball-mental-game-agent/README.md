...
```python
from agent import BaseballMentalGameAgent
from db import BaseballMentalGameAgentDB
...
- `!baseball-mental-game-agent_help` - Show help information
- `!baseball-mental-game-agent_status` - Show agent status
