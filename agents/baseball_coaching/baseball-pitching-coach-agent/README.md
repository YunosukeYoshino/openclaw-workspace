...
```python
from agent import BaseballPitchingCoachAgent
from db import BaseballPitchingCoachAgentDB
...
- `!baseball-pitching-coach-agent_help` - Show help information
- `!baseball-pitching-coach-agent_status` - Show agent status
