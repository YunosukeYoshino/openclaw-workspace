...
class AnomalyDetectionBot(commands.Bot):
    """Discord bot for anomaly-detection-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/anomaly-detection-agent/data.db"):
