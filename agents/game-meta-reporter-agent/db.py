#!/usr/bin/env python3
"""
Database for ゲームメタレポーターエージェント / Game Meta Reporter Agent
"""
...
class Database:
    """Database for game-meta-reporter-agent"""

    def __init__(self, db_path: str = "data/game-meta-reporter-agent.db"):
