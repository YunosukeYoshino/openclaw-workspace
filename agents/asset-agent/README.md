...
asset agentは、assetの管理と追跡を行うAIエージェントです。
...
- "Add asset record"
- "Show my asset history"
- "List recent asset entries"
