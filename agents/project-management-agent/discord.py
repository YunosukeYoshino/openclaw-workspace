#!/usr/bin/env python3
"""
project-management-agent - Discord Bot Module

Discord bot for project-management-agent - プロジェクトの進捗・タスク・リソース管理
"""
...
class DiscordBot(commands.Bot):
    """Discord bot for project-management-agent"""
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Project progress, task, and resource management"
        )
