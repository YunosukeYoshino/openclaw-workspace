...
class EroticAiAudioEditor:
    """えっちAI音声編集エージェント。AIによる音声の編集・加工。"""

    def __init__(self, db_path: str = "agents/erotic-ai-audio-editor-agent/data.db"):
