...
class HabitTrackerAgent:
    """HabitTrackerAgent - habit tracker トラッカーは、habit-trackerの記録と追跡を管理するAIエージェントです。"""

    def __init__(self, db_path: str = None):
        """初期化"""
        if db_path is None:
            db_path = Path(__file__).parent / "habit-tracker-agent.db"
        self.db = Database(str(db_path))
        self.table_name = "habit_tracker_agent"
...
if __name__ == "__main__":
    ...
    print(f"{HabitTrackerAgent} initialized")
