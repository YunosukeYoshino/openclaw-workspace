#!/usr/bin/env python3
"""
craft-agent - Discord Bot Module

Discord bot for craft-agent - 手芸・工作のプロジェクトと材料管理
"""
...
class DiscordBot(commands.Bot):
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Craft and DIY project and material management"
        )
