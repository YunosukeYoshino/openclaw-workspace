...
class EroticAiImgEnhanceV2:
    """えっちAI画像エンハンスV2エージェント。画像品質向上機能。"""

    def __init__(self, db_path: str = "agents/erotic-ai-img-enhance-v2-agent/data.db"):
