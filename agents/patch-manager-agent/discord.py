#!/usr/bin/env python3
"""
Discord integration for patch-manager-agent
"""
...
class PatchManagerBot(commands.Bot):
    """Discord bot for patch-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/patch-manager-agent/data.db"):
