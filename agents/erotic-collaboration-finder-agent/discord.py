#!/usr/bin/env python3
"""
erotic-collaboration-finder-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticCollaborationFinderAgentDB

class EroticCollaborationFinderAgentDiscordBot(commands.Bot):
    """erotic-collaboration-finder-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-collaboration-finder-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticCollaborationFinderAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticCollaborationFinderAgentDiscordBot()
