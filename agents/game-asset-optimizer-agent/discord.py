#!/usr/bin/env python3
"""
Discord integration for game-asset-optimizer-agent
"""
...
class GameAssetOptimizerBot(commands.Bot):
    """Discord bot for game-asset-optimizer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-asset-optimizer-agent/data.db"):
