...
# -*- coding: utf-8 -*-
"""
Database for Game Stream Chat Agent
ゲーム配信チャットエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-stream-chat-agent.db"


class GameStreamChatAgentDB:
    """Database handler for Game Stream Chat Agent"""
...
if __name__ == "__main__":
    db = GameStreamChatAgentDB()
    print(f"Database initialized: "ゲーム配信チャットエージェント"")
