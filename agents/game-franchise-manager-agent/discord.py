#!/usr/bin/env python3
"""
game-franchise-manager-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameFranchiseManagerAgentDB

class GameFranchiseManagerAgentDiscordBot(commands.Bot):
    """game-franchise-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "game-franchise-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameFranchiseManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameFranchiseManagerAgentDiscordBot()
