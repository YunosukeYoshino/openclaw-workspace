#!/usr/bin/env python3
"""
野球ソーシャルメディア監視エージェント - Discord Botモジュール
...
class BaseballSocialMonitorAgentDiscord:
    """野球ソーシャルメディア監視エージェント Discord Botクラス"""
    ...
    def _setup_commands(self):
        ...
        @self.bot.command(name='add_social-monitor')
        ...
        @self.bot.command(name='list_social-monitor')
        ...
        @self.bot.command(name='get_social-monitor')
        ...
        @self.bot.command(name='search_social-monitor')
        ...
        @self.bot.command(name='stats_social-monitor')
...
def main():
    ...
    discord_bot = BaseballSocialMonitorAgentDiscord(agent)
    discord_bot.run()
