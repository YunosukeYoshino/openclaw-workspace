#!/usr/bin/env python3
"""
Discord integration for message-bus-agent
"""
...
class MessageBusBot(commands.Bot):
    """Discord bot for message-bus-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/message-bus-agent/data.db"):
