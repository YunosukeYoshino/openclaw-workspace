...
# -*- coding: utf-8 -*-
"""
Database for Game VR Experience Agent
ゲームVR体験エージェント
"""
...
DB_PATH = Path(__file__).parent / "game-vr-experience-agent.db"


class GameVrExperienceAgentDB:
    """Database handler for Game VR Experience Agent"""
...
if __name__ == "__main__":
    db = GameVrExperienceAgentDB()
    print(f"Database initialized: "ゲームVR体験エージェント"")
