#!/usr/bin/env python3
"""
graphql-api-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GraphqlApiAgentDB

class GraphqlApiAgentDiscordBot(commands.Bot):
    """graphql-api-agent Discord Bot"""

    def __init__(self, db_path: str = "graphql-api-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GraphqlApiAgentDB(db_path)
