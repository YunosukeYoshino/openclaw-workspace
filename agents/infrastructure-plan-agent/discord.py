#!/usr/bin/env python3
"""
infrastructure-plan-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import InfrastructurePlanAgentDB

class InfrastructurePlanAgentDiscordBot(commands.Bot):
    """infrastructure-plan-agent Discord Bot"""

    def __init__(self, db_path: str = "infrastructure-plan-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = InfrastructurePlanAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = InfrastructurePlanAgentDiscordBot()
