#!/usr/bin/env python3
"""
Discord integration for baseball-flexibility-training-agent
"""
...
class BaseballFlexibilityTrainingBot(commands.Bot):
    """Discord bot for baseball-flexibility-training-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-flexibility-training-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballFlexibilityTrainingBot()
