...
# -*- coding: utf-8 -*-
"""
game-recommendation-ml-agent - Database Module
SQLite database management for game-recommendation-ml-agent
"""
...
class GameRecommendationMlAgentDB:
    """Database manager for game-recommendation-ml-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-recommendation-ml-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-recommendation-ml-agent initialized at " + str(db.db_path))
