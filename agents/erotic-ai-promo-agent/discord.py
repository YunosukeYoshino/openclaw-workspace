#!/usr/bin/env python3
"""
Discord integration for erotic-ai-promo-agent
"""
...
class EroticAiPromoBot(commands.Bot):
    """Discord bot for erotic-ai-promo-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-promo-agent/data.db"):
