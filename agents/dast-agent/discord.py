#!/usr/bin/env python3
"""
Discord integration for dast-agent
"""
...
class DastBot(commands.Bot):
    """Discord bot for dast-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/dast-agent/data.db"):
