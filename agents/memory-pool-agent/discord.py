#!/usr/bin/env python3
"""
Discord integration for memory-pool-agent
"""
...
class MemoryPoolBot(commands.Bot):
    """Discord bot for memory-pool-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/memory-pool-agent/data.db"):
