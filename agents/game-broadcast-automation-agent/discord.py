#!/usr/bin/env python3
"""
game-broadcast-automation-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameBroadcastAutomationAgentDB

class GameBroadcastAutomationAgentDiscordBot(commands.Bot):
    """game-broadcast-automation-agent Discord Bot"""

    def __init__(self, db_path: str = "game-broadcast-automation-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameBroadcastAutomationAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameBroadcastAutomationAgentDiscordBot()
