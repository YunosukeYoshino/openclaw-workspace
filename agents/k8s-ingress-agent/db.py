...
class K8sIngressAgentDB:
    """K8sイングレスエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/k8s-ingress-agent.db"):
...
async def main():
    """動作確認"""
    db = K8sIngressAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for K8sイングレスエージェント"
    )
