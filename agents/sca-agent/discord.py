#!/usr/bin/env python3
"""
Discord integration for sca-agent
"""
...
class ScaBot(commands.Bot):
    """Discord bot for sca-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/sca-agent/data.db"):
