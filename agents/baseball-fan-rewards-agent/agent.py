...
class BaseballFanRewardsAgent:
    """野球ファン報酬エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-fan-rewards-agent"
        self.title = "野球ファン報酬エージェント"
        self.description = "野球ファン報酬プログラムの管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球ファン報酬エージェント"
        }
    }
