...
class EdgeAiAgentV2DB:
    """エッジAI V2エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/edge-ai-agent-v2.db"):
...
async def main():
    ...
    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for エッジAI V2エージェント"
    )
