...
class EroticAiVideoWatermark:
    """えっちAI動画ウォーターマークエージェント。ウォーターマークの追加・削除。"""

    def __init__(self, db_path: str = "agents/erotic-ai-video-watermark-agent/data.db"):
