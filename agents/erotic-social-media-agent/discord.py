#!/usr/bin/env python3
"""
Discord integration for erotic-social-media-agent
"""
...
class EroticSocialMediaBot(commands.Bot):
    """Discord bot for erotic-social-media-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-social-media-agent/data.db"):
