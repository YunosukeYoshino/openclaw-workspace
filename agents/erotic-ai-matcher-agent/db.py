...
class EroticAiMatcherAgentDB:
    """えっちAIマッチングエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/erotic-ai-matcher-agent.db"):
...
async def main():
    """動作確認"""
    db = EroticAiMatcherAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for えっちAIマッチングエージェント"
    )
