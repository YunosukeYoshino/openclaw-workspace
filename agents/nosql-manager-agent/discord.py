#!/usr/bin/env python3
"""
Discord integration for nosql-manager-agent
"""
...
class NosqlManagerBot(commands.Bot):
    """Discord bot for nosql-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/nosql-manager-agent/data.db"):
