#!/usr/bin/env python3
"""
Discord integration for sast-agent
"""
...
class SastBot(commands.Bot):
    """Discord bot for sast-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/sast-agent/data.db"):
