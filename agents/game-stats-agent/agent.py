#!/usr/bin/env python3
"""
game-stats-agent エージェント
game-stats-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class GameStatsAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "game-stats-agent.db"
