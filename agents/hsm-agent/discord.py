#!/usr/bin/env python3
"""
Discord integration for hsm-agent
"""
...
class HsmBot(commands.Bot):
    """Discord bot for hsm-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/hsm-agent/data.db"):
