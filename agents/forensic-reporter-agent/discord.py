#!/usr/bin/env python3
"""
Discord integration for forensic-reporter-agent
"""
...
class ForensicReporterBot(commands.Bot):
    """Discord bot for forensic-reporter-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/forensic-reporter-agent/data.db"):
