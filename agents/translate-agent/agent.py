...
class TranslateAgent:
    """TranslateAgent - 多言語翻訳・翻訳履歴管理・定型文管理機能を備えた翻訳エージェント。"""

    def __init__(self, db_path: str = None):
        """初期化"""
        if db_path is None:
            db_path = Path(__file__).parent / "translate-agent.db"
        self.db = Database(str(db_path))
        self.table_name = "translate_agent"
...
if __name__ == "__main__":
    ...
    print(f"{TranslateAgent} initialized")
