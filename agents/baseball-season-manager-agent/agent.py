...
class BaseballSeasonManager:
    """野球シーズンマネージャーエージェント。シーズンの管理。"""

    def __init__(self, db_path: str = "agents/baseball-season-manager-agent/data.db"):
