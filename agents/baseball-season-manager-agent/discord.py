#!/usr/bin/env python3
"""
Discord integration for baseball-season-manager-agent
"""
...
class BaseballSeasonManagerBot(commands.Bot):
    """Discord bot for baseball-season-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-season-manager-agent/data.db"):
