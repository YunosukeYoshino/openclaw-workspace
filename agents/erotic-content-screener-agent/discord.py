#!/usr/bin/env python3
"""
erotic-content-screener-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticContentScreenerAgentDB

class EroticContentScreenerAgentDiscordBot(commands.Bot):
    """erotic-content-screener-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-content-screener-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticContentScreenerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticContentScreenerAgentDiscordBot()
