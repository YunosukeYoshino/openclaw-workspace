#!/usr/bin/env python3
"""
iac-validator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import IacValidatorAgentDB

class IacValidatorAgentDiscordBot(commands.Bot):
    """iac-validator-agent Discord Bot"""

    def __init__(self, db_path: str = "iac-validator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = IacValidatorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = IacValidatorAgentDiscordBot()
