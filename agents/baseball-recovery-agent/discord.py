#!/usr/bin/env python3
"""
Discord integration for baseball-recovery-agent
"""
...
class BaseballRecoveryBot(commands.Bot):
    """Discord bot for baseball-recovery-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-recovery-agent/data.db"):
