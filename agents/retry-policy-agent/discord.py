#!/usr/bin/env python3
"""
Discord integration for retry-policy-agent
"""
...
class RetryPolicyBot(commands.Bot):
    """Discord bot for retry-policy-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/retry-policy-agent/data.db"):
