#!/usr/bin/env python3
"""
drift-detector-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import DriftDetectorAgentDB

class DriftDetectorAgentDiscordBot(commands.Bot):
    """drift-detector-agent Discord Bot"""

    def __init__(self, db_path: str = "drift-detector-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = DriftDetectorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = DriftDetectorAgentDiscordBot()
