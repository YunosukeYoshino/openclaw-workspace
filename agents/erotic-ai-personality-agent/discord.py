#!/usr/bin/env python3
"""
Discord integration for erotic-ai-personality-agent
"""
...
class EroticAiPersonalityBot(commands.Bot):
    """Discord bot for erotic-ai-personality-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-personality-agent/data.db"):
