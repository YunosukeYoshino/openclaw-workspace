...
class EroticAiPersonality:
    """えっちAIパーソナリティエージェント。AI個性の設定・管理。"""

    def __init__(self, db_path: str = "agents/erotic-ai-personality-agent/data.db"):
