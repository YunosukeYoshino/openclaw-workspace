#!/usr/bin/env python3
"""
Discord integration for baseball-sabermetrics-analyst-agent
"""
...
class BaseballSabermetricsAnalystBot(commands.Bot):
    """Discord bot for baseball-sabermetrics-analyst-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-sabermetrics-analyst-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballSabermetricsAnalystBot()
