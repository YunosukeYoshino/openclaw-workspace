#!/usr/bin/env python3
"""
game-guild-system-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameGuildSystemAgentDB

class GameGuildSystemAgentDiscordBot(commands.Bot):
    """game-guild-system-agent Discord Bot"""

    def __init__(self, db_path: str = "game-guild-system-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameGuildSystemAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameGuildSystemAgentDiscordBot()
