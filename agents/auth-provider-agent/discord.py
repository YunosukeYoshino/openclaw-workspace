#!/usr/bin/env python3
"""
Discord integration for auth-provider-agent
"""
...
class AuthProviderBot(commands.Bot):
    """Discord bot for auth-provider-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/auth-provider-agent/data.db"):
