#!/usr/bin/env python3
"""
Discord integration for oauth-manager-agent
"""
...
class OauthManagerBot(commands.Bot):
    """Discord bot for oauth-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/oauth-manager-agent/data.db"):
