#!/usr/bin/env python3
"""
えっちAIストーリーエージェント - Discord Botモジュール
...
class EroticAiStoryAgentDiscord:
    """えっちAIストーリーエージェント Discord Botクラス"""
    ...
    def _setup_commands(self):
        ...
        @self.bot.command(name='add_ai-story')
        ...
        @self.bot.command(name='list_ai-story')
        ...
        @self.bot.command(name='get_ai-story')
        ...
        @self.bot.command(name='search_ai-story')
        ...
        @self.bot.command(name='stats_ai-story')
...
def main():
    ...
    discord_bot = EroticAiStoryAgentDiscord(agent)
    discord_bot.run()
