#!/usr/bin/env python3
"""
ゲームレビューエージェント Database Module
Game Review Agent データベースモジュール
"""
...
class GameReviewAgentDB:
    "Game Review Agent Database"

    def __init__(self, db_path: str = "data/game-review-agent.db"):
