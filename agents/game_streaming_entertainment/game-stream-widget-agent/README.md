...
```python
from agent import GameStreamWidgetAgent
from db import GameStreamWidgetAgentDB
...
- `!game-stream-widget-agent_help` - Show help information
- `!game-stream-widget-agent_status` - Show agent status
