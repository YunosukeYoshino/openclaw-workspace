...
```python
from agent import GameStreamInteractiveAgent
from db import GameStreamInteractiveAgentDB
...
- `!game-stream-interactive-agent_help` - Show help information
- `!game-stream-interactive-agent_status` - Show agent status
