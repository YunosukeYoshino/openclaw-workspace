...
```python
from agent import GameStreamContentAgent
from db import GameStreamContentAgentDB
...
- `!game-stream-content-agent_help` - Show help information
- `!game-stream-content-agent_status` - Show agent status
