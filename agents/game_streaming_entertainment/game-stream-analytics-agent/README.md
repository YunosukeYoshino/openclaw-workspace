...
```python
from agent import GameStreamAnalyticsAgent
from db import GameStreamAnalyticsAgentDB
...
- `!game-stream-analytics-agent_help` - Show help information
- `!game-stream-analytics-agent_status` - Show agent status
