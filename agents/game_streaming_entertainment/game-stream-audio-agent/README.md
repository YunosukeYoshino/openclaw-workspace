...
```python
from agent import GameStreamAudioAgent
from db import GameStreamAudioAgentDB
...
- `!game-stream-audio-agent_help` - Show help information
- `!game-stream-audio-agent_status` - Show agent status
