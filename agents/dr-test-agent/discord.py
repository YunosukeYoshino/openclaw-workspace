#!/usr/bin/env python3
"""
Discord integration for dr-test-agent
"""
...
class DrTestBot(commands.Bot):
    """Discord bot for dr-test-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/dr-test-agent/data.db"):
