#!/usr/bin/env python3
"""
calendar-integration-agent Discord Bot
calendar-integration-agent - AIエージェント
"""
...
from agent import CalendarIntegrationAgent
...
class CalendarIntegrationAgentBot(commands.Bot):
    def __init__(self):
        super().__init__(command_prefix='!', intents=intents)
        self.agent = CalendarIntegrationAgent()
...
def main():
    ...
    bot = CalendarIntegrationAgentBot()
    bot.run(token)
