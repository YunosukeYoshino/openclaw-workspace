...
```python
from agent import BaseballPlayerCompareAgent
from db import BaseballPlayerCompareAgentDB
...
- `!baseball-player-compare-agent_help` - Show help information
- `!baseball-player-compare-agent_status` - Show agent status
