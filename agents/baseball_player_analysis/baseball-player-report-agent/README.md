...
```python
from agent import BaseballPlayerReportAgent
from db import BaseballPlayerReportAgentDB
...
- `!baseball-player-report-agent_help` - Show help information
- `!baseball-player-report-agent_status` - Show agent status
