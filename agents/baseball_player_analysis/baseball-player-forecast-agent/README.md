...
```python
from agent import BaseballPlayerForecastAgent
from db import BaseballPlayerForecastAgentDB
...
- `!baseball-player-forecast-agent_help` - Show help information
- `!baseball-player-forecast-agent_status` - Show agent status
