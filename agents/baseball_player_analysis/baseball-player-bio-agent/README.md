...
```python
from agent import BaseballPlayerBioAgent
from db import BaseballPlayerBioAgentDB
...
- `!baseball-player-bio-agent_help` - Show help information
- `!baseball-player-bio-agent_status` - Show agent status
