#!/usr/bin/env python3
"""
Discord integration for game-tournament-agent
"""
...
class GameTournamentBot(commands.Bot):
    """Discord bot for game-tournament-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-tournament-agent/data.db"):
