#!/usr/bin/env python3
"""
えっちAIダイアログエージェント - Discord Botモジュール
...
class EroticAiDialogueAgentDiscord:
    """えっちAIダイアログエージェント Discord Botクラス"""
    ...
    def _setup_commands(self):
        ...
        @self.bot.command(name='add_ai-dialogue')
        ...
        @self.bot.command(name='list_ai-dialogue')
        ...
        @self.bot.command(name='get_ai-dialogue')
        ...
        @self.bot.command(name='search_ai-dialogue')
        ...
        @self.bot.command(name='stats_ai-dialogue')
...
def main():
    ...
    discord_bot = EroticAiDialogueAgentDiscord(agent)
    discord_bot.run()
