#!/usr/bin/env python3
"""
rest-api-builder-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import RestApiBuilderAgentDB

class RestApiBuilderAgentDiscordBot(commands.Bot):
    """rest-api-builder-agent Discord Bot"""

    def __init__(self, db_path: str = "rest-api-builder-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = RestApiBuilderAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = RestApiBuilderAgentDiscordBot()
