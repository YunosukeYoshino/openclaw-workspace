#!/usr/bin/env python3
"""
Database for ゲームコンテンツカレンダーエージェント / Game Content Calendar Agent
"""
...
class Database:
    """Database for game-content-calendar-agent"""

    def __init__(self, db_path: str = "data/game-content-calendar-agent.db"):
