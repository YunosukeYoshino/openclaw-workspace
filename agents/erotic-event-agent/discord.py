#!/usr/bin/env python3
"""
えっちイベントエージェント Discord Bot Module
Erotic Event Agent Discord Bot
...
class EroticEventAgentBot(commands.Bot):
    """えっちイベントエージェント Discord Bot"""

    def __init__(self, db_path: str = "erotic-event-agent.db", command_prefix: str = "!"):
    ...
    @commands.command(name='eventagentget')
    ...
    @commands.command(name='eventagentsearch')
    ...
    @commands.command(name='eventagentstats')
    async def get_stats(self, ctx):
        ...
        embed = discord.Embed(
            title="えっちイベントエージェント Statistics",
    ...
    @commands.command(name='eventagenthelp')
    async def show_help(self, ctx):
        """ヘルプを表示"""
        embed = discord.Embed(
            title="えっちイベントエージェント Commands",
            description="Available commands:",
            color=discord.Color.blue()
        )
        embed.add_field(name="!eventagentadd <title> [description]", value="Add a new entry", inline=False)
        embed.add_field(name="!eventagentlist [limit]", value="List entries", inline=False)
        embed.add_field(name="!eventagentget <id>", value="Get entry details", inline=False)
        embed.add_field(name="!eventagentsearch <query>", value="Search entries", inline=False)
        embed.add_field(name="!eventagentstats", value="Show statistics", inline=False)
        embed.add_field(name="!eventagenthelp", value="Show this help", inline=False)
