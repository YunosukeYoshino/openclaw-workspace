#!/usr/bin/env python3
"""
game-press-coverage-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GamePressCoverageAgentDB

class GamePressCoverageAgentDiscordBot(commands.Bot):
    """game-press-coverage-agent Discord Bot"""

    def __init__(self, db_path: str = "game-press-coverage-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GamePressCoverageAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GamePressCoverageAgentDiscordBot()
