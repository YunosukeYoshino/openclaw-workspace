#!/usr/bin/env python3
"""
test-reporter-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import TestReporterAgentDB

class TestReporterAgentDiscordBot(commands.Bot):
    """test-reporter-agent Discord Bot"""

    def __init__(self, db_path: str = "test-reporter-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = TestReporterAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = TestReporterAgentDiscordBot()
