...
```python
from agent import BaseballEquipmentInventoryAgent
from db import BaseballEquipmentInventoryAgentDB
...
- `!baseball-equipment-inventory-agent_help` - Show help information
- `!baseball-equipment-inventory-agent_status` - Show agent status
...
### BaseballEquipmentInventoryAgent
...
### BaseballEquipmentInventoryAgentDB
