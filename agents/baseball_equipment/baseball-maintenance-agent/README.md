...
```python
from agent import BaseballMaintenanceAgent
from db import BaseballMaintenanceAgentDB
...
- `!baseball-maintenance-agent_help` - Show help information
- `!baseball-maintenance-agent_status` - Show agent status
