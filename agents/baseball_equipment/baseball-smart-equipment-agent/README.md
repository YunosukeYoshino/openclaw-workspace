...
```python
from agent import BaseballSmartEquipmentAgent
from db import BaseballSmartEquipmentAgentDB
...
- `!baseball-smart-equipment-agent_help` - Show help information
- `!baseball-smart-equipment-agent_status` - Show agent status
