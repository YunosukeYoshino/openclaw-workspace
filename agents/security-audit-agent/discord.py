#!/usr/bin/env python3
"""
Discord integration for security-audit-agent
"""
...
class SecurityAuditBot(commands.Bot):
    """Discord bot for security-audit-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/security-audit-agent/data.db"):
