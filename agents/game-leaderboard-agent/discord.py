#!/usr/bin/env python3
"""
game-leaderboard-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameLeaderboardAgentDB

class GameLeaderboardAgentDiscordBot(commands.Bot):
    """game-leaderboard-agent Discord Bot"""

    def __init__(self, db_path: str = "game-leaderboard-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameLeaderboardAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameLeaderboardAgentDiscordBot()
