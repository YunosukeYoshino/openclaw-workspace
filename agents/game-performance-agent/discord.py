#!/usr/bin/env python3
"""
Discord integration for game-performance-agent
"""
...
class GamePerformanceBot(commands.Bot):
    """Discord bot for game-performance-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-performance-agent/data.db"):
