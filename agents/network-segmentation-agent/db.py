...
# -*- coding: utf-8 -*-
"""
network-segmentation-agent - Database Module
SQLite database management for network-segmentation-agent
"""
...
class NetworkSegmentationAgentDB:
    """Database manager for network-segmentation-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "network-segmentation-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for network-segmentation-agent initialized at " + str(db.db_path))
