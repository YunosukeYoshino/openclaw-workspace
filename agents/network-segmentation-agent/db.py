#!/usr/bin/env python3
"""
Database module for network-segmentation-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "network-segmentation-agent.db"
...
class Database:
    """Database operations for network-segmentation-agent"""
