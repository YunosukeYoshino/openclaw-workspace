#!/usr/bin/env python3
"""
ネットワークセグメンテーションエージェント - データベース管理
SQLiteベースのデータ永続化
"""
...
class NetworkSegmentationAgentDB:
    """ネットワークセグメンテーションエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/network-segmentation-agent.db"):
...
async def main():
    ...
    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for ネットワークセグメンテーションエージェント"
    )
