#!/usr/bin/env python3
"""
Discord integration for distributed-tracing-agent
"""
...
class DistributedTracingBot(commands.Bot):
    """Discord bot for distributed-tracing-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/distributed-tracing-agent/data.db"):
