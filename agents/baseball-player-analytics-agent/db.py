#!/usr/bin/env python3
"""
Database module for baseball-player-analytics-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "baseball-player-analytics-agent.db"
...
class Database:
    """Database operations for baseball-player-analytics-agent"""
