#!/usr/bin/env python3
"""
Discord Bot for erotic-content-marketplace-agent
えっちコンテンツマーケットプレイスエージェント / Erotic Content Marketplace Agent
"""

import discord
from discord.ext import commands
from agent import EroticContentMarketplaceAgent
import logging
from pathlib import Path
import os

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("erotic-content-marketplace-agent")
