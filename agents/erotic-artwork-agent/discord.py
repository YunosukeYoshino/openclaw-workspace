#!/usr/bin/env python3
"""
えっちなイラスト・アート管理エージェント - Discord Botモジュール
...
from db import EroticArtworkAgentDB


class EroticArtworkAgentBot(commands.Bot):
    """えっちなイラスト・アート管理エージェント Discord Bot"""
    ...
    def __init__(self, db_path: str = None, command_prefix: str = "!"):
        ...
        self.db = EroticArtworkAgentDB(db_path)
        self.db.initialize()
...
def get_bot(db_path: str = None, command_prefix: str = "!"):
    ...
    global bot
    if bot is None:
        bot = EroticArtworkAgentBot(db_path, command_prefix)
        ...
        async def show_help(ctx: commands.Context):
            ...
            embed = discord.Embed(
                ...
                description="えっちなイラスト・アート管理エージェントの使い方",
                color=0x00aaff
            )
