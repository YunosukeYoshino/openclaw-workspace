...
# -*- coding: utf-8 -*-
"""
Database for Game Map Builder Agent
ゲームマップビルダーエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-map-builder-agent.db"


class GameMapBuilderAgentDB:
    """Database handler for Game Map Builder Agent"""
...
if __name__ == "__main__":
    db = GameMapBuilderAgentDB()
    print(f"Database initialized: "ゲームマップビルダーエージェント"")
