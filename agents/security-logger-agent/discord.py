#!/usr/bin/env python3
"""
security-logger-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import SecurityLoggerAgentDB

class SecurityLoggerAgentDiscordBot(commands.Bot):
    """security-logger-agent Discord Bot"""

    def __init__(self, db_path: str = "security-logger-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = SecurityLoggerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = SecurityLoggerAgentDiscordBot()
