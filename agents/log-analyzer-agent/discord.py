#!/usr/bin/env python3
"""
log-analyzer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import LogAnalyzerAgentDB

class LogAnalyzerAgentDiscordBot(commands.Bot):
    """log-analyzer-agent Discord Bot"""

    def __init__(self, db_path: str = "log-analyzer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = LogAnalyzerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = LogAnalyzerAgentDiscordBot()
