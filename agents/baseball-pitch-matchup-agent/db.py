#!/usr/bin/env python3
"""
Database for 野球投球マッチアップエージェント / Baseball Pitch Matchup Agent
"""
...
class Database:
    """Database for baseball-pitch-matchup-agent"""

    def __init__(self, db_path: str = "data/baseball-pitch-matchup-agent.db"):
