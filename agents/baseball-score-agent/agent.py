#!/usr/bin/env python3
"""
baseball-score-agent エージェント
baseball-score-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class BaseballScoreAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "baseball-score-agent.db"
