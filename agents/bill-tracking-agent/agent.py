#!/usr/bin/env python3
"""
bill-tracking-agent エージェント
bill-tracking-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class BillTrackingAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "bill-tracking-agent.db"
