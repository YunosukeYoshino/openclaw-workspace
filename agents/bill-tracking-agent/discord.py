#!/usr/bin/env python3
"""
bill-tracking-agent - Discord Bot Module

Discord bot for bill-tracking-agent - 請求書・支払いの管理・リマインダー
"""
...
class DiscordBot(commands.Bot):
    """Discord bot for bill-tracking-agent"""
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Bill and payment management and reminders"
        )
