#!/usr/bin/env python3
"""
erotic-quality-scorer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticQualityScorerAgentDB

class EroticQualityScorerAgentDiscordBot(commands.Bot):
    """erotic-quality-scorer-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-quality-scorer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticQualityScorerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticQualityScorerAgentDiscordBot()
