...
class ApiDocumentationAgentDiscord:
    """APIドキュメントエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = ApiDocumentationAgentDiscord()
    await bot.start()
