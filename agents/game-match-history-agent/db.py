...
# -*- coding: utf-8 -*-
"""
game-match-history-agent - Database Module
SQLite database management for game-match-history-agent
"""
...
class GameMatchHistoryAgentDB:
    """Database manager for game-match-history-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-match-history-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-match-history-agent initialized at " + str(db.db_path))
