...
class IncidentPostMortemAgent:
    """インシデント事後分析エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "incident-post-mortem-agent"
        self.title = "インシデント事後分析エージェント"
        self.description = "インシデントの事後分析・レポート"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for インシデント事後分析エージェント"
        }
    }
