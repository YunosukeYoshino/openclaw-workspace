...
class BaseballPlayTrackingAgentDB:
    """野球プレイ追跡エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-play-tracking-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballPlayTrackingAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球プレイ追跡エージェント"
    )
