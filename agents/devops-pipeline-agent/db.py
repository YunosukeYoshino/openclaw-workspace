...
# -*- coding: utf-8 -*-
"""
devops-pipeline-agent - Database Module
SQLite database management for devops-pipeline-agent
"""
...
class DevopsPipelineAgentDB:
    """Database manager for devops-pipeline-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "devops-pipeline-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for devops-pipeline-agent initialized at " + str(db.db_path))
