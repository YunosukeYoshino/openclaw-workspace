#!/usr/bin/env python3
"""
consistency-checker-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import ConsistencyCheckerAgentDB

class ConsistencyCheckerAgentDiscordBot(commands.Bot):
    """consistency-checker-agent Discord Bot"""

    def __init__(self, db_path: str = "consistency-checker-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = ConsistencyCheckerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = ConsistencyCheckerAgentDiscordBot()
