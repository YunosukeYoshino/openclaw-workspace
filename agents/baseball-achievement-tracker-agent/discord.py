#!/usr/bin/env python3
"""
Discord integration for baseball-achievement-tracker-agent
"""
...
class BaseballAchievementTrackerBot(commands.Bot):
    """Discord bot for baseball-achievement-tracker-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-achievement-tracker-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballAchievementTrackerBot()
