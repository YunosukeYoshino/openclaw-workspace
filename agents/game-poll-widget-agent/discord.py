#!/usr/bin/env python3
"""
Discord integration for game-poll-widget-agent
"""
...
class GamePollWidgetBot(commands.Bot):
    """Discord bot for game-poll-widget-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-poll-widget-agent/data.db"):
