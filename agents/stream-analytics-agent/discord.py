#!/usr/bin/env python3
"""
Discord integration for stream-analytics-agent
"""
...
class StreamAnalyticsBot(commands.Bot):
    """Discord bot for stream-analytics-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/stream-analytics-agent/data.db"):
