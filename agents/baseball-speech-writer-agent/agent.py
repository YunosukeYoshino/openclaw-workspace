...
class BaseballSpeechWriter:
    """野球スピーチライターエージェント。選手・監督のスピーチ原稿作成。"""

    def __init__(self, db_path: str = "agents/baseball-speech-writer-agent/data.db"):
