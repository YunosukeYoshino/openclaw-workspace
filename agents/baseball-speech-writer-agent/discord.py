#!/usr/bin/env python3
"""
Discord integration for baseball-speech-writer-agent
"""
...
class BaseballSpeechWriterBot(commands.Bot):
    """Discord bot for baseball-speech-writer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-speech-writer-agent/data.db"):
