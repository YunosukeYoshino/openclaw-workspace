...
# -*- coding: utf-8 -*-
"""
Database for Game Mod Manager Agent
ゲームMOD管理エージェント
"""
...
DB_PATH = Path(__file__).parent / "game-mod-manager-agent.db"


class GameModManagerAgentDB:
    """Database handler for Game Mod Manager Agent"""
...
if __name__ == "__main__":
    db = GameModManagerAgentDB()
    print(f"Database initialized: "ゲームMOD管理エージェント"")
