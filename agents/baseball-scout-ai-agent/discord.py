#!/usr/bin/env python3
"""
baseball-scout-ai-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballScoutAiAgentDB

class BaseballScoutAiAgentDiscordBot(commands.Bot):
    """baseball-scout-ai-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-scout-ai-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballScoutAiAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballScoutAiAgentDiscordBot()
