#!/usr/bin/env python3
"""
vtuber-schedule-agent Discord Bot
Discord bot interface for vtuber-schedule-agent
"""
...
class VtuberScheduleAgentBot(commands.Bot):
    """Discord Bot for vtuber-schedule-agent"""
