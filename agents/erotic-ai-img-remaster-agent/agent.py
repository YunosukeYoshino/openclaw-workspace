...
class EroticAiImgRemaster:
    """えっちAI画像リマスター エージェント。画像のリマスター化。"""

    def __init__(self, db_path: str = "agents/erotic-ai-img-remaster-agent/data.db"):
