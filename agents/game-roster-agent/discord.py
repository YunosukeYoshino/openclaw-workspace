#!/usr/bin/env python3
"""
Discord integration for game-roster-agent
"""
...
class GameRosterBot(commands.Bot):
    """Discord bot for game-roster-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-roster-agent/data.db"):
