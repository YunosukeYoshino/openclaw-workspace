#!/usr/bin/env python3
"""
Discord integration for secret-manager-agent
"""
...
class SecretManagerBot(commands.Bot):
    """Discord bot for secret-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/secret-manager-agent/data.db"):
