...
# -*- coding: utf-8 -*-
"""
game-ml-model-agent - Database Module
SQLite database management for game-ml-model-agent
"""
...
class GameMlModelAgentDB:
    """Database manager for game-ml-model-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-ml-model-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-ml-model-agent initialized at " + str(db.db_path))
