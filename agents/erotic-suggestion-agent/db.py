...
class EroticSuggestionAgentDB:
    """えっちコンテンツ提案エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/erotic-suggestion-agent.db"):
...
async def main():
    """動作確認"""
    db = EroticSuggestionAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for えっちコンテンツ提案エージェント"
    )
