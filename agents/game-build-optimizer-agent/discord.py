#!/usr/bin/env python3
"""
Discord integration for game-build-optimizer-agent
"""
...
class GameBuildOptimizerBot(commands.Bot):
    """Discord bot for game-build-optimizer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-build-optimizer-agent/data.db"):
