...
class EroticContentModerationAgent:
    """えっちコンテンツモデレーションエージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "erotic-content-moderation-agent"
        self.title = "えっちコンテンツモデレーションエージェント"
        self.description = "えっちコンテンツのモデレーション"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for えっちコンテンツモデレーションエージェント"
        }
    }
