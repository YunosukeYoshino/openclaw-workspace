#!/usr/bin/env python3
"""
Discord integration for etl-pipeline-v2-agent
"""
...
class EtlPipelineV2Bot(commands.Bot):
    """Discord bot for etl-pipeline-v2-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/etl-pipeline-v2-agent/data.db"):
