#!/usr/bin/env python3
"""
Database module for baseball-commentator-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "baseball-commentator-agent.db"
...
class Database:
    """Database operations for baseball-commentator-agent"""
