#!/usr/bin/env python3
"""
Discord integration for game-guild-agent
"""
...
class GameGuildBot(commands.Bot):
    """Discord bot for game-guild-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-guild-agent/data.db"):
