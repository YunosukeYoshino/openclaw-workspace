...
# -*- coding: utf-8 -*-
"""
vpn-manager-agent - Database Module
SQLite database management for vpn-manager-agent
"""
...
class VpnManagerAgentDB:
    """Database manager for vpn-manager-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "vpn-manager-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for vpn-manager-agent initialized at " + str(db.db_path))
