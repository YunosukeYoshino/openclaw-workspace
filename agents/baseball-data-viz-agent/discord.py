#!/usr/bin/env python3
"""
baseball-data-viz-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballDataVizAgentDB

class BaseballDataVizAgentDiscordBot(commands.Bot):
    """baseball-data-viz-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-data-viz-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballDataVizAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballDataVizAgentDiscordBot()
