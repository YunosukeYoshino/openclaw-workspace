#!/usr/bin/env python3
"""
baseball-chart-generator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballChartGeneratorAgentDB

class BaseballChartGeneratorAgentDiscordBot(commands.Bot):
    """baseball-chart-generator-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-chart-generator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballChartGeneratorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballChartGeneratorAgentDiscordBot()
