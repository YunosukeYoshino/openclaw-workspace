#!/usr/bin/env python3
"""
Discord integration for game-recruitment-agent
"""
...
class GameRecruitmentBot(commands.Bot):
    """Discord bot for game-recruitment-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-recruitment-agent/data.db"):
