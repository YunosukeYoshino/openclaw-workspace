#!/usr/bin/env python3
"""
erotic-api-gateway-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticApiGatewayAgentDB

class EroticApiGatewayAgentDiscordBot(commands.Bot):
    """erotic-api-gateway-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-api-gateway-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticApiGatewayAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticApiGatewayAgentDiscordBot()
