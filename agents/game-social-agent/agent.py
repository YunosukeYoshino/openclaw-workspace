#!/usr/bin/env python3
"""
game-social-agent エージェント
game-social-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class GameSocialAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "game-social-agent.db"
