#!/usr/bin/env python3
"""
Discord integration for helm-chart-agent
"""
...
class HelmChartBot(commands.Bot):
    """Discord bot for helm-chart-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/helm-chart-agent/data.db"):
