...
```python
from agent import EroticPlatformAnalyticsAgent
from db import EroticPlatformAnalyticsAgentDB
...
- `!erotic-platform-analytics-agent_help` - Show help information
- `!erotic-platform-analytics-agent_status` - Show agent status
...
### EroticPlatformAnalyticsAgentDB
