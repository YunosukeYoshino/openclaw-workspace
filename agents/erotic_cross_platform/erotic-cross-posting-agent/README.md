...
```python
from agent import EroticCrossPostingAgent
from db import EroticCrossPostingAgentDB
...
- `!erotic-cross-posting-agent_help` - Show help information
- `!erotic-cross-posting-agent_status` - Show agent status
