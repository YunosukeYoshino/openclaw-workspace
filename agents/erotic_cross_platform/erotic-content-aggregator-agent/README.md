...
```python
from agent import EroticContentAggregatorAgent
from db import EroticContentAggregatorAgentDB
...
- `!erotic-content-aggregator-agent_help` - Show help information
- `!erotic-content-aggregator-agent_status` - Show agent status
...
### EroticContentAggregatorAgentDB
