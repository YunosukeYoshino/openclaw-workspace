...
```python
from agent import EroticUnifiedLibraryAgent
from db import EroticUnifiedLibraryAgentDB
...
- `!erotic-unified-library-agent_help` - Show help information
- `!erotic-unified-library-agent_status` - Show agent status
