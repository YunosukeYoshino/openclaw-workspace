...
```python
from agent import EroticMultiPlatformSyncAgent
from db import EroticMultiPlatformSyncAgentDB
...
- `!erotic-multi-platform-sync-agent_help` - Show help information
- `!erotic-multi-platform-sync-agent_status` - Show agent status
...
### EroticMultiPlatformSyncAgentDB
