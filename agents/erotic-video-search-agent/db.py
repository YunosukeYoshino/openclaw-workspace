#!/usr/bin/env python3
"""
Database module for erotic-video-search-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "erotic-video-search-agent.db"
...
class Database:
    """Database operations for erotic-video-search-agent"""
