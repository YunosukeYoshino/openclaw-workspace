#!/usr/bin/env python3
"""
game-brand-licensing-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameBrandLicensingAgentDB

class GameBrandLicensingAgentDiscordBot(commands.Bot):
    """game-brand-licensing-agent Discord Bot"""

    def __init__(self, db_path: str = "game-brand-licensing-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameBrandLicensingAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameBrandLicensingAgentDiscordBot()
