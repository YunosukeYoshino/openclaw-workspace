#!/usr/bin/env python3
"""
Discord integration for datawarehouse-agent
"""
...
class DatawarehouseBot(commands.Bot):
    """Discord bot for datawarehouse-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/datawarehouse-agent/data.db"):
