#!/usr/bin/env python3
"""
baseball-fan-event-booking-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballFanEventBookingAgentDB

class BaseballFanEventBookingAgentDiscordBot(commands.Bot):
    """baseball-fan-event-booking-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-fan-event-booking-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballFanEventBookingAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballFanEventBookingAgentDiscordBot()
