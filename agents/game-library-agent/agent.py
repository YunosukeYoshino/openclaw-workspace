#!/usr/bin/env python3
"""
game-library-agent エージェント
game-library-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class GameLibraryAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "game-library-agent.db"
