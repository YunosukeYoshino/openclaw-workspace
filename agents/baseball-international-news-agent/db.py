...
# -*- coding: utf-8 -*-
"""
Database for Baseball International News Agent
野球国際ニュースエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-international-news-agent.db"


class BaseballInternationalNewsAgentDB:
    """Database handler for Baseball International News Agent"""
...
if __name__ == "__main__":
    db = BaseballInternationalNewsAgentDB()
    print(f"Database initialized: "野球国際ニュースエージェント"")
