#!/usr/bin/env python3
"""
character-tracker-agent Discord Bot
Discord bot interface for character-tracker-agent
"""
...
class CharacterTrackerAgentBot(commands.Bot):
    """Discord Bot for character-tracker-agent"""
