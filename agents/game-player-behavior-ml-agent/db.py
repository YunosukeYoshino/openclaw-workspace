...
# -*- coding: utf-8 -*-
"""
game-player-behavior-ml-agent - Database Module
SQLite database management for game-player-behavior-ml-agent
"""
...
class GamePlayerBehaviorMlAgentDB:
    """Database manager for game-player-behavior-ml-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-player-behavior-ml-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-player-behavior-ml-agent initialized at " + str(db.db_path))
