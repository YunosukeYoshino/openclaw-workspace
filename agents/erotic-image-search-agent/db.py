#!/usr/bin/env python3
"""
Database module for erotic-image-search-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "erotic-image-search-agent.db"
...
class Database:
    """Database operations for erotic-image-search-agent"""
