...
class SecurityGapAnalysisAgent:
    """セキュリティギャップ分析エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "security-gap-analysis-agent"
        self.title = "セキュリティギャップ分析エージェント"
        self.description = "セキュリティギャップの分析"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for セキュリティギャップ分析エージェント"
        }
    }
