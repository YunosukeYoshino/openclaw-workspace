#!/usr/bin/env python3
"""
Discord integration for baseball-announcer-script-agent
"""
...
class BaseballAnnouncerScriptBot(commands.Bot):
    """Discord bot for baseball-announcer-script-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-announcer-script-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballAnnouncerScriptBot()
