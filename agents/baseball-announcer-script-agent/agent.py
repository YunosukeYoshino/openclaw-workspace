...
class BaseballAnnouncerScript:
    """野球アナウンサースクリプトエージェント。放送用スクリプトの作成。"""

    def __init__(self, db_path: str = "agents/baseball-announcer-script-agent/data.db"):
