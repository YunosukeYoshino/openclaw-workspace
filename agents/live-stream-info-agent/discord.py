#!/usr/bin/env python3
"""
live-stream-info-agent Discord Bot
Discord bot interface for live-stream-info-agent
"""
...
class LiveStreamInfoAgentBot(commands.Bot):
    """Discord Bot for live-stream-info-agent"""

    def __init__(self, command_prefix: str = "!"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix=command_prefix, intents=intents)
        self.agent_name = "live-stream-info-agent"
