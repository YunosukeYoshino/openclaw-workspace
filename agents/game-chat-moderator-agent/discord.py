#!/usr/bin/env python3
"""
Discord integration for game-chat-moderator-agent
"""
...
class GameChatModeratorBot(commands.Bot):
    """Discord bot for game-chat-moderator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-chat-moderator-agent/data.db"):
