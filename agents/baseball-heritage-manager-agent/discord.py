#!/usr/bin/env python3
"""
baseball-heritage-manager-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballHeritageManagerAgentDB

class BaseballHeritageManagerAgentDiscordBot(commands.Bot):
    """baseball-heritage-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-heritage-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballHeritageManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballHeritageManagerAgentDiscordBot()
