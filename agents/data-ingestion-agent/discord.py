#!/usr/bin/env python3
"""
Discord integration for data-ingestion-agent
"""
...
class DataIngestionBot(commands.Bot):
    """Discord bot for data-ingestion-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/data-ingestion-agent/data.db"):
