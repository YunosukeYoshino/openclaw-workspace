#!/usr/bin/env python3
"""
artwork-agent Discord Bot
Discord bot interface for artwork-agent
"""
...
class ArtworkAgentBot(commands.Bot):
    """Discord Bot for artwork-agent"""

    def __init__(self, command_prefix: str = "!"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix=command_prefix, intents=intents)
        self.agent_name = "artwork-agent"
