#!/usr/bin/env python3
"""
Database for 野球国際選手エージェント / Baseball International Agent
"""
...
class Database:
    """Database for baseball-international-agent"""

    def __init__(self, db_path: str = "data/baseball-international-agent.db"):
