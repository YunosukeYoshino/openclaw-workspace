...
# -*- coding: utf-8 -*-
"""
game-balance-ml-agent - Database Module
SQLite database management for game-balance-ml-agent
"""
...
class GameBalanceMlAgentDB:
    """Database manager for game-balance-ml-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-balance-ml-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-balance-ml-agent initialized at " + str(db.db_path))
