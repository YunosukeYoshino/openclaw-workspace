...
class BaseballMetricsAgent:
    """野球メトリクス管理エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-metrics-agent"
        self.title = "野球メトリクス管理エージェント"
        self.description = "野球メトリクスの収集・管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球メトリクス管理エージェント"
        }
    }
