#!/usr/bin/env python3
"""
Discord integration for erotic-ai-summary-agent
"""
...
class EroticAiSummaryBot(commands.Bot):
    """Discord bot for erotic-ai-summary-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-summary-agent/data.db"):
