#!/usr/bin/env python3
"""
Discord integration for baseball-presentation-agent
"""
...
class BaseballPresentationBot(commands.Bot):
    """Discord bot for baseball-presentation-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-presentation-agent/data.db"):
