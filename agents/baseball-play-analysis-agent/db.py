...
class BaseballPlayAnalysisAgentDB:
    """野球プレイ分析エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-play-analysis-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballPlayAnalysisAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球プレイ分析エージェント"
    )
