#!/usr/bin/env python3
"""
baseball-ai-strategy-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballAiStrategyAgentDB

class BaseballAiStrategyAgentDiscordBot(commands.Bot):
    """baseball-ai-strategy-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-ai-strategy-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballAiStrategyAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballAiStrategyAgentDiscordBot()
