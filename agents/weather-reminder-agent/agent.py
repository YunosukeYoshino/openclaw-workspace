#!/usr/bin/env python3
"""
weather-reminder-agent エージェント
weather-reminder-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class WeatherReminderAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "weather-reminder-agent.db"
