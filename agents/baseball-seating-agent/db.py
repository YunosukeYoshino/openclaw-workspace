...
class BaseballSeatingAgentDB:
    """野球場座席エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-seating-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballSeatingAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球場座席エージェント"
    )
