#!/usr/bin/env python3
"""
notification-broker-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import NotificationBrokerAgentDB

class NotificationBrokerAgentDiscordBot(commands.Bot):
    """notification-broker-agent Discord Bot"""

    def __init__(self, db_path: str = "notification-broker-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = NotificationBrokerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = NotificationBrokerAgentDiscordBot()
