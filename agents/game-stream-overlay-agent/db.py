...
# -*- coding: utf-8 -*-
"""
Database for Game Stream Overlay Agent
ゲーム配信オーバーレイエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-stream-overlay-agent.db"


class GameStreamOverlayAgentDB:
    """Database handler for Game Stream Overlay Agent"""
...
if __name__ == "__main__":
    db = GameStreamOverlayAgentDB()
    print(f"Database initialized: "ゲーム配信オーバーレイエージェント"")
