...
class BaseballScoutNetwork:
    """野球スカウトネットワークエージェント。スカウトネットワークの管理。"""

    def __init__(self, db_path: str = "agents/baseball-scout-network-agent/data.db"):
