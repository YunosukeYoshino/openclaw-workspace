#!/usr/bin/env python3
"""
Discord integration for baseball-scout-network-agent
"""
...
class BaseballScoutNetworkBot(commands.Bot):
    """Discord bot for baseball-scout-network-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-scout-network-agent/data.db"):
