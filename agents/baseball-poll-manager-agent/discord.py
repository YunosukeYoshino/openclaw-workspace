#!/usr/bin/env python3
"""
baseball-poll-manager-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballPollManagerAgentDB

class BaseballPollManagerAgentDiscordBot(commands.Bot):
    """baseball-poll-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-poll-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballPollManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballPollManagerAgentDiscordBot()
