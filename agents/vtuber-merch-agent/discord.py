#!/usr/bin/env python3
"""
vtuber-merch-agent Discord Bot
Discord bot interface for vtuber-merch-agent
"""
...
class VtuberMerchAgentBot(commands.Bot):
    """Discord Bot for vtuber-merch-agent"""

    def __init__(self, command_prefix: str = "!"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix=command_prefix, intents=intents)
        self.agent_name = "vtuber-merch-agent"
