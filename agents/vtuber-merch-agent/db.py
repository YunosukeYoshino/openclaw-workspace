#!/usr/bin/env python3
"""
vtuber-merch-agent Database Module
SQLite database for vtuber-merch-agent
"""
...
class VtuberMerchAgentDatabase:
    """Database for vtuber-merch-agent"""

    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            db_path = os.path.join(os.path.dirname(__file__), "vtuber-merch-agent.db")
