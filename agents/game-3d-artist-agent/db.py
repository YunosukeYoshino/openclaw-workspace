...
# -*- coding: utf-8 -*-
"""
game-3d-artist-agent - Database Module
SQLite database management for game-3d-artist-agent
"""
...
class Game3dArtistAgentDB:
    """Database manager for game-3d-artist-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-3d-artist-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-3d-artist-agent initialized at " + str(db.db_path))
