...
class InsuranceAgent:
    """InsuranceAgent - Discord-based insurance agent with SQLite database and natural language processing. Supports both Japanese and English languages."""

    def __init__(self, db_path: str = None):
        """初期化"""
        if db_path is None:
            db_path = Path(__file__).parent / "insurance-agent.db"
        self.db = Database(str(db_path))
        self.table_name = "insurance_agent"
...
if __name__ == "__main__":
    ...
    print(f"{InsuranceAgent} initialized")
