#!/usr/bin/env python3
"""
Database module for erotic-ai-generator-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "erotic-ai-generator-agent.db"
...
class Database:
    """Database operations for erotic-ai-generator-agent"""
