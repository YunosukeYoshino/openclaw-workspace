#!/usr/bin/env python3
"""
game-data-restore-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameDataRestoreAgentDB

class GameDataRestoreAgentDiscordBot(commands.Bot):
    """game-data-restore-agent Discord Bot"""

    def __init__(self, db_path: str = "game-data-restore-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameDataRestoreAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameDataRestoreAgentDiscordBot()
