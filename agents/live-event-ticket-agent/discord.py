#!/usr/bin/env python3
"""
live-event-ticket-agent Discord Bot
Discord bot interface for live-event-ticket-agent
"""
...
class LiveEventTicketAgentBot(commands.Bot):
    """Discord Bot for live-event-ticket-agent"""

    def __init__(self, command_prefix: str = "!"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix=command_prefix, intents=intents)
        self.agent_name = "live-event-ticket-agent"
