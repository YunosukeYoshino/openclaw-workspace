#!/usr/bin/env python3
"""
email-sender-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EmailSenderAgentDB

class EmailSenderAgentDiscordBot(commands.Bot):
    """email-sender-agent Discord Bot"""

    def __init__(self, db_path: str = "email-sender-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EmailSenderAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EmailSenderAgentDiscordBot()
