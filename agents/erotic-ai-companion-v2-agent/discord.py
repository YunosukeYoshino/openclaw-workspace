...
class EroticAiCompanionV2AgentDiscord:
    """えっちAIコンパニオンV2エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticAiCompanionV2AgentDiscord()
    await bot.start()
