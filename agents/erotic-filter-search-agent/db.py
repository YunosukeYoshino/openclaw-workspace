#!/usr/bin/env python3
"""
Database module for erotic-filter-search-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "erotic-filter-search-agent.db"
...
class Database:
    """Database operations for erotic-filter-search-agent"""
