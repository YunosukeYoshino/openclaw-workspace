#!/usr/bin/env python3
"""
Discord integration for encryption-service-agent
"""
...
class EncryptionServiceBot(commands.Bot):
    """Discord bot for encryption-service-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/encryption-service-agent/data.db"):
