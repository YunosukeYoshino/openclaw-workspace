#!/usr/bin/env python3
"""
Database for ゲームeスポーツカレンダーエージェント / Game Esports Calendar Agent
"""
...
class Database:
    """Database for game-esports-calendar-agent"""

    def __init__(self, db_path: str = "data/game-esports-calendar-agent.db"):
