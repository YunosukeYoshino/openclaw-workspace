#!/usr/bin/env python3
"""
Discord integration for game-subscription-alert-agent
"""
...
class GameSubscriptionAlertBot(commands.Bot):
    """Discord bot for game-subscription-alert-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-subscription-alert-agent/data.db"):
