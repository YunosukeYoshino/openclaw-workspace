...
class GameStreamSponsorAgent:
    """ゲーム配信スポンサーエージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "game-stream-sponsor-agent"
        self.title = "ゲーム配信スポンサーエージェント"
        self.description = "ゲーム配信のスポンサー管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for ゲーム配信スポンサーエージェント"
        }
    }
