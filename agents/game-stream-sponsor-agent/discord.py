...
class GameStreamSponsorAgentDiscord:
    """ゲーム配信スポンサーエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameStreamSponsorAgentDiscord()
    await bot.start()
