...
# -*- coding: utf-8 -*-
"""
stream-processor-agent - Database Module
SQLite database management for stream-processor-agent
"""
...
class StreamProcessorAgentDB:
    """Database manager for stream-processor-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "stream-processor-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for stream-processor-agent initialized at " + str(db.db_path))
