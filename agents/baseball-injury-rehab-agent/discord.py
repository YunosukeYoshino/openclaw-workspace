#!/usr/bin/env python3
"""
野球怪我リハビリエージェント - Discord Bot Integration
"""
...
class BaseballInjuryRehabAgentDiscordBot(commands.Bot):
    """野球怪我リハビリエージェント - Discord Bot"""
    ...
    async def stats(self, ctx: commands.Context):
        ...
        embed = discord.Embed(title=f"野球怪我リハビリエージェント 統計情報", color=discord.Color.blue())
...
def run_bot(token: str):
    bot = BaseballInjuryRehabAgentDiscordBot(command_prefix="!")
    bot.run(token)
