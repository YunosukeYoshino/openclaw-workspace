#!/usr/bin/env python3
"""
Discord integration for cache-warmup-agent
"""
...
class CacheWarmupBot(commands.Bot):
    """Discord bot for cache-warmup-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/cache-warmup-agent/data.db"):
