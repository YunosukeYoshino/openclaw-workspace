#!/usr/bin/env python3
"""
Discord integration for esports-sponsorship-agent
"""
...
class EsportsSponsorshipBot(commands.Bot):
    """Discord bot for esports-sponsorship-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/esports-sponsorship-agent/data.db"):
