...
class BaseballPhysicalCoachV2:
    """野球フィジカルコーチV2エージェント。高度フィジカルトレーニング。"""

    def __init__(self, db_path: str = "agents/baseball-physical-coach-v2-agent/data.db"):
