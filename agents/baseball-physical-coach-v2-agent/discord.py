#!/usr/bin/env python3
"""
Discord integration for baseball-physical-coach-v2-agent
"""
...
class BaseballPhysicalCoachV2Bot(commands.Bot):
    """Discord bot for baseball-physical-coach-v2-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-physical-coach-v2-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballPhysicalCoachV2Bot()
