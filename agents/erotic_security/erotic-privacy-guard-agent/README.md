...
```python
from agent import EroticPrivacyGuardAgent
from db import EroticPrivacyGuardAgentDB
...
- `!erotic-privacy-guard-agent_help` - Show help information
- `!erotic-privacy-guard-agent_status` - Show agent status
