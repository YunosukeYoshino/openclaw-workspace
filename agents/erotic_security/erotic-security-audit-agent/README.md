...
```python
from agent import EroticSecurityAuditAgent
from db import EroticSecurityAuditAgentDB
...
- `!erotic-security-audit-agent_help` - Show help information
- `!erotic-security-audit-agent_status` - Show agent status
