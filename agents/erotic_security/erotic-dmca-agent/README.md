...
```python
from agent import EroticDmcaAgent
from db import EroticDmcaAgentDB
...
- `!erotic-dmca-agent_help` - Show help information
- `!erotic-dmca-agent_status` - Show agent status
