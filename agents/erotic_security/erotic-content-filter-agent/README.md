...
```python
from agent import EroticContentFilterAgent
from db import EroticContentFilterAgentDB
...
- `!erotic-content-filter-agent_help` - Show help information
- `!erotic-content-filter-agent_status` - Show agent status
