...
class K8sDeploymentAgentDB:
    """K8sデプロイメントエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/k8s-deployment-agent.db"):
...
async def main():
    """動作確認"""
    db = K8sDeploymentAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for K8sデプロイメントエージェント"
    )
