#!/usr/bin/env python3
"""
Discord integration for game-live-qa-agent
"""
...
class GameLiveQaBot(commands.Bot):
    """Discord bot for game-live-qa-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-live-qa-agent/data.db"):
