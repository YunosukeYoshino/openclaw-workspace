#!/usr/bin/env python3
"""
Discord integration for event-bus-agent
"""
...
class EventBusBot(commands.Bot):
    """Discord bot for event-bus-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/event-bus-agent/data.db"):
