...
# -*- coding: utf-8 -*-
"""
Database for Baseball Data Warehouse Agent
野球データウェアハウスエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-data-warehouse-agent.db"


class BaseballDataWarehouseAgentDB:
    """Database handler for Baseball Data Warehouse Agent"""
...
if __name__ == "__main__":
    db = BaseballDataWarehouseAgentDB()
    print(f"Database initialized: "野球データウェアハウスエージェント"")
