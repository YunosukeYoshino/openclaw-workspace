...
# -*- coding: utf-8 -*-
"""
game-ar-content-agent - Database Module
SQLite database management for game-ar-content-agent
"""
...
class GameArContentAgentDB:
    """Database manager for game-ar-content-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-ar-content-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-ar-content-agent initialized at " + str(db.db_path))
