#!/usr/bin/env python3
"""
data-sync-manager-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import DataSyncManagerAgentDB

class DataSyncManagerAgentDiscordBot(commands.Bot):
    """data-sync-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "data-sync-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = DataSyncManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = DataSyncManagerAgentDiscordBot()
