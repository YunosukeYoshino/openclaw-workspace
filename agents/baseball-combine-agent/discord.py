#!/usr/bin/env python3
"""
Discord integration for baseball-combine-agent
"""
...
class BaseballCombineBot(commands.Bot):
    """Discord bot for baseball-combine-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-combine-agent/data.db"):
