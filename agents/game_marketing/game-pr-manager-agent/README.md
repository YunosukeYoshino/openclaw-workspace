...
```python
from agent import GamePrManagerAgent
from db import GamePrManagerAgentDB
...
- `!game-pr-manager-agent_help` - Show help information
- `!game-pr-manager-agent_status` - Show agent status
