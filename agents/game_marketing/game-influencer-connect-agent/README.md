...
```python
from agent import GameInfluencerConnectAgent
from db import GameInfluencerConnectAgentDB
...
- `!game-influencer-connect-agent_help` - Show help information
- `!game-influencer-connect-agent_status` - Show agent status
