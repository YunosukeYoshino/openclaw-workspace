...
```python
from agent import GameContentMarketingAgent
from db import GameContentMarketingAgentDB
...
- `!game-content-marketing-agent_help` - Show help information
- `!game-content-marketing-agent_status` - Show agent status
