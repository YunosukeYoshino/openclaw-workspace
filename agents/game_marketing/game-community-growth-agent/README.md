...
```python
from agent import GameCommunityGrowthAgent
from db import GameCommunityGrowthAgentDB
...
- `!game-community-growth-agent_help` - Show help information
- `!game-community-growth-agent_status` - Show agent status
