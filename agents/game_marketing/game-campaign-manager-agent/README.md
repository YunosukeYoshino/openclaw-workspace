...
```python
from agent import GameCampaignManagerAgent
from db import GameCampaignManagerAgentDB
...
- `!game-campaign-manager-agent_help` - Show help information
- `!game-campaign-manager-agent_status` - Show agent status
