#!/usr/bin/env python3
"""
terraform-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import TerraformAgentDB

class TerraformAgentDiscordBot(commands.Bot):
    """terraform-agent Discord Bot"""

    def __init__(self, db_path: str = "terraform-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = TerraformAgentDB(db_path)
