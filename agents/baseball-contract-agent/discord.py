#!/usr/bin/env python3
"""
Discord integration for baseball-contract-agent
"""
...
class BaseballContractBot(commands.Bot):
    """Discord bot for baseball-contract-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-contract-agent/data.db"):
