#!/usr/bin/env python3
"""
baseball-community-moderation-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballCommunityModerationAgentDB

class BaseballCommunityModerationAgentDiscordBot(commands.Bot):
    """baseball-community-moderation-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-community-moderation-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballCommunityModerationAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballCommunityModerationAgentDiscordBot()
