...
class GameAiModelAgentDB:
    """ゲームAIモデルエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/game-ai-model-agent.db"):
...
async def main():
    """動作確認"""
    db = GameAiModelAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for ゲームAIモデルエージェント"
    )
