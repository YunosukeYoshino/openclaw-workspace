#!/usr/bin/env python3
"""
cache-manager-agent - Discord Botモジュール
"""
...
class CacheManagerAgentDiscordBot(commands.Bot):
    """cache-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "cache-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = CacheManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = CacheManagerAgentDiscordBot()
