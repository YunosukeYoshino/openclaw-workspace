#!/usr/bin/env python3
"""
Discord integration for cache-manager-agent
"""
...
class CacheManagerBot(commands.Bot):
    """Discord bot for cache-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/cache-manager-agent/data.db"):
