#!/usr/bin/env python3
"""
log-collector-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import LogCollectorAgentDB

class LogCollectorAgentDiscordBot(commands.Bot):
    """log-collector-agent Discord Bot"""

    def __init__(self, db_path: str = "log-collector-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = LogCollectorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = LogCollectorAgentDiscordBot()
