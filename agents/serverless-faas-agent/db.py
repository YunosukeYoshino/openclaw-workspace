...
# -*- coding: utf-8 -*-
"""
serverless-faas-agent - Database Module
SQLite database management for serverless-faas-agent
"""
...
class ServerlessFaasAgentDB:
    """Database manager for serverless-faas-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "serverless-faas-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for serverless-faas-agent initialized at " + str(db.db_path))
