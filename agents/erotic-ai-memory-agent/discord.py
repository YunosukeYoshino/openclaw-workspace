#!/usr/bin/env python3
"""
Discord integration for erotic-ai-memory-agent
"""
...
class EroticAiMemoryBot(commands.Bot):
    """Discord bot for erotic-ai-memory-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-memory-agent/data.db"):
