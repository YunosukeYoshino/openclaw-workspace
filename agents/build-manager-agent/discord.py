#!/usr/bin/env python3
"""
build-manager-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BuildManagerAgentDB

class BuildManagerAgentDiscordBot(commands.Bot):
    """build-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "build-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BuildManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BuildManagerAgentDiscordBot()
