#!/usr/bin/env python3
"""
Database module for baseball-pitching-analytics-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "baseball-pitching-analytics-agent.db"
...
class Database:
    """Database operations for baseball-pitching-analytics-agent"""
