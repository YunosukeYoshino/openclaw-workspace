...
class GameCreatorManager:
    """ゲームクリエイターマネージャーエージェント。クリエイターの管理。"""

    def __init__(self, db_path: str = "agents/game-creator-manager-agent/data.db"):
