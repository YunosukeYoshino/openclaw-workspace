#!/usr/bin/env python3
"""
game-progress-agent エージェント
game-progress-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class GameProgressAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "game-progress-agent.db"
