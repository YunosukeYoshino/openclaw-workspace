#!/usr/bin/env python3
"""
Discord integration for service-discovery-agent
"""
...
class ServiceDiscoveryBot(commands.Bot):
    """Discord bot for service-discovery-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/service-discovery-agent/data.db"):
