#!/usr/bin/env python3
"""
service-discovery-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import ServiceDiscoveryAgentDB

class ServiceDiscoveryAgentDiscordBot(commands.Bot):
    """service-discovery-agent Discord Bot"""

    def __init__(self, db_path: str = "service-discovery-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = ServiceDiscoveryAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = ServiceDiscoveryAgentDiscordBot()
