...
class EroticPreferenceAgentDB:
    """えっち嗜好分析エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/erotic-preference-agent.db"):
...
async def main():
    """動作確認"""
    db = EroticPreferenceAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for えっち嗜好分析エージェント"
    )
