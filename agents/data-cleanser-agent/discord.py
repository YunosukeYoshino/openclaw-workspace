#!/usr/bin/env python3
"""
data-cleanser-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import DataCleanserAgentDB

class DataCleanserAgentDiscordBot(commands.Bot):
    """data-cleanser-agent Discord Bot"""

    def __init__(self, db_path: str = "data-cleanser-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = DataCleanserAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = DataCleanserAgentDiscordBot()
