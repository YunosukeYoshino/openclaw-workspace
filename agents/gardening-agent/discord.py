#!/usr/bin/env python3
"""
gardening-agent - Discord Bot Module

Discord bot for gardening-agent - 植物の世話・育成記録・カレンダー
"""
...
class DiscordBot(commands.Bot):
    """Discord bot for gardening-agent"""
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Plant care, growing records, and calendar"
        )
