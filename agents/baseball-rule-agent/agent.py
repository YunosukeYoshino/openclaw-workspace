...
"""
野球ルール説明エージェント
Baseball Rule Explanation Agent

野球のルール・用語を説明するエージェント
Agent for explaining baseball rules and terminology
"""
...
class BaseballRuleAgentAgent:
    "Baseball Rule Explanation Agent""

    def __init__(self, db_path: str = "data/baseball-rule-agent.db"):
        self.db = BaseballRuleAgentDB(db_path)
        self.name = "野球ルール説明エージェント"
