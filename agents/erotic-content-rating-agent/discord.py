#!/usr/bin/env python3
"""
Discord integration for erotic-content-rating-agent
"""
...
class EroticContentRatingBot(commands.Bot):
    """Discord bot for erotic-content-rating-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-content-rating-agent/data.db"):
