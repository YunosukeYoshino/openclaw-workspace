...
class EroticContentRating:
    """えっちコンテンツレーティングエージェント。コンテンツのレーティング。"""

    def __init__(self, db_path: str = "agents/erotic-content-rating-agent/data.db"):
