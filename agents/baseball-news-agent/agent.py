#!/usr/bin/env python3
"""
baseball-news-agent エージェント
baseball-news-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class BaseballNewsAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "baseball-news-agent.db"
