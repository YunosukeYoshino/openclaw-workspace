...
class ServerlessStorageAgentDiscord:
    """サーバーレスストレージエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = ServerlessStorageAgentDiscord()
    await bot.start()
