#!/usr/bin/env python3
"""
Discord integration for baseball-facility-booking-agent
"""
...
class BaseballFacilityBookingBot(commands.Bot):
    """Discord bot for baseball-facility-booking-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-facility-booking-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballFacilityBookingBot()
