#!/usr/bin/env python3
"""
Discord integration for game-skill-tracker-agent
"""
...
class GameSkillTrackerBot(commands.Bot):
    """Discord bot for game-skill-tracker-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-skill-tracker-agent/data.db"):
