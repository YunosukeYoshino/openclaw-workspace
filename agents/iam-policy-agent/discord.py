#!/usr/bin/env python3
"""
Discord integration for iam-policy-agent
"""
...
class IamPolicyBot(commands.Bot):
    """Discord bot for iam-policy-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/iam-policy-agent/data.db"):
