#!/usr/bin/env python3
"""
Discord integration for database-sync-agent
"""
...
class DatabaseSyncBot(commands.Bot):
    """Discord bot for database-sync-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/database-sync-agent/data.db"):
