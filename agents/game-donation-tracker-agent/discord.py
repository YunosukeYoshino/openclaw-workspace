#!/usr/bin/env python3
"""
Discord integration for game-donation-tracker-agent
"""
...
class GameDonationTrackerBot(commands.Bot):
    """Discord bot for game-donation-tracker-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-donation-tracker-agent/data.db"):
