#!/usr/bin/env python3
"""
vtuber-archive-agent Discord Bot
Discord bot interface for vtuber-archive-agent
"""
...
class VtuberArchiveAgentBot(commands.Bot):
    """Discord Bot for vtuber-archive-agent"""
