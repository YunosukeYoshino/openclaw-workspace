...
```python
from agent import GameMonetizationAgent
from db import GameMonetizationAgentDB
...
- `!game-monetization-agent_help` - Show help information
- `!game-monetization-agent_status` - Show agent status
