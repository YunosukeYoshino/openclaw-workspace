...
```python
from agent import GameSponsorshipAgent
from db import GameSponsorshipAgentDB
...
- `!game-sponsorship-agent_help` - Show help information
- `!game-sponsorship-agent_status` - Show agent status
