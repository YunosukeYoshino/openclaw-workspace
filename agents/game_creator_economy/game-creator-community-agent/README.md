...
```python
from agent import GameCreatorCommunityAgent
from db import GameCreatorCommunityAgentDB
...
- `!game-creator-community-agent_help` - Show help information
- `!game-creator-community-agent_status` - Show agent status
