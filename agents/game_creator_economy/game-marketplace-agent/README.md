...
```python
from agent import GameMarketplaceAgent
from db import GameMarketplaceAgentDB
...
- `!game-marketplace-agent_help` - Show help information
- `!game-marketplace-agent_status` - Show agent status
