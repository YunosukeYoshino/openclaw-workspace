...
```python
from agent import GameCreatorAnalyticsAgent
from db import GameCreatorAnalyticsAgentDB
...
- `!game-creator-analytics-agent_help` - Show help information
- `!game-creator-analytics-agent_status` - Show agent status
