...
# -*- coding: utf-8 -*-
"""
Database for Game AI NPC Behavior Agent
ゲームAI NPC行動エージェント
"""
...
DB_PATH = Path(__file__).parent / "game-ai-npc-behavior-agent.db"


class GameAiNpcBehaviorAgentDB:
    """Database handler for Game AI NPC Behavior Agent"""
...
if __name__ == "__main__":
    db = GameAiNpcBehaviorAgentDB()
    print(f"Database initialized: "ゲームAI NPC行動エージェント"")
