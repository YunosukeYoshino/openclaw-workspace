#!/usr/bin/env python3
"""
Database for 野球打順最適化エージェント / Baseball Lineup Optimizer Agent
"""
...
class Database:
    """Database for baseball-lineup-optimizer-agent"""

    def __init__(self, db_path: str = "data/baseball-lineup-optimizer-agent.db"):
