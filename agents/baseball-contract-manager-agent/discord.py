#!/usr/bin/env python3
"""
baseball-contract-manager-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballContractManagerAgentDB

class BaseballContractManagerAgentDiscordBot(commands.Bot):
    """baseball-contract-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-contract-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballContractManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballContractManagerAgentDiscordBot()
