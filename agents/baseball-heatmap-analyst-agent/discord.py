#!/usr/bin/env python3
"""
baseball-heatmap-analyst-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballHeatmapAnalystAgentDB

class BaseballHeatmapAnalystAgentDiscordBot(commands.Bot):
    """baseball-heatmap-analyst-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-heatmap-analyst-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballHeatmapAnalystAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballHeatmapAnalystAgentDiscordBot()
