...
# -*- coding: utf-8 -*-
"""
Database for Game Asset Library Agent
ゲームアセットライブラリエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-asset-library-agent.db"


class GameAssetLibraryAgentDB:
    """Database handler for Game Asset Library Agent"""
...
if __name__ == "__main__":
    db = GameAssetLibraryAgentDB()
    print(f"Database initialized: "ゲームアセットライブラリエージェント"")
