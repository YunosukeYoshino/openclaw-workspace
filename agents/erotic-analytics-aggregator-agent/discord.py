#!/usr/bin/env python3
"""
Discord integration for erotic-analytics-aggregator-agent
"""
...
class EroticAnalyticsAggregatorBot(commands.Bot):
    """Discord bot for erotic-analytics-aggregator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-analytics-aggregator-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = EroticAnalyticsAggregatorBot()
