...
# -*- coding: utf-8 -*-
"""
security-policy-manager-agent - Database Module
SQLite database management for security-policy-manager-agent
"""
...
class SecurityPolicyManagerAgentDB:
    """Database manager for security-policy-manager-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "security-policy-manager-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for security-policy-manager-agent initialized at " + str(db.db_path))
