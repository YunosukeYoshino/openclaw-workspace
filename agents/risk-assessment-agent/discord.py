#!/usr/bin/env python3
"""
Discord integration for risk-assessment-agent
"""
...
class RiskAssessmentBot(commands.Bot):
    """Discord bot for risk-assessment-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/risk-assessment-agent/data.db"):
