...
# -*- coding: utf-8 -*-
"""
terraform-manager-agent - Database Module
SQLite database management for terraform-manager-agent
"""
...
class TerraformManagerAgentDB:
    """Database manager for terraform-manager-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "terraform-manager-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for terraform-manager-agent initialized at " + str(db.db_path))
