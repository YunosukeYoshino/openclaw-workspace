...
class Baseball_Live_Notifications_AgentDB:
    """野球ライブ通知エージェント Database"""

    def __init__(self, db_path: Optional[Path] = None):
        if db_path is None:
            db_path = Path(__file__).parent / "data" / "baseball-live-notifications-agent.db"
