# えっち創作アシスタントエージェント / えっち創作アシスタントエージェント (EN)

創作活動の支援・アイデア提案エージェント / 創作活動の支援・アイデア提案エージェント

## Overview / 概要

AIを活用した創作活動の支援・アイデア提案エージェント。
...
- `!add_creative-assistant <title> <content>` - Add entry / エントリー追加
- `!list_creative-assistant [limit]` - List entries / エントリー一覧
- `!get_creative-assistant <id>` - Get entry / エントリー取得
- `!search_creative-assistant <query>` - Search entries / エントリー検索
- `!stats_creative-assistant` - Get statistics / 統計情報
