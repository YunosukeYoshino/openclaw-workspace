#!/usr/bin/env python3
"""
novel-agent - Discord Bot Module

Discord bot for novel-agent - 小説・ライトノベルの読書記録と管理
"""
...
class DiscordBot(commands.Bot):
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Novel and light novel reading tracking and management"
        )
