...
class BaseballFanCommunicationAgent:
    """野球ファンコミュニケーションエージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-fan-communication-agent"
        self.title = "野球ファンコミュニケーションエージェント"
        self.description = "野球ファンとのコミュニケーション管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球ファンコミュニケーションエージェント"
        }
    }
