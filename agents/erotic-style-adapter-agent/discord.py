#!/usr/bin/env python3
"""
erotic-style-adapter-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticStyleAdapterAgentDB

class EroticStyleAdapterAgentDiscordBot(commands.Bot):
    """erotic-style-adapter-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-style-adapter-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticStyleAdapterAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticStyleAdapterAgentDiscordBot()
