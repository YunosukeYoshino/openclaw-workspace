...
```python
from agent import GameVisualAccessibilityAgent
from db import GameVisualAccessibilityAgentDB
...
- `!game-visual-accessibility-agent_help` - Show help information
- `!game-visual-accessibility-agent_status` - Show agent status
...
### GameVisualAccessibilityAgentDB
