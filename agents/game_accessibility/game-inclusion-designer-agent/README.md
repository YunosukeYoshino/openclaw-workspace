...
```python
from agent import GameInclusionDesignerAgent
from db import GameInclusionDesignerAgentDB
...
- `!game-inclusion-designer-agent_help` - Show help information
- `!game-inclusion-designer-agent_status` - Show agent status
