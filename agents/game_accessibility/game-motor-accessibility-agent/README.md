...
```python
from agent import GameMotorAccessibilityAgent
from db import GameMotorAccessibilityAgentDB
...
- `!game-motor-accessibility-agent_help` - Show help information
- `!game-motor-accessibility-agent_status` - Show agent status
