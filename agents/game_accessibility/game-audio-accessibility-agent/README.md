...
```python
from agent import GameAudioAccessibilityAgent
from db import GameAudioAccessibilityAgentDB
...
- `!game-audio-accessibility-agent_help` - Show help information
- `!game-audio-accessibility-agent_status` - Show agent status
