...
```python
from agent import GameCognitiveAccessibilityAgent
from db import GameCognitiveAccessibilityAgentDB
...
- `!game-cognitive-accessibility-agent_help` - Show help information
- `!game-cognitive-accessibility-agent_status` - Show agent status
...
### GameCognitiveAccessibilityAgent
...
### GameCognitiveAccessibilityAgentDB
