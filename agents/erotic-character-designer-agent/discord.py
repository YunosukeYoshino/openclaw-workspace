#!/usr/bin/env python3
"""
erotic-character-designer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticCharacterDesignerAgentDB

class EroticCharacterDesignerAgentDiscordBot(commands.Bot):
    """erotic-character-designer-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-character-designer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticCharacterDesignerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticCharacterDesignerAgentDiscordBot()
