...
# -*- coding: utf-8 -*-
"""
Database for Baseball Salary Cap Agent
野球サラリーキャップエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-salary-cap-agent.db"


class BaseballSalaryCapAgentDB:
    """Database handler for Baseball Salary Cap Agent"""
...
if __name__ == "__main__":
    db = BaseballSalaryCapAgentDB()
    print(f"Database initialized: "野球サラリーキャップエージェント"")
