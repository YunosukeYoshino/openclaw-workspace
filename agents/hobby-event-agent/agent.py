#!/usr/bin/env python3
"""
hobby-event-agent エージェント
hobby-event-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class HobbyEventAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "hobby-event-agent.db"
