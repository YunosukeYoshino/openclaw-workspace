#!/usr/bin/env python3
"""
Discord integration for threat-response-agent
"""
...
class ThreatResponseBot(commands.Bot):
    """Discord bot for threat-response-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/threat-response-agent/data.db"):
