#!/usr/bin/env python3
"""
soc-analyst-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import SocAnalystAgentDB

class SocAnalystAgentDiscordBot(commands.Bot):
    """soc-analyst-agent Discord Bot"""

    def __init__(self, db_path: str = "soc-analyst-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = SocAnalystAgentDB(db_path)
