#!/usr/bin/env python3
"""
Discord integration for erotic-ai-img-animate-agent
"""
...
class EroticAiImgAnimateBot(commands.Bot):
    """Discord bot for erotic-ai-img-animate-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-img-animate-agent/data.db"):
