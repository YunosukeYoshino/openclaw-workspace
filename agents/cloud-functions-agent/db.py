...
# -*- coding: utf-8 -*-
"""
cloud-functions-agent - Database Module
SQLite database management for cloud-functions-agent
"""
...
class CloudFunctionsAgentDB:
    """Database manager for cloud-functions-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "cloud-functions-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for cloud-functions-agent initialized at " + str(db.db_path))
