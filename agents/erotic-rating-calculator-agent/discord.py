#!/usr/bin/env python3
"""
erotic-rating-calculator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticRatingCalculatorAgentDB

class EroticRatingCalculatorAgentDiscordBot(commands.Bot):
    """erotic-rating-calculator-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-rating-calculator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticRatingCalculatorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticRatingCalculatorAgentDiscordBot()
