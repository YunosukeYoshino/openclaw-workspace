#!/usr/bin/env python3
"""
Discord integration for jwt-handler-agent
"""
...
class JwtHandlerBot(commands.Bot):
    """Discord bot for jwt-handler-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/jwt-handler-agent/data.db"):
