#!/usr/bin/env python3
"""
Discord integration for game-microtransaction-agent
"""
...
class GameMicrotransactionBot(commands.Bot):
    """Discord bot for game-microtransaction-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-microtransaction-agent/data.db"):
