#!/usr/bin/env python3
"""
Database module for cloud-optimization-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "cloud-optimization-agent.db"
...
class Database:
    """Database operations for cloud-optimization-agent"""
