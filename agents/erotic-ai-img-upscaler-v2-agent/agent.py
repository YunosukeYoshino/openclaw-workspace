...
class EroticAiImgUpscalerV2:
    """えっちAI画像アップスケーラーV2エージェント。高精度アップスケーリング。"""

    def __init__(self, db_path: str = "agents/erotic-ai-img-upscaler-v2-agent/data.db"):
