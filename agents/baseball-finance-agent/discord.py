#!/usr/bin/env python3
"""
Discord integration for baseball-finance-agent
"""
...
class BaseballFinanceBot(commands.Bot):
    """Discord bot for baseball-finance-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-finance-agent/data.db"):
