...
class BaseballProspectAgentDB:
    """野球有望選手エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-prospect-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballProspectAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球有望選手エージェント"
    )
