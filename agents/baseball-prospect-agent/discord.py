#!/usr/bin/env python3
"""
Discord integration for baseball-prospect-agent
"""
...
class BaseballProspectBot(commands.Bot):
    """Discord bot for baseball-prospect-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-prospect-agent/data.db"):
