#!/usr/bin/env python3
"""
Discord integration for game-trivia-agent
"""
...
class GameTriviaBot(commands.Bot):
    """Discord bot for game-trivia-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-trivia-agent/data.db"):
