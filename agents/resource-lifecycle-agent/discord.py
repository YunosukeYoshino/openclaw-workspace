#!/usr/bin/env python3
"""
resource-lifecycle-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import ResourceLifecycleAgentDB

class ResourceLifecycleAgentDiscordBot(commands.Bot):
    """resource-lifecycle-agent Discord Bot"""

    def __init__(self, db_path: str = "resource-lifecycle-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = ResourceLifecycleAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = ResourceLifecycleAgentDiscordBot()
