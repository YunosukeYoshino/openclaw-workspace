#!/usr/bin/env python3
"""
workflow-designer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import WorkflowDesignerAgentDB

class WorkflowDesignerAgentDiscordBot(commands.Bot):
    """workflow-designer-agent Discord Bot"""

    def __init__(self, db_path: str = "workflow-designer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = WorkflowDesignerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = WorkflowDesignerAgentDiscordBot()
