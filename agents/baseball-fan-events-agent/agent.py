...
class BaseballFanEventsAgent:
    """野球ファンイベントエージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-fan-events-agent"
        self.title = "野球ファンイベントエージェント"
        self.description = "野球ファンイベントの管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球ファンイベントエージェント"
        }
    }
