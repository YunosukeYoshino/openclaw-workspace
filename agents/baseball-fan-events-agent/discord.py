...
class BaseballFanEventsAgentDiscord:
    """野球ファンイベントエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = BaseballFanEventsAgentDiscord()
    await bot.start()
