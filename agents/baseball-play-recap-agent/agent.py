...
class BaseballPlayRecapAgent:
    """野球プレイ振り返りエージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-play-recap-agent"
        self.title = "野球プレイ振り返りエージェント"
        self.description = "野球プレイの振り返り・要約"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球プレイ振り返りエージェント"
        }
    }
