...
class BaseballPlayRecapAgentDB:
    """野球プレイ振り返りエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-play-recap-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballPlayRecapAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球プレイ振り返りエージェント"
    )
