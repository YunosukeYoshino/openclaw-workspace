...
# -*- coding: utf-8 -*-
"""
stream-aggregation-agent - Database Module
SQLite database management for stream-aggregation-agent
"""
...
class StreamAggregationAgentDB:
    """Database manager for stream-aggregation-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "stream-aggregation-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for stream-aggregation-agent initialized at " + str(db.db_path))
