#!/usr/bin/env python3
"""
baseball-records-digitization-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballRecordsDigitizationAgentDB

class BaseballRecordsDigitizationAgentDiscordBot(commands.Bot):
    """baseball-records-digitization-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-records-digitization-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballRecordsDigitizationAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballRecordsDigitizationAgentDiscordBot()
