...
class EroticAnalyticsAgentDiscord:
    """えっちアナリティクスエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticAnalyticsAgentDiscord()
    await bot.start()
