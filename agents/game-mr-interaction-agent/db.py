...
# -*- coding: utf-8 -*-
"""
Database for Game MR Interaction Agent
ゲームMRインタラクションエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-mr-interaction-agent.db"


class GameMrInteractionAgentDB:
    """Database handler for Game MR Interaction Agent"""
...
if __name__ == "__main__":
    db = GameMrInteractionAgentDB()
    print(f"Database initialized: "ゲームMRインタラクションエージェント"")
