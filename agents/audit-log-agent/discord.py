#!/usr/bin/env python3
"""
Discord integration for audit-log-agent
"""
...
class AuditLogBot(commands.Bot):
    """Discord bot for audit-log-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/audit-log-agent/data.db"):
