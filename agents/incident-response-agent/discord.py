...
class IncidentResponseBot(commands.Bot):
    """Discord bot for incident-response-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/incident-response-agent/data.db"):
