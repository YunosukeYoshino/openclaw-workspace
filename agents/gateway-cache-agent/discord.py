#!/usr/bin/env python3
"""
Discord integration for gateway-cache-agent
"""
...
class GatewayCacheBot(commands.Bot):
    """Discord bot for gateway-cache-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/gateway-cache-agent/data.db"):
