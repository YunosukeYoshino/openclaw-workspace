#!/usr/bin/env python3
"""
Database for 野球マイナーリーグエージェント / Baseball Minor League Agent
"""
...
class Database:
    """Database for baseball-minor-league-agent"""

    def __init__(self, db_path: str = "data/baseball-minor-league-agent.db"):
