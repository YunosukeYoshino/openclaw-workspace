...
class MeditationAgent:
    """MeditationAgent - Meditation Agent helps you track your meditation sessions, techniques, and progress."""

    def __init__(self, db_path: str = None):
        """初期化"""
        if db_path is None:
            db_path = Path(__file__).parent / "meditation-agent.db"
        self.db = Database(str(db_path))
        self.table_name = "meditation_agent"
...
if __name__ == "__main__":
    ...
    print(f"{MeditationAgent} initialized")
