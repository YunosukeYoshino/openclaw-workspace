#!/usr/bin/env python3
"""
Database for 野球イニング戦略エージェント / Baseball Inning Strategy Agent
"""
...
class Database:
    """Database for baseball-inning-strategy-agent"""

    def __init__(self, db_path: str = "data/baseball-inning-strategy-agent.db"):
