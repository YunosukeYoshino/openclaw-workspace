#!/usr/bin/env python3
"""
erotic-pose-generator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticPoseGeneratorAgentDB

class EroticPoseGeneratorAgentDiscordBot(commands.Bot):
    """erotic-pose-generator-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-pose-generator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticPoseGeneratorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticPoseGeneratorAgentDiscordBot()
