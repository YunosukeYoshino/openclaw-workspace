#!/usr/bin/env python3
"""
Discord integration for game-ui-agent
"""
...
class GameUiBot(commands.Bot):
    """Discord bot for game-ui-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-ui-agent/data.db"):
