...
- **Walkthrough**: walkthrough management
- **Cheat**: cheat management
- **Review**: review management
- **Esports**: esports management
- **Commentary**: commentary management
...
```
!gamhelp - Show help
!gamadd <title> <content> - Add new item
!gamlist - List items
!gamsearch <query> - Search items
!gamsync <source> <target> - Sync categories
!gamdashboard - Get dashboard data
```

## Database Schema

### gaming_integrations Table
