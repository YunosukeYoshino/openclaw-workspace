...
class BaseballMachineLearningAgentDB:
    """野球機械学習エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-machine-learning-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballMachineLearningAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球機械学習エージェント"
    )
