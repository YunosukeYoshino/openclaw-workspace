#!/usr/bin/env python3
"""
Database module for baseball-hitting-analytics-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "baseball-hitting-analytics-agent.db"
...
class Database:
    """Database operations for baseball-hitting-analytics-agent"""
