#!/usr/bin/env python3
"""
vtuber-agent - Discord Bot Module

Discord bot for vtuber-agent - VTuberの配信スケジュールと情報管理
"""
...
class DiscordBot(commands.Bot):
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="VTuber streaming schedule and information management"
        )
