#!/usr/bin/env python3
"""
Discord integration for esports-business-manager-agent
"""
...
class EsportsBusinessManagerBot(commands.Bot):
    """Discord bot for esports-business-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/esports-business-manager-agent/data.db"):
