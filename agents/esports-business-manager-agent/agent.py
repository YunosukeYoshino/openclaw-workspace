...
class EsportsBusinessManager:
    """eスポーツビジネスマネージャーエージェント。eスポーツビジネス運営。"""

    def __init__(self, db_path: str = "agents/esports-business-manager-agent/data.db"):
