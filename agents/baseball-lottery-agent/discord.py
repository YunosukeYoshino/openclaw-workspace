#!/usr/bin/env python3
"""
baseball-lottery-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballLotteryAgentDB

class BaseballLotteryAgentDiscordBot(commands.Bot):
    """baseball-lottery-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-lottery-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballLotteryAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballLotteryAgentDiscordBot()
