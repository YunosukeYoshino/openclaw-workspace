...
class EroticAiEmbeddings:
    """えっちAIエンベディングスエージェント。埋め込みベクトルの生成。"""

    def __init__(self, db_path: str = "agents/erotic-ai-embeddings-agent/data.db"):
