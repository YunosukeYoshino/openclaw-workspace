#!/usr/bin/env python3
"""
Database for えっちコレクションショーケースエージェント / Erotic Collection Showcase Agent
"""
...
class Database:
    """Database for erotic-collection-showcase-agent"""

    def __init__(self, db_path: str = "data/erotic-collection-showcase-agent.db"):
