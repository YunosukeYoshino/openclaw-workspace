#!/usr/bin/env python3
"""
Discord integration for baseball-drill-share-agent
"""
...
class BaseballDrillShareBot(commands.Bot):
    """Discord bot for baseball-drill-share-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-drill-share-agent/data.db"):
