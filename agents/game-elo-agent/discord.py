#!/usr/bin/env python3
"""
Discord integration for game-elo-agent
"""
...
class GameEloBot(commands.Bot):
    """Discord bot for game-elo-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-elo-agent/data.db"):
