#!/usr/bin/env python3
"""
baseball-data-preservation-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballDataPreservationAgentDB

class BaseballDataPreservationAgentDiscordBot(commands.Bot):
    """baseball-data-preservation-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-data-preservation-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballDataPreservationAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballDataPreservationAgentDiscordBot()
