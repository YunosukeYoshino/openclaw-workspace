#!/usr/bin/env python3
"""
baseball-dashboard-builder-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballDashboardBuilderAgentDB

class BaseballDashboardBuilderAgentDiscordBot(commands.Bot):
    """baseball-dashboard-builder-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-dashboard-builder-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballDashboardBuilderAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballDashboardBuilderAgentDiscordBot()
