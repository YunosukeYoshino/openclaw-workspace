#!/usr/bin/env python3
"""
sms-gateway-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import SmsGatewayAgentDB

class SmsGatewayAgentDiscordBot(commands.Bot):
    """sms-gateway-agent Discord Bot"""

    def __init__(self, db_path: str = "sms-gateway-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = SmsGatewayAgentDB(db_path)
