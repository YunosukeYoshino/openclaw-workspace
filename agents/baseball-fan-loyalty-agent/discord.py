#!/usr/bin/env python3
"""
Discord integration for baseball-fan-loyalty-agent
"""
...
class BaseballFanLoyaltyBot(commands.Bot):
    """Discord bot for baseball-fan-loyalty-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-fan-loyalty-agent/data.db"):
