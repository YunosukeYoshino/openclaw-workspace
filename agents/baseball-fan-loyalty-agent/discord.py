...
class BaseballFanLoyaltyAgentDiscord:
    """野球ファンロイヤルティエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = BaseballFanLoyaltyAgentDiscord()
    await bot.start()
