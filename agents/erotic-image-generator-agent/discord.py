#!/usr/bin/env python3
"""
erotic-image-generator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticImageGeneratorAgentDB

class EroticImageGeneratorAgentDiscordBot(commands.Bot):
    """erotic-image-generator-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-image-generator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticImageGeneratorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticImageGeneratorAgentDiscordBot()
