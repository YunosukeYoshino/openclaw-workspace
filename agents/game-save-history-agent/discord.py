#!/usr/bin/env python3
"""
game-save-history-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameSaveHistoryAgentDB

class GameSaveHistoryAgentDiscordBot(commands.Bot):
    """game-save-history-agent Discord Bot"""

    def __init__(self, db_path: str = "game-save-history-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameSaveHistoryAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameSaveHistoryAgentDiscordBot()
