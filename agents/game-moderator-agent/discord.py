#!/usr/bin/env python3
"""
Discord integration for game-moderator-agent
"""
...
class GameModeratorBot(commands.Bot):
    """Discord bot for game-moderator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-moderator-agent/data.db"):
