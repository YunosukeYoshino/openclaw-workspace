#!/usr/bin/env python3
"""
Discord integration for baseball-scout-match-agent
"""
...
class BaseballScoutMatchBot(commands.Bot):
    """Discord bot for baseball-scout-match-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-scout-match-agent/data.db"):
