#!/usr/bin/env python3
"""
game-prototyper-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GamePrototyperAgentDB

class GamePrototyperAgentDiscordBot(commands.Bot):
    """game-prototyper-agent Discord Bot"""

    def __init__(self, db_path: str = "game-prototyper-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GamePrototyperAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GamePrototyperAgentDiscordBot()
