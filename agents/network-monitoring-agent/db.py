#!/usr/bin/env python3
"""
Database module for network-monitoring-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "network-monitoring-agent.db"
...
class Database:
    """Database operations for network-monitoring-agent"""
