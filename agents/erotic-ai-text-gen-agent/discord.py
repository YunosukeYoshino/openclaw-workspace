#!/usr/bin/env python3
"""
Discord integration for erotic-ai-text-gen-agent
"""
...
class EroticAiTextGenBot(commands.Bot):
    """Discord bot for erotic-ai-text-gen-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-text-gen-agent/data.db"):
