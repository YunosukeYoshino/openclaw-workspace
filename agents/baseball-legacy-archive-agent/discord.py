#!/usr/bin/env python3
"""
baseball-legacy-archive-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballLegacyArchiveAgentDB

class BaseballLegacyArchiveAgentDiscordBot(commands.Bot):
    """baseball-legacy-archive-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-legacy-archive-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballLegacyArchiveAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballLegacyArchiveAgentDiscordBot()
