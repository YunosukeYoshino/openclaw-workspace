...
class GameAiTrainingAgentDiscord:
    """ゲームAIトレーニングエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameAiTrainingAgentDiscord()
    await bot.start()
