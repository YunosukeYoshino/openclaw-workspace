...
# -*- coding: utf-8 -*-
"""
Database for Game Stream Collaboration Agent
ゲーム配信コラボエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-stream-collab-agent.db"


class GameStreamCollabAgentDB:
    """Database handler for Game Stream Collaboration Agent"""
...
if __name__ == "__main__":
    db = GameStreamCollabAgentDB()
    print(f"Database initialized: "ゲーム配信コラボエージェント"")
