...
class IncidentRemediationAgentDB:
    """インシデント修復エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/incident-remediation-agent.db"):
...
async def main():
    """動作確認"""
    db = IncidentRemediationAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for インシデント修復エージェント"
    )
