...
class IncidentRemediationAgent:
    """インシデント修復エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "incident-remediation-agent"
        self.title = "インシデント修復エージェント"
        self.description = "インシデントの修復・対応"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for インシデント修復エージェント"
        }
    }
