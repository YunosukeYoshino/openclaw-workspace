#!/usr/bin/env python3
"""
baseball-journal-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballJournalAgentDB

class BaseballJournalAgentDiscordBot(commands.Bot):
    """baseball-journal-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-journal-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballJournalAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballJournalAgentDiscordBot()
