#!/usr/bin/env python3
"""
Discord integration for erotic-ai-context-agent
"""
...
class EroticAiContextBot(commands.Bot):
    """Discord bot for erotic-ai-context-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-context-agent/data.db"):
