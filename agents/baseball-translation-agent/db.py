...
# -*- coding: utf-8 -*-
"""
Database for Baseball Translation & Multilingual Agent
野球翻訳・多言語エージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-translation-agent.db"


class BaseballTranslationAgentDB:
    """Database handler for Baseball Translation & Multilingual Agent"""
...
if __name__ == "__main__":
    db = BaseballTranslationAgentDB()
    print(f"Database initialized: "野球翻訳・多言語エージェント"")
