#!/usr/bin/env python3
"""
game-design-system-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameDesignSystemAgentDB

class GameDesignSystemAgentDiscordBot(commands.Bot):
    """game-design-system-agent Discord Bot"""

    def __init__(self, db_path: str = "game-design-system-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameDesignSystemAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameDesignSystemAgentDiscordBot()
