...
class ApiGatewayV2AgentDB:
    """APIゲートウェイV2エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/api-gateway-v2-agent.db"):
...
async def main():
    """動作確認"""
    db = ApiGatewayV2AgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for APIゲートウェイV2エージェント"
    )
