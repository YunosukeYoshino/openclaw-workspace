#!/usr/bin/env python3
"""
Discord integration for baseball-standings-agent
"""
...
class BaseballStandingsBot(commands.Bot):
    """Discord bot for baseball-standings-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-standings-agent/data.db"):
