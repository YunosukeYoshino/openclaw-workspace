#!/usr/bin/env python3
"""
game-behavior-analyzer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameBehaviorAnalyzerAgentDB

class GameBehaviorAnalyzerAgentDiscordBot(commands.Bot):
    """game-behavior-analyzer-agent Discord Bot"""

    def __init__(self, db_path: str = "game-behavior-analyzer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameBehaviorAnalyzerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameBehaviorAnalyzerAgentDiscordBot()
