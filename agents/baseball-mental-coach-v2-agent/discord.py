#!/usr/bin/env python3
"""
Discord integration for baseball-mental-coach-v2-agent
"""
...
class BaseballMentalCoachV2Bot(commands.Bot):
    """Discord bot for baseball-mental-coach-v2-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-mental-coach-v2-agent/data.db"):
