#!/usr/bin/env python3
"""
Discord integration for pub-sub-agent
"""
...
class PubSubBot(commands.Bot):
    """Discord bot for pub-sub-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/pub-sub-agent/data.db"):
