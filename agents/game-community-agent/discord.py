#!/usr/bin/env python3
"""
ゲームコミュニティ・フォーラムエージェント - Discord Bot モジュール
"""
...
class GameCommunityAgentBot(commands.Bot):
    """ゲームコミュニティ・フォーラムエージェント Discord Bot"""
...
async def show_help(ctx):
    """ヘルプを表示"""
    help_text = """
**ゲームコミュニティ・フォーラムエージェント Commands:**
