#!/usr/bin/env python3
"""
Discord integration for baseball-scout-evaluator-agent
"""
...
class BaseballScoutEvaluatorBot(commands.Bot):
    """Discord bot for baseball-scout-evaluator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-scout-evaluator-agent/data.db"):
