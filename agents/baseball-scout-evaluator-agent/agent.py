...
class BaseballScoutEvaluator:
    """野球スカウト評価エージェント。選手採用の評価。"""

    def __init__(self, db_path: str = "agents/baseball-scout-evaluator-agent/data.db"):
