...
# -*- coding: utf-8 -*-
"""
threat-intelligence-v2-agent - Database Module
SQLite database management for threat-intelligence-v2-agent
"""
...
class ThreatIntelligenceV2AgentDB:
    """Database manager for threat-intelligence-v2-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "threat-intelligence-v2-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for threat-intelligence-v2-agent initialized at " + str(db.db_path))
