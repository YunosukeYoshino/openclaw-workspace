...
# -*- coding: utf-8 -*-
"""
access-policy-agent - Database Module
SQLite database management for access-policy-agent
"""
...
class AccessPolicyAgentDB:
    """Database manager for access-policy-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "access-policy-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for access-policy-agent initialized at " + str(db.db_path))
