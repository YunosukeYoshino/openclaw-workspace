#!/usr/bin/env python3
"""
Discord integration for elasticsearch-agent
"""
...
class ElasticsearchBot(commands.Bot):
    """Discord bot for elasticsearch-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/elasticsearch-agent/data.db"):
