#!/usr/bin/env python3
"""
diy-project-agent エージェント
diy-project-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class DiyProjectAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "diy-project-agent.db"
