#!/usr/bin/env python3
"""
Database for ゲームファンアート整理エージェント / Game Fanart Organizer Agent
"""
...
class Database:
    """Database for game-fanart-organizer-agent"""

    def __init__(self, db_path: str = "data/game-fanart-organizer-agent.db"):
