#!/usr/bin/env python3
"""
Database module for ゲームマルチプレイマッチメイキングエージェント
"""
...
class Database:
    """Database handler for ゲームマルチプレイマッチメイキングエージェント"""

    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            db_path = Path(__file__).parent / "game-multiplayer-matchmaking-agent.db"
