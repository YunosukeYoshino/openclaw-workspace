#!/usr/bin/env python3
"""
Discord integration for baseball-match-analyzer-agent
"""
...
class BaseballMatchAnalyzerBot(commands.Bot):
    """Discord bot for baseball-match-analyzer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-match-analyzer-agent/data.db"):
