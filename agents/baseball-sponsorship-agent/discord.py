#!/usr/bin/env python3
"""
baseball-sponsorship-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballSponsorshipAgentDB

class BaseballSponsorshipAgentDiscordBot(commands.Bot):
    """baseball-sponsorship-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-sponsorship-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballSponsorshipAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballSponsorshipAgentDiscordBot()
