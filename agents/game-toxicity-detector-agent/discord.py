#!/usr/bin/env python3
"""
Discord integration for game-toxicity-detector-agent
"""
...
class GameToxicityDetectorBot(commands.Bot):
    """Discord bot for game-toxicity-detector-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-toxicity-detector-agent/data.db"):
