...
class GameRankingAnalysisAgentAgent:
    "Game Ranking Analysis Agent"

    def __init__(self, db_path: str = "data/game-ranking-analysis-agent.db"):
        self.db = GameRankingAnalysisAgentDB(db_path)
        self.name = "ゲームランキング分析エージェント"
