#!/usr/bin/env python3
"""
baseball-schedule-agent エージェント
baseball-schedule-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class BaseballScheduleAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "baseball-schedule-agent.db"
