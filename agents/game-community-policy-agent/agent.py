...
class GameCommunityPolicy:
    """ゲームコミュニティポリシーエージェント。コミュニティルールの管理。"""

    def __init__(self, db_path: str = "agents/game-community-policy-agent/data.db"):
