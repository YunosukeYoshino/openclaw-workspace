#!/usr/bin/env python3
"""
Discord integration for game-community-policy-agent
"""
...
class GameCommunityPolicyBot(commands.Bot):
    """Discord bot for game-community-policy-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-community-policy-agent/data.db"):
