...
# -*- coding: utf-8 -*-
"""
dos-protection-agent - Database Module
SQLite database management for dos-protection-agent
"""
...
class DosProtectionAgentDB:
    """Database manager for dos-protection-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "dos-protection-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for dos-protection-agent initialized at " + str(db.db_path))
