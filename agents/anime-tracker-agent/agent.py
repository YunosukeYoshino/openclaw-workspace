#!/usr/bin/env python3
"""
anime-tracker-agent エージェント
anime-tracker-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class AnimeTrackerAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "anime-tracker-agent.db"
