#!/usr/bin/env python3
"""
anime-tracker-agent - Discord Bot Module

Discord bot for anime-tracker-agent - アニメの視聴記録と管理
"""
...
class DiscordBot(commands.Bot):
    """Discord bot for anime-tracker-agent"""
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Anime viewing tracking and management"
        )
