...
# -*- coding: utf-8 -*-
"""
baseball-broadcaster-agent - Database Module
SQLite database management for baseball-broadcaster-agent
"""
...
class BaseballBroadcasterAgentDB:
    """Database manager for baseball-broadcaster-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "baseball-broadcaster-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for baseball-broadcaster-agent initialized at " + str(db.db_path))
