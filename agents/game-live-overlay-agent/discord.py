#!/usr/bin/env python3
"""
Discord integration for game-live-overlay-agent
"""
...
class GameLiveOverlayBot(commands.Bot):
    """Discord bot for game-live-overlay-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-live-overlay-agent/data.db"):
