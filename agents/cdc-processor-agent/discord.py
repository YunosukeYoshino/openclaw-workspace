#!/usr/bin/env python3
"""
cdc-processor-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import CdcProcessorAgentDB

class CdcProcessorAgentDiscordBot(commands.Bot):
    """cdc-processor-agent Discord Bot"""

    def __init__(self, db_path: str = "cdc-processor-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = CdcProcessorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = CdcProcessorAgentDiscordBot()
