#!/usr/bin/env python3
"""
Discord integration for key-manager-agent
"""
...
class KeyManagerBot(commands.Bot):
    """Discord bot for key-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/key-manager-agent/data.db"):
