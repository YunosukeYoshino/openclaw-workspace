#!/usr/bin/env python3
"""
Database module for game-ai-pathfinding-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "game-ai-pathfinding-agent.db"
...
class Database:
    """Database operations for game-ai-pathfinding-agent"""
