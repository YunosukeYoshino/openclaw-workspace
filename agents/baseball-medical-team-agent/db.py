...
# -*- coding: utf-8 -*-
"""
Database for Baseball Medical Team Agent
野球メディカルチームエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-medical-team-agent.db"


class BaseballMedicalTeamAgentDB:
    """Database handler for Baseball Medical Team Agent"""
...
if __name__ == "__main__":
    db = BaseballMedicalTeamAgentDB()
    print(f"Database initialized: "野球メディカルチームエージェント"")
