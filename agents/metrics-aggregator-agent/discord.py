#!/usr/bin/env python3
"""
metrics-aggregator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import MetricsAggregatorAgentDB

class MetricsAggregatorAgentDiscordBot(commands.Bot):
    """metrics-aggregator-agent Discord Bot"""

    def __init__(self, db_path: str = "metrics-aggregator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = MetricsAggregatorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = MetricsAggregatorAgentDiscordBot()
