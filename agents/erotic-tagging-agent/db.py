...
# -*- coding: utf-8 -*-
"""
erotic-tagging-agent - Database Module
SQLite database management for erotic-tagging-agent
"""
...
class EroticTaggingAgentDB:
    """Database manager for erotic-tagging-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "erotic-tagging-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for erotic-tagging-agent initialized at " + str(db.db_path))
