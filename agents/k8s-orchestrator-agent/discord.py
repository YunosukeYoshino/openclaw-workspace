#!/usr/bin/env python3
"""
Discord integration for k8s-orchestrator-agent
"""
...
class K8sOrchestratorBot(commands.Bot):
    """Discord bot for k8s-orchestrator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/k8s-orchestrator-agent/data.db"):
