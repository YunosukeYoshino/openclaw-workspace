#!/usr/bin/env python3
"""
game-lobby-manager-agent - Discord Botモジュール
"""
...
class GameLobbyManagerAgentDiscordBot(commands.Bot):
    """game-lobby-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "game-lobby-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameLobbyManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameLobbyManagerAgentDiscordBot()
