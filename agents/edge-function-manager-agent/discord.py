#!/usr/bin/env python3
"""
Discord integration for edge-function-manager-agent
"""
...
class EdgeFunctionManagerBot(commands.Bot):
    """Discord bot for edge-function-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/edge-function-manager-agent/data.db"):
