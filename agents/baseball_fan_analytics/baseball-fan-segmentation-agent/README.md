...
```python
from agent import BaseballFanSegmentationAgent
from db import BaseballFanSegmentationAgentDB
...
- `!baseball-fan-segmentation-agent_help` - Show help information
- `!baseball-fan-segmentation-agent_status` - Show agent status
...
### BaseballFanSegmentationAgentDB
