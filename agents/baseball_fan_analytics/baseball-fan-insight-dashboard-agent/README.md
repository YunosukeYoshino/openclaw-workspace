...
```python
from agent import BaseballFanInsightDashboardAgent
from db import BaseballFanInsightDashboardAgentDB
...
- `!baseball-fan-insight-dashboard-agent_help` - Show help information
- `!baseball-fan-insight-dashboard-agent_status` - Show agent status
...
### BaseballFanInsightDashboardAgent
...
### BaseballFanInsightDashboardAgentDB
