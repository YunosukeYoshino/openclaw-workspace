#!/usr/bin/env python3
"""
Discord integration for baseball-hit-tracking-agent
"""
...
class BaseballHitTrackingBot(commands.Bot):
    """Discord bot for baseball-hit-tracking-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-hit-tracking-agent/data.db"):
