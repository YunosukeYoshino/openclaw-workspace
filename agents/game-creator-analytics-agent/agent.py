...
class GameCreatorAnalytics:
    """ゲームクリエイターアナリティクスエージェント。クリエイターの分析。"""

    def __init__(self, db_path: str = "agents/game-creator-analytics-agent/data.db"):
