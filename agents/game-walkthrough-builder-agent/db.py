#!/usr/bin/env python3
"""
Database for ゲーム攻略ビルダーエージェント / Game Walkthrough Builder Agent
"""
...
class Database:
    """Database for game-walkthrough-builder-agent"""

    def __init__(self, db_path: str = "data/game-walkthrough-builder-agent.db"):
