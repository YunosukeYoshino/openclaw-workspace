# えっちスタイル変換エージェント / えっちスタイル変換エージェント (EN)

コンテンツのスタイル・トーン変換エージェント / コンテンツのスタイル・トーン変換エージェント

## Overview / 概要

AIを活用したコンテンツのスタイル・トーン変換エージェント。
...
- `!add_style-transfer <title> <content>` - Add entry / エントリー追加
- `!list_style-transfer [limit]` - List entries / エントリー一覧
- `!get_style-transfer <id>` - Get entry / エントリー取得
- `!search_style-transfer <query>` - Search entries / エントリー検索
- `!stats_style-transfer` - Get statistics / 統計情報
