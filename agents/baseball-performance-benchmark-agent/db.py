#!/usr/bin/env python3
"""
Database module for baseball-performance-benchmark-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "baseball-performance-benchmark-agent.db"
...
class Database:
    """Database operations for baseball-performance-benchmark-agent"""
