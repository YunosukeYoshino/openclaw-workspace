#!/usr/bin/env python3
"""
baseball-report-generator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballReportGeneratorAgentDB

class BaseballReportGeneratorAgentDiscordBot(commands.Bot):
    """baseball-report-generator-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-report-generator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballReportGeneratorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballReportGeneratorAgentDiscordBot()
