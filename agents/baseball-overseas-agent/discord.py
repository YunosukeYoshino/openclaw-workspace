#!/usr/bin/env python3
"""
野球海外エージェント Discord Bot Module
Baseball Overseas Agent Discord Bot
...
class BaseballOverseasAgentBot(commands.Bot):
    """野球海外エージェント Discord Bot"""

    def __init__(self, db_path: str = "baseball-overseas-agent.db", command_prefix: str = "!"):
    ...
    @commands.command(name='overseasagentget')
    ...
    @commands.command(name='overseasagentsearch')
    ...
    @commands.command(name='overseasagentstats')
    ...
    @commands.command(name='overseasagenthelp')
    async def show_help(self, ctx):
        """ヘルプを表示"""
        embed = discord.Embed(
            title="野球海外エージェント Commands",
            description="Available commands:",
            color=discord.Color.blue()
        )
        embed.add_field(name="!overseasagentadd <title> [description]", value="Add a new entry", inline=False)
        embed.add_field(name="!overseasagentlist [limit]", value="List entries", inline=False)
        embed.add_field(name="!overseasagentget <id>", value="Get entry details", inline=False)
        embed.add_field(name="!overseasagentsearch <query>", value="Search entries", inline=False)
        embed.add_field(name="!overseasagentstats", value="Show statistics", inline=False)
        embed.add_field(name="!overseasagenthelp", value="Show this help", inline=False)
