#!/usr/bin/env python3
"""
Discord integration for game-report-handler-agent
"""
...
class GameReportHandlerBot(commands.Bot):
    """Discord bot for game-report-handler-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-report-handler-agent/data.db"):
