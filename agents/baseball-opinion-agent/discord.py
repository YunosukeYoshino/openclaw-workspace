#!/usr/bin/env python3
"""
baseball-opinion-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballOpinionAgentDB

class BaseballOpinionAgentDiscordBot(commands.Bot):
    """baseball-opinion-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-opinion-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballOpinionAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballOpinionAgentDiscordBot()
