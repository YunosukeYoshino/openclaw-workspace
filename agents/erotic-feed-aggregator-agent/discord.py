#!/usr/bin/env python3
"""
erotic-feed-aggregator-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticFeedAggregatorAgentDB

class EroticFeedAggregatorAgentDiscordBot(commands.Bot):
    """erotic-feed-aggregator-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-feed-aggregator-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticFeedAggregatorAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticFeedAggregatorAgentDiscordBot()
