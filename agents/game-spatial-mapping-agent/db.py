...
# -*- coding: utf-8 -*-
"""
game-spatial-mapping-agent - Database Module
SQLite database management for game-spatial-mapping-agent
"""
...
class GameSpatialMappingAgentDB:
    """Database manager for game-spatial-mapping-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-spatial-mapping-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-spatial-mapping-agent initialized at " + str(db.db_path))
