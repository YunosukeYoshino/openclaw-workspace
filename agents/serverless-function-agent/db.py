#!/usr/bin/env python3
"""
Database module for serverless-function-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "serverless-function-agent.db"
...
class Database:
    """Database operations for serverless-function-agent"""
