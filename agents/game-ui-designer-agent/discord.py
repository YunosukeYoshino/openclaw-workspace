#!/usr/bin/env python3
"""
game-ui-designer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameUiDesignerAgentDB

class GameUiDesignerAgentDiscordBot(commands.Bot):
    """game-ui-designer-agent Discord Bot"""

    def __init__(self, db_path: str = "game-ui-designer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameUiDesignerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameUiDesignerAgentDiscordBot()
