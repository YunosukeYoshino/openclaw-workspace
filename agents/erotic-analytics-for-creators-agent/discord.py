#!/usr/bin/env python3
"""
erotic-analytics-for-creators-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticAnalyticsForCreatorsAgentDB

class EroticAnalyticsForCreatorsAgentDiscordBot(commands.Bot):
    """erotic-analytics-for-creators-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-analytics-for-creators-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticAnalyticsForCreatorsAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticAnalyticsForCreatorsAgentDiscordBot()
