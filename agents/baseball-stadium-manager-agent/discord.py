#!/usr/bin/env python3
"""
Discord integration for baseball-stadium-manager-agent
"""
...
class BaseballStadiumManagerBot(commands.Bot):
    """Discord bot for baseball-stadium-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-stadium-manager-agent/data.db"):
