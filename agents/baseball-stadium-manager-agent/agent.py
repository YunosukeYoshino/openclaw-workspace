...
class BaseballStadiumManager:
    """野球スタジアムマネージャーエージェント。スタジアム運営管理。"""

    def __init__(self, db_path: str = "agents/baseball-stadium-manager-agent/data.db"):
