#!/usr/bin/env python3
"""
data-migration-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import DataMigrationAgentDB

class DataMigrationAgentDiscordBot(commands.Bot):
    """data-migration-agent Discord Bot"""

    def __init__(self, db_path: str = "data-migration-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = DataMigrationAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = DataMigrationAgentDiscordBot()
