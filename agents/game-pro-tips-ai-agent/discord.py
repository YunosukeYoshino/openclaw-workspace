#!/usr/bin/env python3
"""
ゲームプロtips AIエージェント - Discord Botモジュール
...
class GameProTipsAiAgentDiscord:
    """ゲームプロtips AIエージェント Discord Botクラス"""
    ...
    def _setup_commands(self):
        ...
        @self.bot.command(name='add_pro-tips-ai')
        ...
        @self.bot.command(name='list_pro-tips-ai')
        ...
        @self.bot.command(name='get_pro-tips-ai')
        ...
        @self.bot.command(name='search_pro-tips-ai')
        ...
        @self.bot.command(name='stats_pro-tips-ai')
...
def main():
    """メイン関数"""
    from agent import GameProTipsAiAgent

    agent = GameProTipsAiAgent()
    discord_bot = GameProTipsAiAgentDiscord(agent)
    discord_bot.run()
