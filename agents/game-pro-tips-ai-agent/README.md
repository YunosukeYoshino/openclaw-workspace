# ゲームプロtips AIエージェント / ゲームプロtips AIエージェント (EN)

AIによるプロプレイヤーtipsエージェント / AIによるプロプレイヤーtipsエージェント

## Overview / 概要

AIを活用したAIによるプロプレイヤーtipsエージェント。
...
- `!add_pro-tips-ai <title> <content>` - Add entry / エントリー追加
- `!list_pro-tips-ai [limit]` - List entries / エントリー一覧
- `!get_pro-tips-ai <id>` - Get entry / エントリー取得
- `!search_pro-tips-ai <query>` - Search entries / エントリー検索
- `!stats_pro-tips-ai` - Get statistics / 統計情報
