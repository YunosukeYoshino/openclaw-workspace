#!/usr/bin/env python3
"""
Discord integration for baseball-data-science-agent
"""
...
class BaseballDataScienceBot(commands.Bot):
    """Discord bot for baseball-data-science-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-data-science-agent/data.db"):
