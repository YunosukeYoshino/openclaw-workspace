...
class BaseballDataScience:
    """野球データサイエンスエージェント。データ分析・統計モデリング。"""

    def __init__(self, db_path: str = "agents/baseball-data-science-agent/data.db"):
