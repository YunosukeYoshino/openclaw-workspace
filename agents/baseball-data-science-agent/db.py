...
class BaseballDataScienceAgentDB:
    """野球データサイエンスエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-data-science-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballDataScienceAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球データサイエンスエージェント"
    )
