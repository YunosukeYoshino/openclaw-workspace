#!/usr/bin/env python3
"""
erotic-story-writer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticStoryWriterAgentDB

class EroticStoryWriterAgentDiscordBot(commands.Bot):
    """erotic-story-writer-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-story-writer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticStoryWriterAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticStoryWriterAgentDiscordBot()
