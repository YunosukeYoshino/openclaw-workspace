...
# -*- coding: utf-8 -*-
"""
Database for Baseball Injury Tracker Agent
野球怪我追跡エージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-injury-tracker-agent.db"


class BaseballInjuryTrackerAgentDB:
    """Database handler for Baseball Injury Tracker Agent"""
...
if __name__ == "__main__":
    db = BaseballInjuryTrackerAgentDB()
    print(f"Database initialized: "野球怪我追跡エージェント"")
