#!/usr/bin/env python3
"""
test-runner-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import TestRunnerAgentDB

class TestRunnerAgentDiscordBot(commands.Bot):
    """test-runner-agent Discord Bot"""

    def __init__(self, db_path: str = "test-runner-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = TestRunnerAgentDB(db_path)
