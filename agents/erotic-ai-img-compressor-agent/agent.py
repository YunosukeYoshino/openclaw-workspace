...
class EroticAiImgCompressor:
    """えっちAI画像圧縮エージェント。画像の圧縮・軽量化。"""

    def __init__(self, db_path: str = "agents/erotic-ai-img-compressor-agent/data.db"):
