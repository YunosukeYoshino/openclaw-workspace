#!/usr/bin/env python3
"""
Discord integration for erotic-ai-img-compressor-agent
"""
...
class EroticAiImgCompressorBot(commands.Bot):
    """Discord bot for erotic-ai-img-compressor-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-img-compressor-agent/data.db"):
