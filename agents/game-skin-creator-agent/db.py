...
# -*- coding: utf-8 -*-
"""
Database for Game Skin Creator Agent
ゲームスキン作成エージェント
"""
...
DB_PATH = Path(__file__).parent / "game-skin-creator-agent.db"


class GameSkinCreatorAgentDB:
    """Database handler for Game Skin Creator Agent"""
...
if __name__ == "__main__":
    db = GameSkinCreatorAgentDB()
    print(f"Database initialized: "ゲームスキン作成エージェント"")
