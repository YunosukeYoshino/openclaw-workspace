...
class BaseballVideoSummaryAgentDiscord:
    """野球動画要約エージェント Discord Botクラス"""
    ...
    def _setup_commands(self):
        ...
        @self.bot.command(name='add_video-summary')
        ...
        @self.bot.command(name='list_video-summary')
        ...
        @self.bot.command(name='get_video-summary')
        ...
        @self.bot.command(name='search_video-summary')
        ...
        @self.bot.command(name='stats_video-summary')
...
def main():
    """メイン関数"""
    from agent import BaseballVideoSummaryAgent

    agent = BaseballVideoSummaryAgent()
    discord_bot = BaseballVideoSummaryAgentDiscord(agent)
    discord_bot.run()
