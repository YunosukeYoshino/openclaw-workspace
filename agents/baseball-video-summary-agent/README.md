# 野球動画要約エージェント / 野球動画要約エージェント (EN)

野球動画の自動要約・抽出エージェント / 野球動画の自動要約・抽出エージェント

## Overview / 概要

野球関連メディアの野球動画の自動要約・抽出エージェント。
...
- `!add_video-summary <title> <content>` - Add entry / エントリー追加
- `!list_video-summary [limit]` - List entries / エントリー一覧
- `!get_video-summary <id>` - Get entry / エントリー取得
- `!search_video-summary <query>` - Search entries / エントリー検索
- `!stats_video-summary` - Get statistics / 統計情報
