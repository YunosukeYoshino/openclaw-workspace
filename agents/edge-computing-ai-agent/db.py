...
class EdgeComputingAiAgentDB:
    """エッジコンピューティングAIエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/edge-computing-ai-agent.db"):
...
async def main():
    """動作確認"""
    db = EdgeComputingAiAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for エッジコンピューティングAIエージェント"
    )
