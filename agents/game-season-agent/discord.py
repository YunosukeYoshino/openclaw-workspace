#!/usr/bin/env python3
"""
Discord integration for game-season-agent
"""
...
class GameSeasonBot(commands.Bot):
    """Discord bot for game-season-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-season-agent/data.db"):
