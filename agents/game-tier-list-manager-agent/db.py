#!/usr/bin/env python3
"""
Database for ゲームTierリスト管理エージェント / Game Tier List Manager Agent
"""
...
class Database:
    """Database for game-tier-list-manager-agent"""

    def __init__(self, db_path: str = "data/game-tier-list-manager-agent.db"):
