...
```python
from agent import GameEsportsRecruitmentAgent
from db import GameEsportsRecruitmentAgentDB
...
- `!game-esports-recruitment-agent_help` - Show help information
- `!game-esports-recruitment-agent_status` - Show agent status
