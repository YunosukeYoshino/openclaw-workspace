...
```python
from agent import GameCareerPlanningAgent
from db import GameCareerPlanningAgentDB
...
- `!game-career-planning-agent_help` - Show help information
- `!game-career-planning-agent_status` - Show agent status
