...
```python
from agent import GameEsportsNetworkingAgent
from db import GameEsportsNetworkingAgentDB
...
- `!game-esports-networking-agent_help` - Show help information
- `!game-esports-networking-agent_status` - Show agent status
