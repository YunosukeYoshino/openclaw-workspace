...
```python
from agent import GameProPlayerProfileAgent
from db import GameProPlayerProfileAgentDB
...
- `!game-pro-player-profile-agent_help` - Show help information
- `!game-pro-player-profile-agent_status` - Show agent status
