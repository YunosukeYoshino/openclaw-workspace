#!/usr/bin/env python3
"""
character-quotes-agent Discord Bot
Discord bot interface for character-quotes-agent
"""
...
class CharacterQuotesAgentBot(commands.Bot):
    """Discord Bot for character-quotes-agent"""
