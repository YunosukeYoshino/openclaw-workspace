#!/usr/bin/env python3
"""
えっちコンテンツ閲覧履歴エージェント - Discord連携
Erotic Content History Agent - Discord Integration
"""

import discord
from discord.ext import commands
from agent import EroticHistoryAgent


class EroticHistoryAgentBot(commands.Bot):
    """えっちコンテンツ閲覧履歴エージェント Discord Bot"""

    def __init__(self):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix='!', intents=intents)
        self.agent = EroticHistoryAgent()
