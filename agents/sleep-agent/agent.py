...
class SleepAgent:
    """SleepAgent - Sleep Agent helps you track your sleep patterns, sleep quality, and maintain a sleep journal."""

    def __init__(self, db_path: str = None):
        """初期化"""
        if db_path is None:
            db_path = Path(__file__).parent / "sleep-agent.db"
        self.db = Database(str(db_path))
        self.table_name = "sleep_agent"
...
if __name__ == "__main__":
    agent = SleepAgent()
    print(f"{SleepAgent} initialized")
