...
class GameSocialFeaturesAgentDiscord:
    """ゲームソーシャル機能エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameSocialFeaturesAgentDiscord()
    await bot.start()
