...
class GameSocialFeaturesAgent:
    """ゲームソーシャル機能エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "game-social-features-agent"
        self.title = "ゲームソーシャル機能エージェント"
        self.description = "ゲームソーシャル機能の管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for ゲームソーシャル機能エージェント"
        }
    }
