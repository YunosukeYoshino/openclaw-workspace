...
class GameSocialFeaturesAgentDB:
    """ゲームソーシャル機能エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/game-social-features-agent.db"):
...
async def main():
    """動作確認"""
    db = GameSocialFeaturesAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for ゲームソーシャル機能エージェント"
    )
