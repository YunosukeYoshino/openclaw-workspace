#!/usr/bin/env python3
"""
erotic-subscription-manager-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticSubscriptionManagerAgentDB

class EroticSubscriptionManagerAgentDiscordBot(commands.Bot):
    """erotic-subscription-manager-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-subscription-manager-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticSubscriptionManagerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticSubscriptionManagerAgentDiscordBot()
