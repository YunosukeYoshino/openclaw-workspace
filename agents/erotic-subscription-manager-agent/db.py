#!/usr/bin/env python3
"""
Database module for えっちサブスクリプションマネージャーエージェント
"""
...
class Database:
    """Database handler for えっちサブスクリプションマネージャーエージェント"""

    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            db_path = Path(__file__).parent / "erotic-subscription-manager-agent.db"
