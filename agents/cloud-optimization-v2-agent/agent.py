...
class CloudOptimizationV2Agent:
    """クラウド最適化V2エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "cloud-optimization-v2-agent"
        self.title = "クラウド最適化V2エージェント"
        self.description = "クラウド環境の最適化V2"
        self.category = "cloud"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for クラウド最適化V2エージェント"
        }
    }
