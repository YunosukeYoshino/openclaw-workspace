...
class CloudOptimizationV2AgentDB:
    """クラウド最適化V2エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/cloud-optimization-v2-agent.db"):
...
async def main():
    """動作確認"""
    db = CloudOptimizationV2AgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for クラウド最適化V2エージェント"
    )
