#!/usr/bin/env python3
"""
game-media-kit-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameMediaKitAgentDB

class GameMediaKitAgentDiscordBot(commands.Bot):
    """game-media-kit-agent Discord Bot"""

    def __init__(self, db_path: str = "game-media-kit-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameMediaKitAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameMediaKitAgentDiscordBot()
