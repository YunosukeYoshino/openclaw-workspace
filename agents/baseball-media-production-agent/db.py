#!/usr/bin/env python3
"""
Database module for baseball-media-production-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "baseball-media-production-agent.db"
...
class Database:
    """Database operations for baseball-media-production-agent"""
