...
class SecurityTestingAgentDB:
    """セキュリティテストエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/security-testing-agent.db"):
...
async def main():
    """動作確認"""
    db = SecurityTestingAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for セキュリティテストエージェント"
    )
