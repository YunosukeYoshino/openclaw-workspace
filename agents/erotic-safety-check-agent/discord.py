...
class EroticSafetyCheckAgentDiscord:
    """えっち安全性チェックエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticSafetyCheckAgentDiscord()
    await bot.start()
