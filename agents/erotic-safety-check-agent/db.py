...
class EroticSafetyCheckAgentDB:
    """えっち安全性チェックエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/erotic-safety-check-agent.db"):
...
async def main():
    """動作確認"""
    db = EroticSafetyCheckAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for えっち安全性チェックエージェント"
    )
