...
class EroticDashboardAgentDiscord:
    """えっちダッシュボードエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticDashboardAgentDiscord()
    await bot.start()
