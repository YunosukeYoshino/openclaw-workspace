#!/usr/bin/env python3
"""
baseball-player-agent エージェント
baseball-player-agent - AIエージェント
"""

import sqlite3
from pathlib import Path

class BaseballPlayerAgent:
    def __init__(self, db_path=None):
        self.db_path = db_path or Path(__file__).parent / "baseball-player-agent.db"
