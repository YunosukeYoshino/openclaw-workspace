#!/usr/bin/env python3
"""
Discord integration for game-influencer-agent
"""
...
class GameInfluencerBot(commands.Bot):
    """Discord bot for game-influencer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-influencer-agent/data.db"):
