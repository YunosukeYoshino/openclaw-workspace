...
# -*- coding: utf-8 -*-
"""
Database for Baseball MLB Agent
野球MLBエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-mlb-agent.db"


class BaseballMlbAgentDB:
    """Database handler for Baseball MLB Agent"""
...
if __name__ == "__main__":
    db = BaseballMlbAgentDB()
    print(f"Database initialized: "野球MLBエージェント"")
