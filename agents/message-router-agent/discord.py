#!/usr/bin/env python3
"""
Discord integration for message-router-agent
"""
...
class MessageRouterBot(commands.Bot):
    """Discord bot for message-router-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/message-router-agent/data.db"):
