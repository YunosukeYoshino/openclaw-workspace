#!/usr/bin/env python3
"""
Discord integration for mfa-manager-agent
"""
...
class MfaManagerBot(commands.Bot):
    """Discord bot for mfa-manager-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/mfa-manager-agent/data.db"):
