...
# -*- coding: utf-8 -*-
"""
game-ar-ux-agent - Database Module
SQLite database management for game-ar-ux-agent
"""
...
class GameArUxAgentDB:
    """Database manager for game-ar-ux-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-ar-ux-agent.db")
...
if __name__ == "__main__":
    db = GameArUxAgentDB()
    print("Database for game-ar-ux-agent initialized at " + str(db.db_path))
