#!/usr/bin/env python3
"""
Discord integration for cloud-native-monitor-agent
"""
...
class CloudNativeMonitorBot(commands.Bot):
    """Discord bot for cloud-native-monitor-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/cloud-native-monitor-agent/data.db"):
