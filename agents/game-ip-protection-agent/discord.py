#!/usr/bin/env python3
"""
game-ip-protection-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameIpProtectionAgentDB

class GameIpProtectionAgentDiscordBot(commands.Bot):
    """game-ip-protection-agent Discord Bot"""

    def __init__(self, db_path: str = "game-ip-protection-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameIpProtectionAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameIpProtectionAgentDiscordBot()
