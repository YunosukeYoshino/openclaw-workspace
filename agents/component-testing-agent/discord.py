#!/usr/bin/env python3
"""
Discord integration for component-testing-agent
"""
...
class ComponentTestingBot(commands.Bot):
    """Discord bot for component-testing-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/component-testing-agent/data.db"):
