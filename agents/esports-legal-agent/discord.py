#!/usr/bin/env python3
"""
Discord integration for esports-legal-agent
"""
...
class EsportsLegalBot(commands.Bot):
    """Discord bot for esports-legal-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/esports-legal-agent/data.db"):
