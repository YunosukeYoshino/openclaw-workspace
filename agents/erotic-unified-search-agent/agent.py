...
class EroticUnifiedSearch:
    """えっちコンテンツ統合検索エージェント。全プラットフォームの検索。"""

    def __init__(self, db_path: str = "agents/erotic-unified-search-agent/data.db"):
