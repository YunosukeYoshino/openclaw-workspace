#!/usr/bin/env python3
"""
character-media-agent Discord Bot
Discord bot interface for character-media-agent
"""
...
class CharacterMediaAgentBot(commands.Bot):
    """Discord Bot for character-media-agent"""
