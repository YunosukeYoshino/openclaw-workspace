...
class CloudComplianceAgentDiscord:
    """クラウドコンプライアンスエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = CloudComplianceAgentDiscord()
    await bot.start()
