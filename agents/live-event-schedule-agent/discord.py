#!/usr/bin/env python3
"""
live-event-schedule-agent Discord Bot
Discord bot interface for live-event-schedule-agent
"""
...
class LiveEventScheduleAgentBot(commands.Bot):
    """Discord Bot for live-event-schedule-agent"""
