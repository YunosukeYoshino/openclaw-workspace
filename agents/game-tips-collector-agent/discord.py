#!/usr/bin/env python3
"""
Discord integration for game-tips-collector-agent
"""
...
class GameTipsCollectorBot(commands.Bot):
    """Discord bot for game-tips-collector-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-tips-collector-agent/data.db"):
