#!/usr/bin/env python3
"""
erotic-monetization-tracker-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticMonetizationTrackerAgentDB

class EroticMonetizationTrackerAgentDiscordBot(commands.Bot):
    """erotic-monetization-tracker-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-monetization-tracker-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticMonetizationTrackerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticMonetizationTrackerAgentDiscordBot()
