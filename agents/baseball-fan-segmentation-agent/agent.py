...
class BaseballFanSegmentation:
    """野球ファンセグメンテーションエージェント。ファンの分類・分析。"""

    def __init__(self, db_path: str = "agents/baseball-fan-segmentation-agent/data.db"):
