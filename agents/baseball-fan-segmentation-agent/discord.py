#!/usr/bin/env python3
"""
Discord integration for baseball-fan-segmentation-agent
"""
...
class BaseballFanSegmentationBot(commands.Bot):
    """Discord bot for baseball-fan-segmentation-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-fan-segmentation-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballFanSegmentationBot()
