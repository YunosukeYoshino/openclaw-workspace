#!/usr/bin/env python3
"""
cooking-agent - Discord Bot Module

Discord bot for cooking-agent - レシピ管理・献立計画・料理記録
"""
...
class DiscordBot(commands.Bot):
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Recipe management, meal planning, and cooking records"
        )
