#!/usr/bin/env python3
"""
Discord integration for erotic-seo-optimizer-agent
"""
...
class EroticSeoOptimizerBot(commands.Bot):
    """Discord bot for erotic-seo-optimizer-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-seo-optimizer-agent/data.db"):
