#!/usr/bin/env python3
"""
vtuber-news-agent Database Module
SQLite database for vtuber-news-agent
"""
...
class VtuberNewsAgentDatabase:
    """Database for vtuber-news-agent"""

    def __init__(self, db_path: Optional[str] = None):
        if db_path is None:
            db_path = os.path.join(os.path.dirname(__file__), "vtuber-news-agent.db")
