#!/usr/bin/env python3
"""
Discord integration for erotic-content-sync-agent
"""
...
class EroticContentSyncBot(commands.Bot):
    """Discord bot for erotic-content-sync-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-content-sync-agent/data.db"):
