...
class GamePlayerClubAgentDiscord:
    """ゲームプレイヤークラブエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GamePlayerClubAgentDiscord()
    await bot.start()
