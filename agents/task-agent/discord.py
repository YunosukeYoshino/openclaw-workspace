#!/usr/bin/env python3
"""
task-agent - Discord Bot Module

Discord bot for task-agent - タスクの作成・追跡・完了管理
"""
...
class DiscordBot(commands.Bot):
    ...
    def __init__(self):
        ...
        super().__init__(
            command_prefix='!',
            intents=intents,
            description="Task creation, tracking, and completion management"
        )
