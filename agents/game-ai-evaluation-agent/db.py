...
class GameAiEvaluationAgentDB:
    """ゲームAI評価エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/game-ai-evaluation-agent.db"):
...
async def main():
    """動作確認"""
    db = GameAiEvaluationAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for ゲームAI評価エージェント"
    )
