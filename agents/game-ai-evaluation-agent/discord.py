...
class GameAiEvaluationAgentDiscord:
    """ゲームAI評価エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameAiEvaluationAgentDiscord()
    await bot.start()
