...
class EroticContentFilterAgentDiscord:
    """えっちコンテンツフィルターエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticContentFilterAgentDiscord()
    await bot.start()
