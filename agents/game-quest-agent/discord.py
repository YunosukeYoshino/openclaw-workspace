#!/usr/bin/env python3
"""
Discord integration for game-quest-agent
"""
...
class GameQuestBot(commands.Bot):
    """Discord bot for game-quest-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-quest-agent/data.db"):
