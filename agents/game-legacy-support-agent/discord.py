...
class GameLegacySupportAgentDiscord:
    """ゲームレガシーサポートエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameLegacySupportAgentDiscord()
    await bot.start()
