#!/usr/bin/env python3
"""
Discord integration for erotic-ai-grammar-agent
"""
...
class EroticAiGrammarBot(commands.Bot):
    """Discord bot for erotic-ai-grammar-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-grammar-agent/data.db"):
