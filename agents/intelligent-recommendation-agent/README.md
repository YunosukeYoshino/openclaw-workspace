...
- **Similar**: similar management
- **Personalize**: personalize management
...
```
!inthelp - Show help
!intadd <title> <content> - Add new item
!intlist - List items
!intsearch <query> - Search items
!intsync <source> <target> - Sync categories
!intdashboard - Get dashboard data
```
