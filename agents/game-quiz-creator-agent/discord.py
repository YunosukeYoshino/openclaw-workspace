#!/usr/bin/env python3
"""
Discord integration for game-quiz-creator-agent
"""
...
class GameQuizCreatorBot(commands.Bot):
    """Discord bot for game-quiz-creator-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-quiz-creator-agent/data.db"):
