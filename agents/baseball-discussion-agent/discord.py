#!/usr/bin/env python3
"""
baseball-discussion-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballDiscussionAgentDB

class BaseballDiscussionAgentDiscordBot(commands.Bot):
    """baseball-discussion-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-discussion-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballDiscussionAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballDiscussionAgentDiscordBot()
