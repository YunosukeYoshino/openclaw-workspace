...
class EroticPlatformBridge:
    """えっちプラットフォームブリッジエージェント。プラットフォーム間の連携。"""

    def __init__(self, db_path: str = "agents/erotic-platform-bridge-agent/data.db"):
