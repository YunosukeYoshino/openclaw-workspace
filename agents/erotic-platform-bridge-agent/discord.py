#!/usr/bin/env python3
"""
erotic-platform-bridge-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticPlatformBridgeAgentDB

class EroticPlatformBridgeAgentDiscordBot(commands.Bot):
    """erotic-platform-bridge-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-platform-bridge-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticPlatformBridgeAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticPlatformBridgeAgentDiscordBot()
