#!/usr/bin/env python3
"""
Discord integration for erotic-ai-audio-gen-agent
"""
...
class EroticAiAudioGenBot(commands.Bot):
    """Discord bot for erotic-ai-audio-gen-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-audio-gen-agent/data.db"):
