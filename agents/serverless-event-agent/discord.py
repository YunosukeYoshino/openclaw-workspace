...
class ServerlessEventAgentDiscord:
    """サーバーレスイベントエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = ServerlessEventAgentDiscord()
    await bot.start()
