#!/usr/bin/env python3
"""
Discord integration for container-registry-agent
"""
...
class ContainerRegistryBot(commands.Bot):
    """Discord bot for container-registry-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/container-registry-agent/data.db"):
