#!/usr/bin/env python3
"""
Discord integration for session-monitor-agent
"""
...
class SessionMonitorBot(commands.Bot):
    """Discord bot for session-monitor-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/session-monitor-agent/data.db"):
