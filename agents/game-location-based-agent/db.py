...
# -*- coding: utf-8 -*-
"""
game-location-based-agent - Database Module
SQLite database management for game-location-based-agent
"""
...
class GameLocationBasedAgentDB:
    """Database manager for game-location-based-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-location-based-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-location-based-agent initialized at " + str(db.db_path))
