#!/usr/bin/env python3
"""
game-reviewer-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GameReviewerAgentDB

class GameReviewerAgentDiscordBot(commands.Bot):
    """game-reviewer-agent Discord Bot"""

    def __init__(self, db_path: str = "game-reviewer-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GameReviewerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = GameReviewerAgentDiscordBot()
