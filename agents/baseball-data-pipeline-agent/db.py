...
# -*- coding: utf-8 -*-
"""
Database for Baseball Data Pipeline Agent
野球データパイプラインエージェント
"""
...
DB_PATH = Path(__file__).parent / "baseball-data-pipeline-agent.db"


class BaseballDataPipelineAgentDB:
    """Database handler for Baseball Data Pipeline Agent"""
...
if __name__ == "__main__":
    db = BaseballDataPipelineAgentDB()
    print(f"Database initialized: "野球データパイプラインエージェント"")
