#!/usr/bin/env python3
"""
task-scheduler-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import TaskSchedulerAgentDB

class TaskSchedulerAgentDiscordBot(commands.Bot):
    """task-scheduler-agent Discord Bot"""

    def __init__(self, db_path: str = "task-scheduler-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = TaskSchedulerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = TaskSchedulerAgentDiscordBot()
