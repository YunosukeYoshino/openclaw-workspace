#!/usr/bin/env python3
"""
Discord integration for erotic-ai-tts-agent
"""
...
class EroticAiTtsBot(commands.Bot):
    """Discord bot for erotic-ai-tts-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/erotic-ai-tts-agent/data.db"):
