#!/usr/bin/env python3
"""
Discord integration for baseball-compare-tracker-agent
"""
...
class BaseballCompareTrackerBot(commands.Bot):
    """Discord bot for baseball-compare-tracker-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-compare-tracker-agent/data.db"):
