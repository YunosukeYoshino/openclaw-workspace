...
class EdgeModelAgentDB:
    """エッジモデルエージェント データベースクラス"""

    def __init__(self, db_path: str = "data/edge-model-agent.db"):
...
async def main():
    ...
    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for エッジモデルエージェント"
    )
