#!/usr/bin/env python3
"""
Discord integration for baseball-fan-feedback-agent
"""
...
class BaseballFanFeedbackBot(commands.Bot):
    """Discord bot for baseball-fan-feedback-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-fan-feedback-agent/data.db"):
