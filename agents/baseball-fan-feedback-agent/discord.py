#!/usr/bin/env python3
"""
baseball-fan-feedback-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballFanFeedbackAgentDB

class BaseballFanFeedbackAgentDiscordBot(commands.Bot):
    """baseball-fan-feedback-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-fan-feedback-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballFanFeedbackAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballFanFeedbackAgentDiscordBot()
