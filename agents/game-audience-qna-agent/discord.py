#!/usr/bin/env python3
"""
Discord integration for game-audience-qna-agent
"""
...
class GameAudienceQnaBot(commands.Bot):
    """Discord bot for game-audience-qna-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-audience-qna-agent/data.db"):
