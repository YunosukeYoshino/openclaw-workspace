...
class EroticDiscussionAgentDiscord:
    """えっちディスカッションエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = EroticDiscussionAgentDiscord()
    await bot.start()
