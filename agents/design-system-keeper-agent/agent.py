...
class DesignSystemKeeper:
    """デザインシステムキーパーエージェント。デザインシステムの一貫性維持。"""

    def __init__(self, db_path: str = "agents/design-system-keeper-agent/data.db"):
