...
```
!multimodal-erotic-analysis-agent [media_url]    # Analyze media from URL or attachment
!multimodal-erotic-analysis-agent-list [limit]   # List recent entries (default: 10)
!multimodal-erotic-analysis-agent-stats          # Show statistics
```
...
agent = MultimodalEroticAnalysisAgent(bot)
