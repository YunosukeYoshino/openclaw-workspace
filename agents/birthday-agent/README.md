...
birthday agentは、birthdayの管理と追跡を行うAIエージェントです。
...
- "Add birthday record"
- "Show my birthday history"
- "List recent birthday entries"
...
```json
{
    "database_path": "birthday-agent.db",
    "log_level": "INFO"
}
```
