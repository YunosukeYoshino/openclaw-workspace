#!/usr/bin/env python3
"""
Discord integration for game-team-analytics-agent
"""
...
class GameTeamAnalyticsBot(commands.Bot):
    """Discord bot for game-team-analytics-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-team-analytics-agent/data.db"):
