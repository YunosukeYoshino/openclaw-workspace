...
class BaseballLegendPlayersAgent:
    """野球伝説の選手エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-legend-players-agent"
        self.title = "野球伝説の選手エージェント"
        self.description = "野球伝説の選手データの管理"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球伝説の選手エージェント"
        }
    }
