...
class BaseballLegendPlayersAgentDB:
    """野球伝説の選手エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-legend-players-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballLegendPlayersAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球伝説の選手エージェント"
    )
