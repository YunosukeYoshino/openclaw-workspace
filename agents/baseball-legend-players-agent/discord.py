...
class BaseballLegendPlayersAgentDiscord:
    """野球伝説の選手エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = BaseballLegendPlayersAgentDiscord()
    await bot.start()
