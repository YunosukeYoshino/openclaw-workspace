#!/usr/bin/env python3
"""
Database module for security-incident-policy-agent
"""
...
DB_PATH = Path(__file__).parent / "data" / "security-incident-policy-agent.db"
...
class Database:
    """Database operations for security-incident-policy-agent"""
