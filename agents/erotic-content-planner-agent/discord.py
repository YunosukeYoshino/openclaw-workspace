#!/usr/bin/env python3
"""
erotic-content-planner-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import EroticContentPlannerAgentDB

class EroticContentPlannerAgentDiscordBot(commands.Bot):
    """erotic-content-planner-agent Discord Bot"""

    def __init__(self, db_path: str = "erotic-content-planner-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = EroticContentPlannerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = EroticContentPlannerAgentDiscordBot()
