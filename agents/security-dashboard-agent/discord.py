#!/usr/bin/env python3
"""
Discord integration for security-dashboard-agent
"""
...
class SecurityDashboardBot(commands.Bot):
    """Discord bot for security-dashboard-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/security-dashboard-agent/data.db"):
