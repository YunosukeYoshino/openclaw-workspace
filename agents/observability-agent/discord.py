#!/usr/bin/env python3
"""
Discord integration for observability-agent
"""
...
class ObservabilityBot(commands.Bot):
    """Discord bot for observability-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/observability-agent/data.db"):
