...
class BaseballReportAgentDB:
    """野球レポート生成エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-report-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballReportAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球レポート生成エージェント"
    )
