...
```python
from agent import BaseballAiDrillAgent
from db import BaseballAiDrillAgentDB
...
- `!baseball-ai-drill-agent_help` - Show help information
- `!baseball-ai-drill-agent_status` - Show agent status
