...
```python
from agent import BaseballAiStrategyAgent
...
- `!baseball-ai-strategy-agent_help` - Show help information
- `!baseball-ai-strategy-agent_status` - Show agent status
