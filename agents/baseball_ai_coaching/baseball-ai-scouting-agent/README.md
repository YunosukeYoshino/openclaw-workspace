...
```python
from agent import BaseballAiScoutingAgent
from db import BaseballAiScoutingAgentDB
...
- `!baseball-ai-scouting-agent_help` - Show help information
- `!baseball-ai-scouting-agent_status` - Show agent status
