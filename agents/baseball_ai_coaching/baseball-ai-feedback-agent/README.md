...
```python
from agent import BaseballAiFeedbackAgent
from db import BaseballAiFeedbackAgentDB
...
- `!baseball-ai-feedback-agent_help` - Show help information
- `!baseball-ai-feedback-agent_status` - Show agent status
