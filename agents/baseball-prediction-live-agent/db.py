#!/usr/bin/env python3
"""
Database for 野球ライブ予測エージェント / Baseball Live Prediction Agent
"""
...
class Database:
    """Database for baseball-prediction-live-agent"""

    def __init__(self, db_path: str = "data/baseball-prediction-live-agent.db"):
