...
# -*- coding: utf-8 -*-
"""
game-voice-actor-agent - Database Module
SQLite database management for game-voice-actor-agent
"""
...
class GameVoiceActorAgentDB:
    """Database manager for game-voice-actor-agent"""

    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = str(Path(__file__).parent / "game-voice-actor-agent.db")
...
if __name__ == "__main__":
    ...
    print("Database for game-voice-actor-agent initialized at " + str(db.db_path))
