...
class BaseballFacilitiesAgentDB:
    """野球場施設エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/baseball-facilities-agent.db"):
...
async def main():
    """動作確認"""
    db = BaseballFacilitiesAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for 野球場施設エージェント"
    )
