...
class IncidentReviewAgent:
    """インシデントレビューエージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "incident-review-agent"
        self.title = "インシデントレビューエージェント"
        self.description = "インシデントのレビュー・分析"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for インシデントレビューエージェント"
        }
    }
