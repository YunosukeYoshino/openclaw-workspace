#!/usr/bin/env python3
"""
Discord integration for baseball-in-game-agent
"""
...
class BaseballInGameBot(commands.Bot):
    """Discord bot for baseball-in-game-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-in-game-agent/data.db"):
