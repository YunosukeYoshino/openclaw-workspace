...
# -*- coding: utf-8 -*-
"""
Database for Game Workshop Agent
ゲームワークショップエージェント
"""
...
DB_PATH = Path(__file__).parent / "game-workshop-agent.db"


class GameWorkshopAgentDB:
    """Database handler for Game Workshop Agent"""
...
if __name__ == "__main__":
    db = GameWorkshopAgentDB()
    print(f"Database initialized: "ゲームワークショップエージェント"")
