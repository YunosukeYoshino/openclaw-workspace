#!/usr/bin/env python3
"""
スピードラン記録・RTA情報エージェント - Discord Bot モジュール
"""
...
class GameSpeedrunAgentBot(commands.Bot):
    """スピードラン記録・RTA情報エージェント Discord Bot"""
