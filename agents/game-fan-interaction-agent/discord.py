...
class GameFanInteractionAgentDiscord:
    """ゲームファン交流エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameFanInteractionAgentDiscord()
    await bot.start()
