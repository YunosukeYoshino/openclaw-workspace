#!/usr/bin/env python3
"""
Discord Bot for baseball-international-signing-agent
野球国際契約エージェント / Baseball International Signing Agent
"""

import discord
from discord.ext import commands
from agent import BaseballInternationalSigningAgent
import logging
from pathlib import Path
import os

logging.basicConfig(level=logging.INFO)
logger = logging.getLogger("baseball-international-signing-agent")
