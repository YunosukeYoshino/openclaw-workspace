...
class GameInteractiveWidget:
    """ゲームインタラクティブウィジェットエージェント。視聴者参加型ウィジェットの作成。"""

    def __init__(self, db_path: str = "agents/game-interactive-widget-agent/data.db"):
