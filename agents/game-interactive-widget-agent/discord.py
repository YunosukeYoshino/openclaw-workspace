#!/usr/bin/env python3
"""
Discord integration for game-interactive-widget-agent
"""
...
class GameInteractiveWidgetBot(commands.Bot):
    """Discord bot for game-interactive-widget-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/game-interactive-widget-agent/data.db"):
