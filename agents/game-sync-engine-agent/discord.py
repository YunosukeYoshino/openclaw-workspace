...
class GameSyncEngineAgentDiscord:
    """ゲーム同期エンジンエージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = GameSyncEngineAgentDiscord()
    await bot.start()
