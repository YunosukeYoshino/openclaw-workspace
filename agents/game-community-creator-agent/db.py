#!/usr/bin/env python3
"""
Database for ゲームコミュニティ作成エージェント / Game Community Creator Agent
"""
...
class Database:
    """Database for game-community-creator-agent"""

    def __init__(self, db_path: str = "data/game-community-creator-agent.db"):
