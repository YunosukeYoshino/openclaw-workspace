#!/usr/bin/env python3
"""
api-mock-server-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import ApiMockServerAgentDB

class ApiMockServerAgentDiscordBot(commands.Bot):
    """api-mock-server-agent Discord Bot"""

    def __init__(self, db_path: str = "api-mock-server-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = ApiMockServerAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = ApiMockServerAgentDiscordBot()
