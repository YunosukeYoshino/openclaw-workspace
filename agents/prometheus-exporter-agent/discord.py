#!/usr/bin/env python3
"""
prometheus-exporter-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import PrometheusExporterAgentDB

class PrometheusExporterAgentDiscordBot(commands.Bot):
    """prometheus-exporter-agent Discord Bot"""

    def __init__(self, db_path: str = "prometheus-exporter-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = PrometheusExporterAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = PrometheusExporterAgentDiscordBot()
