#!/usr/bin/env python3
"""
Discord integration for data-archive-agent
"""
...
class DataArchiveBot(commands.Bot):
    """Discord bot for data-archive-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/data-archive-agent/data.db"):
