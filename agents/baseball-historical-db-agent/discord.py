#!/usr/bin/env python3
"""
baseball-historical-db-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import BaseballHistoricalDbAgentDB

class BaseballHistoricalDbAgentDiscordBot(commands.Bot):
    """baseball-historical-db-agent Discord Bot"""

    def __init__(self, db_path: str = "baseball-historical-db-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = BaseballHistoricalDbAgentDB(db_path)
...
def main():
    """メイン関数"""
    bot = BaseballHistoricalDbAgentDiscordBot()
