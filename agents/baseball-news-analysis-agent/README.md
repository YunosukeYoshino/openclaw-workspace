# 野球ニュース分析エージェント / 野球ニュース分析エージェント (EN)

野球ニュースのAI分析・要約エージェント / 野球ニュースのAI分析・要約エージェント

## Overview / 概要

野球関連メディアの野球ニュースのAI分析・要約エージェント。
...
- `!add_news-analysis <title> <content>` - Add entry / エントリー追加
- `!list_news-analysis [limit]` - List entries / エントリー一覧
- `!get_news-analysis <id>` - Get entry / エントリー取得
- `!search_news-analysis <query>` - Search entries / エントリー検索
- `!stats_news-analysis` - Get statistics / 統計情報
