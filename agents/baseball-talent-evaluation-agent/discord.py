...
class BaseballTalentEvaluationAgentDiscord:
    """野球タレント評価エージェント Discord連携クラス"""
...
async def main():
    """動作確認"""
    bot = BaseballTalentEvaluationAgentDiscord()
    await bot.start()
