...
class BaseballTalentEvaluationAgent:
    """野球タレント評価エージェント"""

    def __init__(self, config: Optional[Dict[str, Any]] = None):
        self.config = config or {}
        self.name = "baseball-talent-evaluation-agent"
        self.title = "野球タレント評価エージェント"
        self.description = "野球タレントの評価・採点"
...
async def main():
    ...
    sample_task = {
        "id": "sample_001",
        "data": {
            "message": "Sample task for 野球タレント評価エージェント"
        }
    }
