#!/usr/bin/env python3
"""
graph-db-agent - Discord Botモジュール
"""

import discord
from discord.ext import commands
from db import GraphDbAgentDB

class GraphDbAgentDiscordBot(commands.Bot):
    """graph-db-agent Discord Bot"""

    def __init__(self, db_path: str = "graph-db-agent.db"):
        intents = discord.Intents.default()
        intents.message_content = True
        super().__init__(command_prefix="!", intents=intents)
        self.db = GraphDbAgentDB(db_path)
