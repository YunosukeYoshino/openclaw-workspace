...
class DataWarehouseAgent:
    ...
    def __init__(self, db_path=None):
        ...
        self.db = data_warehouse_agentDatabase(self.db_path)
        self.commands = ["create_fact", "add_dimension", "run_etl", "warehouse_status"]
    ...
    async def handle_command(self, cmd: str, args: list, user_id: str = None):
        ...
        if cmd == "create_fact" and len(commands) > 0:
            return await self.create_fact(args, user_id)
    ...
    async def create_fact(self, args: list, user_id: str = None):
        """Handle create_fact command"""
        logger.info(f"create_fact: {args}")
