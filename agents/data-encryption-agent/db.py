...
class DataEncryptionAgentDB:
    """データ暗号化エージェント データベースクラス"""

    def __init__(self, db_path: str = "data/data-encryption-agent.db"):
...
async def main():
    """動作確認"""
    db = DataEncryptionAgentDB()

    record_id = db.insert_record(
        record_type="sample",
        title="Sample Record",
        content="This is a sample record for データ暗号化エージェント"
    )
