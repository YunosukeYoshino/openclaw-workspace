#!/usr/bin/env python3
"""
Discord integration for baseball-mental-performance-agent
"""
...
class BaseballMentalPerformanceBot(commands.Bot):
    """Discord bot for baseball-mental-performance-agent"""

    def __init__(self, command_prefix: str = "!", db_path: str = "agents/baseball-mental-performance-agent/data.db"):
...
if __name__ == "__main__":
    import os
    bot = BaseballMentalPerformanceBot()
