#!/usr/bin/env python3
"""
docker-compose-agent - Discord Bot モジュール
"""
...
class DockerComposeAgentDiscordBot:
    """Docker Composeエージェント。Docker Composeの管理。 Discord Bot"""
...
if __name__ == "__main__":
    # テスト実行
    async def test():
        bot = DockerComposeAgentDiscordBot()
        await bot.start()
