...
# -*- coding: utf-8 -*-
"""
Discordボットモジュール - インフラストラクチャーコード化エージェント
"""
...
class DiscordBot(commands.Bot):
    ...
    async def cmd_info(self, ctx: commands.Context):
        """エージェント情報を表示"""
        embed = discord.Embed(title="インフラストラクチャーコード化エージェント", description="Terraform/CloudFormation等のIaC管理を行うエージェント", color=discord.Color.green())
