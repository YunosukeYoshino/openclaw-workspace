...
class IotDeviceManagerAgent:
    """iot-device-manager-agent"""

    def __init__(self, db_path: str = "iot-device-manager-agent.db"):
...
def main():
    """メイン関数"""
    agent = IotDeviceManagerAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="IoTデバイスマネージャーエージェント。IoTデバイスの管理・監視。",
