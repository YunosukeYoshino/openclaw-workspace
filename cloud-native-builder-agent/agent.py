...
class CloudNativeBuilderAgent:
    """cloud-native-builder-agent"""

    def __init__(self, db_path: str = "cloud-native-builder-agent.db"):
...
def main():
    """メイン関数"""
    agent = CloudNativeBuilderAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="クラウドネイティブビルダーエージェント。クラウドネイティブアプリのビルド。",
