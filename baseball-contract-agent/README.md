...
Baseball contract agent. Manage contracts.
...
```python
from agent import BaseballContractAgentAgent

agent = BaseballContractAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from baseball-contract-agent")
```
