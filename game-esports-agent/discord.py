...
# -*- coding: utf-8 -*-
"""
Discordボットモジュール - ゲームeスポーツエージェント
"""
...
class DiscordBot(commands.Bot):
    ...
    async def cmd_info(self, ctx: commands.Context):
        embed = discord.Embed(title="ゲームeスポーツエージェント", description="ゲームeスポーツシーン全体を管理するエージェント", color=discord.Color.green())
        embed.add_field(name="カテゴリ", value="ゲームeスポーツ", inline=False)
        await ctx.send(embed=embed)
