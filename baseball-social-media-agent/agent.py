...
class BaseballSocialMediaAgent:
    """baseball-social-media-agent"""

    def __init__(self, db_path: str = "baseball-social-media-agent.db"):
...
def main():
    """メイン関数"""
    agent = BaseballSocialMediaAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="野球ソーシャルメディアエージェント。SNS運営・コンテンツ管理。",
