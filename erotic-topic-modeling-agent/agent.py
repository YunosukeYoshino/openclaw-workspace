...
class EroticTopicModelingAgent:
    """erotic-topic-modeling-agent"""

    def __init__(self, db_path: str = "erotic-topic-modeling-agent.db"):
...
def main():
    """メイン関数"""
    agent = EroticTopicModelingAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="えっちトピックモデリングエージェント。トピック抽出・分類。",
