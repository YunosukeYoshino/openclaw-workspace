...
# -*- coding: utf-8 -*-
"""
Discordボットモジュール - えっちクリエイターアナリティクスエージェント
"""
...
class DiscordBot(commands.Bot):
    ...
    async def cmd_info(self, ctx: commands.Context):
        embed = discord.Embed(title="えっちクリエイターアナリティクスエージェント", description="えっちクリエイターの分析・統計を提供するエージェント", color=discord.Color.green())
