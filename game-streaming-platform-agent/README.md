...
Game streaming platform agent. Manage streaming platforms.
...
```python
from agent import GameStreamingPlatformAgentAgent
...
await bot.connect()
await bot.send_message("Hello from game-streaming-platform-agent")
```
