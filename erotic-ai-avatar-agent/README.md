...
えっちAIアバターエージェント。AIアバターの管理。

Erotic AI avatar agent. Manage AI avatars.
...
```python
from agent import EroticAiAvatarAgentAgent

agent = EroticAiAvatarAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from erotic-ai-avatar-agent")
```
