...
# -*- coding: utf-8 -*-
"""
Discordボットモジュール - セキュリティトレーニングポータルエージェント
"""
...
class DiscordBot(commands.Bot):
    ...
    async def cmd_info(self, ctx: commands.Context):
        embed = discord.Embed(title="セキュリティトレーニングポータルエージェント", description="セキュリティトレーニングポータルを管理するエージェント", color=discord.Color.green())
        embed.add_field(name="カテゴリ", value="セキュリティガバナンス・コンプライアンス", inline=False)
        await ctx.send(embed=embed)
