...
# -*- coding: utf-8 -*-
"""
Discordボットモジュール - えっちコンテンツマーケティングエージェント
"""
...
class DiscordBot(commands.Bot):
    ...
    async def cmd_info(self, ctx: commands.Context):
        embed = discord.Embed(title="えっちコンテンツマーケティングエージェント", description="えっちコンテンツのマーケティング戦略を管理するエージェント", color=discord.Color.green())
        embed.add_field(name="カテゴリ", value="えっちコンテンツマーケティング", inline=False)
        await ctx.send(embed=embed)
