...
ガバナンスエージェント。組織ガバナンスの実施。

Governance agent. Implement organizational governance.
...
```python
from agent import GovernanceAgentAgent

agent = GovernanceAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from governance-agent")
```
