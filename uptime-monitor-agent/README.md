...
Uptime monitor agent. Monitor uptime.
...
```python
from agent import UptimeMonitorAgentAgent

agent = UptimeMonitorAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from uptime-monitor-agent")
```
