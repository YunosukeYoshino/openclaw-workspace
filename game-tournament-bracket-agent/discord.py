#!/usr/bin/env python3
"""
game-tournament-bracket-agent - Discord Bot モジュール
"""
...
class GameTournamentBracketAgentDiscordBot:
    """ゲームトーナメントブラケットエージェント。トーナメント表の管理。 Discord Bot"""
...
if __name__ == "__main__":
    # テスト実行
    async def test():
        bot = GameTournamentBracketAgentDiscordBot()
        await bot.start()
