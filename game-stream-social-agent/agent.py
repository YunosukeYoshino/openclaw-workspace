...
class GameStreamSocialAgent:
    """game-stream-social-agent"""

    def __init__(self, db_path: str = "game-stream-social-agent.db"):
...
def main():
    """メイン関数"""
    agent = GameStreamSocialAgent()

    # サンプル実行
    entry_id = agent.add_entry(
        title="サンプル",
        content="ゲームストリームソーシャルエージェント。ストリームのソーシャル機能管理。",
