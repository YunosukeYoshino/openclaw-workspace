#!/usr/bin/env python3
"""
game-esports-player-agent - Discord Bot モジュール
"""
...
class GameEsportsPlayerAgentDiscordBot:
    """ゲームeスポーツプレイヤーエージェント。eスポーツプレイヤーの管理。 Discord Bot"""
...
if __name__ == "__main__":
    # テスト実行
    async def test():
        bot = GameEsportsPlayerAgentDiscordBot()
        await bot.start()
