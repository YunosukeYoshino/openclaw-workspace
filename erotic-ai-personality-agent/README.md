...
えっちAIパーソナリティエージェント。AIパーソナリティの管理。

Erotic AI personality agent. Manage AI personalities.
...
```python
from agent import EroticAiPersonalityAgentAgent

agent = EroticAiPersonalityAgentAgent()
...
await bot.connect()
await bot.send_message("Hello from erotic-ai-personality-agent")
```
