...
logger = logging.getLogger('disaster-recovery-agent')


class DisasterRecoveryAgentDiscordBot:
    ...
    def _setup_commands(self):
        ...
        async def help_command(ctx):
            help_text = """
**disaster-recovery-agent Commands:**
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Discord bot for disaster-recovery-agent")
    parser.add_argument("--token", help="Discord bot token")
    parser.add_argument("--prefix", default="!", help="Command prefix")
    args = parser.parse_args()

    bot = DisasterRecoveryAgentDiscordBot(token=args.token, prefix=args.prefix)
    if bot.run():
